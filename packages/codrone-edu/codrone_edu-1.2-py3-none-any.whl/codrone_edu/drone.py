...
class Drone:
    ...
    def pair(self, portname=None):
        print("Please remove AA batteries from controller while programming or connecting micro USB cable.")
        self.open(portname)
    ...
    def goto_waypoint(self, waypoint, velocity, heading, rotationalVelocity):
            """
            drone movement command
