...
class TortoiseSelector(BaseSelector[BaseModel], Generic[BaseModel]):
    ...
    id_field = "id"
    not_exists_exception: Type[Exception] = Exception
    not_exists_exception_msg: Optional[str] = None
    ...
    @classmethod
    async def list_get_all(cls, *args, **kwargs) -> list[BaseModel]:
        return await cls.list_get_all_as_qs(*args, **kwargs)

    @classmethod
    def list_get_all_as_qs(cls, *args, **kwargs) -> QuerySet[BaseModel]:
        return cls.model.all()

    @classmethod
    async def list_get_all_as_pydantic(cls, *args, **kwargs):
        query_set = cls.list_get_all_as_qs(*args, **kwargs)
