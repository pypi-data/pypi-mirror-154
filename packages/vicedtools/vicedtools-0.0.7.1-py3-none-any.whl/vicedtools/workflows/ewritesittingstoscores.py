...
def ewrite_sittings_to_scores(oars_tests_json: str, ewrite_sittings_dir: str,
    ...
    Creates two tables, a scores table that provides the overall score achieved
    but the student for each sitting and a per-criteria table that provides the
    scale score achieved for each criteria for each sitting.
    """
