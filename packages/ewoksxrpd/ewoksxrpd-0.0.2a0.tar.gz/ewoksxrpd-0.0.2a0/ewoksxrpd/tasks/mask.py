...
class MaskDetection(
    ...
    def run(self):
        monitor_high = utils.get_data(self.inputs.monitor1)
        monitor_low = utils.get_data(self.inputs.monitor2)
        image_high = utils.get_image(self.inputs.image1)
        image_low = utils.get_image(self.inputs.image2)
