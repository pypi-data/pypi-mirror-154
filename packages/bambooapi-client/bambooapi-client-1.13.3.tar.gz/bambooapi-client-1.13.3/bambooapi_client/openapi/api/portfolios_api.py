...
class PortfoliosApi(object):
    ...
    def read_portfolio_energy_market_operations(
        ...
        **kwargs
        ...
        >>> thread = api.read_portfolio_energy_market_operations(portfolio_id, market_id, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            operations ([MarketOperationsEnum]): [optional] if omitted the server will use the default value of ["bids","clearings"]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def read_portfolio_flexibility_market_operations(
        ...
        **kwargs
        ...
        >>> thread = api.read_portfolio_flexibility_market_operations(portfolio_id, market_id, async_req=True)
        >>> result = thread.get()
