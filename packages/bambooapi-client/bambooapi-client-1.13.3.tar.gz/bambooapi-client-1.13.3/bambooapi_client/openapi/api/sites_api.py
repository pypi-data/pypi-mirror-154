...
from bambooapi_client.openapi.model.activation_status_data_point import ActivationStatusDataPoint
...
class SitesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_site_flexumer_statistics_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'get_site_flexumer_statistics',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_sites_flexumers_statistics_endpoint = _Endpoint(
            settings={
                'response_type': ([SiteFlexumerStatistics],),
                'auth': [
                    'BearerAuth'
                ...
                'operation_id': 'get_sites_flexumers_statistics',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.read_device_activations_endpoint = _Endpoint(
            settings={
                'response_type': (DeviceActivation,),
                'auth': [
                    'BearerAuth'
                ],
        ...
        self.read_site_activations_endpoint = _Endpoint(
            settings={
                'response_type': ([ActivationStatusDataPoint],),
                'auth': [
                    'BearerAuth'
                ],
    ...
    def create_site(
        ...
        **kwargs
        ...
        Create a Site with all the information.  - **site_name**: each site must have a name - **flexumer_id**: each site must be associated with a flexumer - **weather_id**: each site must be associated with a weather station - **tariff_id**: each site must be associated with an electricity tariff - **energy_injection**: If True, energy can be injected into the grid - **location**: a site can optionally have a location - **country**: a site can optionally have a country - **country_code**: a site can optionally have an ISO 3166 country code - **timezone**: a site can optionally have a time zone - **latitude**: a site can optionally have a latitude - **longitude**: a site can optionally have a longitude - **elevation**: a site can optionally have an elevation - **microgrid**: a site must have a microgrid JSON describing devices and sensors  # noqa: E501
    ...
    def get_site_flexumer_statistics(
        self,
        site_id,
        start_time,
        end_time,
        **kwargs
        ...
        Get summary statistics of a flexumer for one site.  - **`reliability_index`, for now, only shows the non-missing data ratio, with 5-minutal frequency. Data is considered non-missing for a device if the device has data for any field during the 5-minute period.** - **`co2_reduction` is not implemented yet, and returns null.**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_site_flexumer_statistics(site_id, start_time, end_time, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['end_time'] = \
            end_time
        return self.get_site_flexumer_statistics_endpoint.call_with_http_info(**kwargs)
    ...
    def get_sites_flexumers_statistics(
        self,
        **kwargs
    ):
        """Get summary statistics of all sites  # noqa: E501

        Get summary statistics of all sites.  **Not implemented yet. This endpoint returns a reliability index of 1.0 for all sites.**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_sites_flexumers_statistics(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.get_sites_flexumers_statistics_endpoint.call_with_http_info(**kwargs)
    ...
    def read_device_activations(
        ...
        **kwargs
        ...
        Return the active activation at the given `end_time`.  If there is no active activation, return an empty response.  Activations lifetime is 15 minutes by default, but can be superseded by forthcoming activations.  Returns HTTP400 if the device is not controllable.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        Keyword Args:
            end_time (datetime): A timestamp in RFC3339 format, in UTC timezone (\"YYYY-MM-DDT00:00:00Z\"). Make sure to specify the timezone either with \"Z\" or \"+00:00\". If not provided, the default value is now.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
    ...
    def read_measurements(
        ...
        **kwargs
        ...
        Get devices measurements for selected device types.  The response list preserves the order of `device_types` query parameter.  - **Timestamps are ordered from oldest to newest** - **Data is returned with the same sign convention as when pushed** (not transformation applied)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def read_site_activations(
        ...
        **kwargs
        ...
        Return the time series of activations of a site.  A Site is considered to be activated if any of its controllable devices are activated.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.read_site_activations(site_id, start_time, end_time, async_req=True)
        >>> result = thread.get()
    ...
    def read_sites_activations(
        ...
        **kwargs
        ...
        Get activation state of all sites at the given `end_time`.  Activations lifetime is 15 minutes by default.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_device_activations(
        ...
        **kwargs
        ...
        >>> thread = api.update_device_activations(site_id, device_name, device_activation, async_req=True)
        >>> result = thread.get()
