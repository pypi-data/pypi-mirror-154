...
class TimeOfUseOffer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, offer_name, display_name, prices, *args, **kwargs):  # noqa: E501
        """TimeOfUseOffer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, offer_name, display_name, prices, *args, **kwargs):  # noqa: E501
        """TimeOfUseOffer - a model defined in OpenAPI
