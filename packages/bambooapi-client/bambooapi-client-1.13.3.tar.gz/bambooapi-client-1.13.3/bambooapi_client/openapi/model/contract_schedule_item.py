...
class ContractScheduleItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, period_name, power, energy_price, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, period_name, power, energy_price, *args, **kwargs):  # noqa: E501
        """ContractScheduleItem - a model defined in OpenAPI
