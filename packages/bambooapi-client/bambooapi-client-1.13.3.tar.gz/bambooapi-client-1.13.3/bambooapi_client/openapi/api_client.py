...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ClientsApi()
        api_instance.create_client  # this is an instance of the class Endpoint
        api_instance.create_client()  # this invokes api_instance.create_client.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_client.callable or self.callable in this class
