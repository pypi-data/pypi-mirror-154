...
class Menu(metaclass=_MenuMeta):
    ...
    ctx: Optional[:class:`commands.Context`]
        ...
        been started yet or :class:`discord.Interaction` is used instead.
    ...
    def buttons(self) -> Mapping[discord.PartialEmoji, Button]:
    ...
    def remove_button(
        ...
        Parameters
        ------------
        emoji: Union[:class:`Button`, :class:`str`, :class:`~discord.Emoji`, :class:`~discord.PartialEmoji`]
    ...
    async def start(
        ...
        *,
        ...
        :class:`Context <discord.ext.commands.Context>` or an :class:`Interaction <discord.Interaction>` object.

        Parameters
        -----------
        ctx: :class:`Context <discord.ext.commands.Context>`
    ...
    async def send_initial_message(
        self, ctx: Optional[commands.Context], channel: Optional[discord.abc.Messageable]
    ) -> discord.Message:
        """|coro|
...
class ButtonMenu(Menu, discord.ui.View):
    ...
    async def _update_view(self):
        """|coro|
        Updates the :class:`discord.ui.View` of the menu.
        Raises
        --------
        AssertionError
            The message is None.
    ...
    async def _set_all_disabled(self, disable: bool):
        """|coro|
        Enables or disables all :class:`discord.ui.Button` components in the menu. If the :attr:`message` is set,
        it will be edited with the new :class:`~discord.ui.View`.
        ...
        for child in self.children:
            if isinstance(child, discord.ui.Button) and child.disabled != disable:
    ...
    async def enable(self):
        """|coro|
        Enables all :class:`discord.ui.Button` components in the menu. If the :attr:`message` is set,
        it will be edited with the new :class:`~discord.ui.View`.
    ...
    async def disable(self):
        """|coro|
        Disables all :class:`discord.ui.Button` components in the menu. If the :attr:`message` is set,
        it will be edited with the new :class:`~discord.ui.View`.
    ...
    async def clear(self):
        """|coro|
        Removes all :class:`discord.ui.Button` components in the menu. If the :attr:`message` is set,
        it will be edited with the new :class:`~discord.ui.View`.
