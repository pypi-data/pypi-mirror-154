...
if __name__ == "__main__":
    ...
    patients_who_failed = dataset.create_hdf5_dataset(
        path_to_patients_folder=r"C:\Users\MALAR507\Documents\GitHub\ProstateCancerPrognosisAI\examples\local_data\Patients",
        tags_to_use_as_attributes=[(0x0008, 0x103E), (0x0020, 0x000E), (0x0008, 0x0060)],
        series_descriptions="data/series_descriptions_small_set.json",
        transforms=[transforms.Resample((1.5, 1.5, 1.5))],
        erase_unused_dicom_files=False,
    ...
    # # ----------------------------------------------------------------------------------------------------------- #
    # with open("data/series_descriptions_small_set.json", "r") as json_file:
    ...
    # )
    #
    # with open("data/series_descriptions_small_set.json", 'w', encoding='utf-8') as json_file:
    ...
    # # ----------------------------------------------------------------------------------------------------------- #
    # patients_who_failed = dataset.create_hdf5_dataset(
    #     path_to_patients_folder="data/small_set",
    #     tags_to_use_as_attributes=[(0x0008, 0x103E), (0x0020, 0x000E), (0x0008, 0x0060)],
