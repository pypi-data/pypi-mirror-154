...
def setup_yams_object(command):
    ...
    commands['push'].add_argument_as_dict(expiration)

    push_object_mutually_exclusive_group = commands['push'].add_mutually_exclusive_group(required=False)
    push_object_mutually_exclusive_group.add_argument(
        '--recursive', action='store_true', help="upload all the files in a directory, recursively")
    push_object_mutually_exclusive_group.add_argument('--object-name', help="name of the object. Default: Object ID's UUIDv4")
