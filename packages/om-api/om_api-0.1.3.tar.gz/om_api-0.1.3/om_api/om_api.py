...
def make_request(request_type: str, param: dict = ..., data: dict = ..., url = globals()['URL'], cookie = globals()['COOKIE']):
    if param is ...:
        param = {}
    if data is ...:
        data = {}
...
def get_properties(list_name: str, url = globals()['URL'], cookie = globals()['COOKIE']):
