...
from modules.demo_module import settings, worker_task

class DemoModule(module_base.ModuleBase):
    ...
    def do_stop(self):
        ...
        if self.worker_thread.is_running():
            ...
            self.worker_thread.stop(wait=True)
    ...
    def setup_worker_thread(self):
        ...
        self.worker_thread.sig_started.connect(self._on_sig_worker_started)
        self.worker_thread.sig_finished.connect(self._on_sig_worker_finished)
    ...
    def start_worker(self):
        if not self.worker_thread.is_running():
    ...
    def update_worker_parameter(self):
        ...
        self.worker_thread.par_time_between_ticks = 0.1
    ...
    def _on_sig_worker_finished(self):
        ...
        if not self.worker_thread.is_aborted():
