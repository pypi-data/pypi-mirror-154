...
class I2CBusMaster():
    ...
    def __init__(self, spm_ctrl: spm.Spm = None, instance_id: I2CInstances = I2CInstances.CONTROLLER, master_type: I2CMasterType = I2CMasterType.EMBEDDED_AVALON, bus_id: I2CBusID = I2CBusID.Undef, bus_speed: I2CBusSpeed = I2CBusSpeed.kHz_400):
    ...
    def setup_metadata(self, addr: int, offset_mode: 'I2CChip.I2COffsetMode', auto_lock: bool = True):
        self._test_obj.I2CSetupMetaDataEx(self._rx_packet_buffer_len, self._tx_packet_buffer_len, I2CBusMaster.I2CSyncing.NoSync, I2CBusMaster.I2CByteMode.SingleByteOff, self._bus_speed)
