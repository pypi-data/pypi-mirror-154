...
package Librflxlang.Analysis is
   ...
   ---------------
      ...
      type RFLX_Node is tagged private;
      ...
      type AbstractID is new RFLX_Node with private
      ;
      --  Base class for identifiers.
      type Type_Def is new RFLX_Node with private
      ;
      ...
      type Aspect is new RFLX_Node with private
      ;
      
      type RFLX_Node_Base_List is new RFLX_Node with private
      ;
      
      type Aspect_List is new RFLX_Node_Base_List with private
      ...
      type Attr_Stmt is new RFLX_Node with private
      ;
      ...
      type Expr is new RFLX_Node with private
      ;
      ...
      ;
      --  Attribute statement.
      type Base_Aggregate is new RFLX_Node with private
      ;
      --  Base class for message aggregates.
      type Base_Checksum_Val is new RFLX_Node with private
      ;
      --  Base class for checksum values.
      type Base_Checksum_Val_List is new RFLX_Node_Base_List with private
      ...
      type Base_State_Body is new RFLX_Node with private
      ;
      ...
      type Message_Aspect is new RFLX_Node with private
      ;
      --  Base class for message aspects.
      type Byte_Order_Aspect is new Message_Aspect with private
      ;
      
      type Byte_Order_Type is new RFLX_Node with private
      ;
      ...
      type Channel_Attribute is new RFLX_Node with private
      ;
      --  Base class for channel attributes.
      type Channel_Attribute_List is new RFLX_Node_Base_List with private
      ...
      type Checksum_Assoc is new RFLX_Node with private
      ;
      --  Association between checksum field and list of covered fields.
      type Checksum_Assoc_List is new RFLX_Node_Base_List with private
      ...
      type Choice_List is new RFLX_Node_Base_List with private
      ...
      type Transition is new RFLX_Node with private
      ;
      ...
      type Conditional_Transition_List is new RFLX_Node_Base_List with private
      ...
      type Context_Item_List is new RFLX_Node_Base_List with private
      ...
      type Declaration is new RFLX_Node with private
      ;
      --  Base class for declarations (types, refinements, sessions).
      type Declaration_List is new RFLX_Node_Base_List with private
      ...
      ;
      --  List of Declaration.
      type Description is new RFLX_Node with private
      ;
      --  String description of an entity.
      type Element_Value_Assoc is new RFLX_Node with private
      ;
      --  Element/value association.
      type Element_Value_Assoc_List is new RFLX_Node_Base_List with private
      ...
      type Expr_List is new RFLX_Node_Base_List with private
      ...
      --
      --  * Variable
      type Formal_Decl is new RFLX_Node with private
      ;
      --  Base class for generic formal session declarations.
      type Formal_Channel_Decl is new Formal_Decl with private
      ;
      
      type Formal_Decl_List is new RFLX_Node_Base_List with private
      ...
      type Formal_Private_Type_Decl is new Formal_Decl with private
      ;
      --  Formal private session type declaration.
      type ID is new AbstractID with private
      ;
      ...
      type Local_Decl is new RFLX_Node with private
      ;
      --  Base class for session or state local declarations.
      type Local_Decl_List is new RFLX_Node_Base_List with private
      ...
      type Message_Aggregate_Association is new RFLX_Node with private
      ;
      
      type Message_Aggregate_Association_List is new RFLX_Node_Base_List with private
      ...
      type Message_Aspect_List is new RFLX_Node_Base_List with private
      ...
      type Message_Field is new RFLX_Node with private
      ;
      
      type Message_Field_Assignment is new Statement with private
      ;
      --  Assignment of expression to message field.
      type Message_Field_List is new RFLX_Node_Base_List with private
      ...
      type Message_Fields is new RFLX_Node with private
      ;
      ...
      type NullID is new AbstractID with private
      ;
      --  'null' identifier.
      type Null_Message_Aggregate is new Base_Aggregate with private
      ;
      
      type Null_Message_Field is new RFLX_Node with private
      ;
      
      type Null_Message_Type_Def is new Abstract_Message_Type_Def with private
      ;
      
      type Null_State_Body is new Base_State_Body with private
      ;
      
      type Numeric_Literal is new Expr with private
      ;
      
      type Numeric_Literal_List is new RFLX_Node_Base_List with private
      ...
      type Op is new RFLX_Node with private
      ;
      ...
      type Package_Node is new RFLX_Node with private
      ;
      
      type Parameter is new RFLX_Node with private
      ;
      
      type Parameter_List is new RFLX_Node_Base_List with private
      ...
      ;
      --  List of Parameter.
      type Parameters is new RFLX_Node with private
      ;
      ...
      type Quantifier is new RFLX_Node with private
      ;
      --  Quantifier kind.
      ...
      type RFLX_Node_List is new RFLX_Node_Base_List with private
         with Iterable => (First       => RFLX_Node_List_First,
                           Next        => RFLX_Node_List_Next,
                           Has_Element => RFLX_Node_List_Has_Element,
                           Element     => RFLX_Node_List_Element)
      ;
      --  List of RFLXNode.
      --
      --  This list node can contain one of the following nodes:
      ...
      type Session_Aspects is new RFLX_Node with private
      ;
      --  Session aspects (Initial, Final).
      type Session_Decl is new Declaration with private
      ;
      
      type Specification is new RFLX_Node with private
      ;
      --  RecordFlux specification.
      type State is new RFLX_Node with private
      ;
      --  Session state.
      type State_Body is new Base_State_Body with private
      ;
      --  Body of a session state.
      type State_List is new RFLX_Node_Base_List with private
      ...
      ;
      --  List of State.
      type Statement_List is new RFLX_Node_Base_List with private
      ...
      type Term_Assoc is new RFLX_Node with private
      ;
      
      type Term_Assoc_List is new RFLX_Node_Base_List with private
      ...
      ;
      --  List of TermAssoc.
      type Then_Node is new RFLX_Node with private
      ;
      --  Link to field.
      type Then_Node_List is new RFLX_Node_Base_List with private
      ...
      ;
      --  List of Then.
      type Type_Argument is new RFLX_Node with private
      ;
      
      type Type_Argument_List is new RFLX_Node_Base_List with private
      ...
      type UnqualifiedID is new AbstractID with private
      ;
      --  Simple, unqualified identifiers, i.e. identifiers without a package
      --  part (e.g. "Foo").
      type UnqualifiedID_List is new RFLX_Node_Base_List with private
         with Iterable => (First       => UnqualifiedID_List_First,
                           Next        => UnqualifiedID_List_Next,
                           Has_Element => UnqualifiedID_List_Has_Element,
                           Element     => UnqualifiedID_List_Element)
      ;
      ...
      No_RFLX_Node : constant RFLX_Node;
      ...
      --  constant.
      No_AbstractID : constant AbstractID;
      --% no-document: True
      ...
      --% no-document: True
      No_RFLX_Node_Base_List : constant RFLX_Node_Base_List;
      --% no-document: True
      ...
      --% no-document: True
      No_Base_State_Body : constant Base_State_Body;
      --% no-document: True
      ...
      --% no-document: True
      No_Formal_Private_Type_Decl : constant Formal_Private_Type_Decl;
      --% no-document: True
      No_ID : constant ID;
      --% no-document: True
      ...
      --% no-document: True
      No_Null_State_Body : constant Null_State_Body;
      --% no-document: True
      ...
      --% no-document: True
      No_RFLX_Node_List : constant RFLX_Node_List;
      --% no-document: True
      ...
      --% no-document: True
      No_Session_Aspects : constant Session_Aspects;
      --% no-document: True
      ...
      --% no-document: True
      No_UnqualifiedID : constant UnqualifiedID;
      --% no-document: True
      No_UnqualifiedID_List : constant UnqualifiedID_List;
      --% no-document: True
   ...
   function Is_Null (Node : RFLX_Node'Class) return Boolean;
   --  Return whether this node is a null node reference.

   function Is_Token_Node
     (Node : RFLX_Node'Class) return Boolean;
   ...
   function "=" (L, R : RFLX_Node'Class) return Boolean;
   --  Return whether L and R designate the same entity

   function Image (Node : RFLX_Node'Class) return String;
   ...
   function Root (Unit : Analysis_Unit'Class) return RFLX_Node;
   ...
   ---------------------
      ...
      type RFLX_Node_Array is
         array (Positive range <>) of RFLX_Node;
   ...
   function Kind
     (Node : RFLX_Node'Class) return RFLX_Node_Kind_Type;
   function Kind_Name (Node : RFLX_Node'Class) return String;
   ...
   function Parents
     (Node : RFLX_Node'Class;
      With_Self : Boolean := True) return RFLX_Node_Array;
   ...
   function Children
     (Node : RFLX_Node'Class) return RFLX_Node_Array;
   --  Return an array that contains the direct lexical children.

         
   function Token_Start
     (Node : RFLX_Node'Class) return Token_Reference;
   ...
   function Child_Index
     (Node : RFLX_Node'Class) return Integer;
   ...
   function Unit
     (Node : RFLX_Node'Class) return Analysis_Unit;
   ...
   function Full_Sloc_Image
     (Node : RFLX_Node'Class) return Text_Type;
   ...
   function F_Identifier
     (Node : Formal_Private_Type_Decl'Class) return UnqualifiedID;
   ...
   --  * Variable
         ...
         function RFLX_Node_List_First (Node : RFLX_Node_List) return Positive;
         --  Implementation detail for the Iterable aspect

         function RFLX_Node_List_Next
           (Node : RFLX_Node_List; Cursor : Positive) return Positive;
         --  Implementation detail for the Iterable aspect

         function RFLX_Node_List_Has_Element
           (Node : RFLX_Node_List; Cursor : Positive) return Boolean;
         --  Implementation detail for the Iterable aspect

         function RFLX_Node_List_Element
           (Node : RFLX_Node_List; Cursor : Positive)
            return RFLX_Node'Class;
         --  Implementation detail for the Iterable aspect
   ...
   function F_Base
     (Node : Type_Derivation_Def'Class) return ID;
         ...
         function List_Child
           (Node : UnqualifiedID_List'Class; Index : Positive)
            return UnqualifiedID;
         --  Return the ``Index``'th child of ``Node``, or null if ``Node`` has
         --  no such child.

         function UnqualifiedID_List_First (Node : UnqualifiedID_List) return Positive;
         --  Implementation detail for the Iterable aspect

         function UnqualifiedID_List_Next
           (Node : UnqualifiedID_List; Cursor : Positive) return Positive;
         --  Implementation detail for the Iterable aspect

         function UnqualifiedID_List_Has_Element
           (Node : UnqualifiedID_List; Cursor : Positive) return Boolean;
         --  Implementation detail for the Iterable aspect

         function UnqualifiedID_List_Element
           (Node : UnqualifiedID_List; Cursor : Positive)
   ...
   function Children_Count
     (Node : RFLX_Node'Class) return Natural;
   ...
   function Sloc_Range
     (Node : RFLX_Node'Class) return Source_Location_Range;
   ...
   function Lookup
     (Node : RFLX_Node'Class;
      Sloc : Source_Location) return RFLX_Node;
   ...
   function Text (Node : RFLX_Node'Class) return Text_Type;
   ...
   function Token_Range
     (Node : RFLX_Node'Class) return Token_Iterator;
   ...
   --  to another (RFLX_Node can refer to any node type). They
   ...
   pragma Warnings (Off, "defined after private extension");
      ...
      --% no-document: True
      function As_Formal_Private_Type_Decl
        (Node : RFLX_Node'Class) return Formal_Private_Type_Decl;
      --% no-document: True
      function As_ID
   ...
   function Hash
     (Node : RFLX_Node) return Ada.Containers.Hash_Type;
...
private
   ...
   --------------------------
         ...
         type RFLX_Node is tagged record
      ...
      No_RFLX_Node : constant RFLX_Node :=
        (Internal   => Implementation.No_Entity,
         ...
         type AbstractID is new RFLX_Node with null record;
      No_AbstractID : constant AbstractID :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Type_Def is new RFLX_Node with null record;
      No_Type_Def : constant Type_Def :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Abstract_Message_Type_Def : constant Abstract_Message_Type_Def :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Aspect is new RFLX_Node with null record;
      No_Aspect : constant Aspect :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type RFLX_Node_Base_List is new RFLX_Node with null record;
      No_RFLX_Node_Base_List : constant RFLX_Node_Base_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Aspect_List is new RFLX_Node_Base_List with null record;
      No_Aspect_List : constant Aspect_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Statement is new RFLX_Node with null record;
      No_Statement : constant Statement :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Assignment : constant Assignment :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Attr is new RFLX_Node with null record;
      No_Attr : constant Attr :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Attr_Size : constant Attr_Size :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Attr_Stmt is new RFLX_Node with null record;
      No_Attr_Stmt : constant Attr_Stmt :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Attr_Valid_Checksum : constant Attr_Valid_Checksum :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Expr is new RFLX_Node with null record;
      No_Expr : constant Expr :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Attribute_Statement : constant Attribute_Statement :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Base_Aggregate is new RFLX_Node with null record;
      No_Base_Aggregate : constant Base_Aggregate :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Base_Checksum_Val is new RFLX_Node with null record;
      No_Base_Checksum_Val : constant Base_Checksum_Val :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Base_Checksum_Val_List is new RFLX_Node_Base_List with null record;
      No_Base_Checksum_Val_List : constant Base_Checksum_Val_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Base_State_Body is new RFLX_Node with null record;
      No_Base_State_Body : constant Base_State_Body :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Binding : constant Binding :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Message_Aspect is new RFLX_Node with null record;
      No_Message_Aspect : constant Message_Aspect :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Byte_Order_Aspect : constant Byte_Order_Aspect :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Byte_Order_Type is new RFLX_Node with null record;
      No_Byte_Order_Type : constant Byte_Order_Type :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Case_Expression : constant Case_Expression :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Channel_Attribute is new RFLX_Node with null record;
      No_Channel_Attribute : constant Channel_Attribute :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Channel_Attribute_List is new RFLX_Node_Base_List with null record;
      No_Channel_Attribute_List : constant Channel_Attribute_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Checksum_Aspect : constant Checksum_Aspect :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Checksum_Assoc is new RFLX_Node with null record;
      No_Checksum_Assoc : constant Checksum_Assoc :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Checksum_Assoc_List is new RFLX_Node_Base_List with null record;
      No_Checksum_Assoc_List : constant Checksum_Assoc_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Choice : constant Choice :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Choice_List is new RFLX_Node_Base_List with null record;
      No_Choice_List : constant Choice_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Concatenation : constant Concatenation :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Transition is new RFLX_Node with null record;
      No_Transition : constant Transition :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Conditional_Transition : constant Conditional_Transition :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Conditional_Transition_List is new RFLX_Node_Base_List with null record;
      No_Conditional_Transition_List : constant Conditional_Transition_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Context_Item : constant Context_Item :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Context_Item_List is new RFLX_Node_Base_List with null record;
      No_Context_Item_List : constant Context_Item_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Conversion : constant Conversion :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Declaration is new RFLX_Node with null record;
      No_Declaration : constant Declaration :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Declaration_List is new RFLX_Node_Base_List with null record;
      No_Declaration_List : constant Declaration_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Description is new RFLX_Node with null record;
      No_Description : constant Description :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Element_Value_Assoc is new RFLX_Node with null record;
      No_Element_Value_Assoc : constant Element_Value_Assoc :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Element_Value_Assoc_List is new RFLX_Node_Base_List with null record;
      No_Element_Value_Assoc_List : constant Element_Value_Assoc_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Enumeration_Type_Def : constant Enumeration_Type_Def :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Expr_List is new RFLX_Node_Base_List with null record;
      No_Expr_List : constant Expr_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Formal_Decl is new RFLX_Node with null record;
      No_Formal_Decl : constant Formal_Decl :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Formal_Channel_Decl : constant Formal_Channel_Decl :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Formal_Decl_List is new RFLX_Node_Base_List with null record;
      No_Formal_Decl_List : constant Formal_Decl_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Formal_Function_Decl : constant Formal_Function_Decl :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Formal_Private_Type_Decl is new Formal_Decl with null record;
      No_Formal_Private_Type_Decl : constant Formal_Private_Type_Decl :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type ID is new AbstractID with null record;
      No_ID : constant ID :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Integer_Type_Def : constant Integer_Type_Def :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Local_Decl is new RFLX_Node with null record;
      No_Local_Decl : constant Local_Decl :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Local_Decl_List is new RFLX_Node_Base_List with null record;
      No_Local_Decl_List : constant Local_Decl_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Message_Aggregate : constant Message_Aggregate :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Message_Aggregate_Association is new RFLX_Node with null record;
      No_Message_Aggregate_Association : constant Message_Aggregate_Association :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Message_Aggregate_Association_List is new RFLX_Node_Base_List with null record;
      No_Message_Aggregate_Association_List : constant Message_Aggregate_Association_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Message_Aggregate_Associations : constant Message_Aggregate_Associations :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Message_Aspect_List is new RFLX_Node_Base_List with null record;
      No_Message_Aspect_List : constant Message_Aspect_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Message_Field is new RFLX_Node with null record;
      No_Message_Field : constant Message_Field :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Message_Field_Assignment : constant Message_Field_Assignment :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Message_Field_List is new RFLX_Node_Base_List with null record;
      No_Message_Field_List : constant Message_Field_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Message_Fields is new RFLX_Node with null record;
      No_Message_Fields : constant Message_Fields :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Negation : constant Negation :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type NullID is new AbstractID with null record;
      No_NullID : constant NullID :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Null_Message_Aggregate : constant Null_Message_Aggregate :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Null_Message_Field is new RFLX_Node with null record;
      No_Null_Message_Field : constant Null_Message_Field :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Null_Message_Type_Def : constant Null_Message_Type_Def :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Null_State_Body is new Base_State_Body with null record;
      No_Null_State_Body : constant Null_State_Body :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Numeric_Literal : constant Numeric_Literal :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Numeric_Literal_List is new RFLX_Node_Base_List with null record;
      No_Numeric_Literal_List : constant Numeric_Literal_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Op is new RFLX_Node with null record;
      No_Op : constant Op :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Op_Sub : constant Op_Sub :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Package_Node is new RFLX_Node with null record;
      No_Package_Node : constant Package_Node :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Parameter is new RFLX_Node with null record;
      No_Parameter : constant Parameter :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Parameter_List is new RFLX_Node_Base_List with null record;
      No_Parameter_List : constant Parameter_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Parameters is new RFLX_Node with null record;
      No_Parameters : constant Parameters :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Quantified_Expression : constant Quantified_Expression :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Quantifier is new RFLX_Node with null record;
      No_Quantifier : constant Quantifier :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Quantifier_Some : constant Quantifier_Some :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type RFLX_Node_List is new RFLX_Node_Base_List with null record;
      No_RFLX_Node_List : constant RFLX_Node_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Sequence_Type_Def : constant Sequence_Type_Def :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Session_Aspects is new RFLX_Node with null record;
      No_Session_Aspects : constant Session_Aspects :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Session_Decl : constant Session_Decl :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Specification is new RFLX_Node with null record;
      No_Specification : constant Specification :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type State is new RFLX_Node with null record;
      No_State : constant State :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type State_Body is new Base_State_Body with null record;
      No_State_Body : constant State_Body :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type State_List is new RFLX_Node_Base_List with null record;
      No_State_List : constant State_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Statement_List is new RFLX_Node_Base_List with null record;
      No_Statement_List : constant Statement_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_String_Literal : constant String_Literal :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Term_Assoc is new RFLX_Node with null record;
      No_Term_Assoc : constant Term_Assoc :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Term_Assoc_List is new RFLX_Node_Base_List with null record;
      No_Term_Assoc_List : constant Term_Assoc_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Then_Node is new RFLX_Node with null record;
      No_Then_Node : constant Then_Node :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Then_Node_List is new RFLX_Node_Base_List with null record;
      No_Then_Node_List : constant Then_Node_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Type_Argument is new RFLX_Node with null record;
      No_Type_Argument : constant Type_Argument :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type Type_Argument_List is new RFLX_Node_Base_List with null record;
      No_Type_Argument_List : constant Type_Argument_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
      ...
      No_Type_Derivation_Def : constant Type_Derivation_Def :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type UnqualifiedID is new AbstractID with null record;
      No_UnqualifiedID : constant UnqualifiedID :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
         type UnqualifiedID_List is new RFLX_Node_Base_List with null record;
      No_UnqualifiedID_List : constant UnqualifiedID_List :=
        (Internal   => Implementation.No_Entity,
         Safety_Net => Implementation.No_Node_Safety_Net);
   ...
   procedure Check_Safety_Net (Self : RFLX_Node'Class);
   ...
   procedure RN (Node : Librflxlang.Implementation.Bare_RFLX_Node)
