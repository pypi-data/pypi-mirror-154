...
class BaseSource(ABC):
    ...
    def __init_subclass__(cls, **kwargs: Any) -> None:
        # Call BaseSource __init__ when initialising subclass
    ...
    def _get_dtypes(cls) -> _GetDtypesCallable:
        ...
        def get_dtypes(self: BaseSource, **kwargs: Any) -> _Dtypes:
    ...
    def _get_column(
        ...
        def get_column(self: BaseSource, col_name: str, **kwargs: Any) -> _Column:
