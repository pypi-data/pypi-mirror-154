...
class PersistedTask(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["app_name",b"app_name","current_iteration",b"current_iteration","encoded_args",b"encoded_args","id",b"id","manifest",b"manifest","parent_task_id",b"parent_task_id","qualified_symbol",b"qualified_symbol","result",b"result","status",b"status","with_checkpointing",b"with_checkpointing"]) -> None: ...
