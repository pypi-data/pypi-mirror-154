...
@LastEditTime: 2022-06-14 13:57:15
    ...
    def get_client_task_list(self,app_id,act_id,module_id,user_id,task_types="",app_key="",app_secret="",is_log=False,daily_repeat_browse=False):
        ...
        for task_info_dict in task_info_list:
            ...
            if task_info_dict["task_type"] == TaskType.free_gift.value:
                ...
                result["text"] = ["领取", "已领取"]
                result["get_ways"] = 0 #0-接口自动领取 1-前端调用领取
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/free_gift"
            ...
            #单次签到
                ...
                result["text"] = ["签到", "已签到"]
                result["get_ways"] = 0 #0-接口自动领取 1-前端调用领取
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/one_sign"
                result_list.append(result)
            #每周签到(status:0当天未签到1当天已签到2已完成)
                ...
                result["get_ways"] = 0 #0-接口自动领取 1-前端调用领取
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/weekly_sign"
                result_list.append(result)
            #累计签到(status:0当天未签到1当天已签到2已完成)
                ...
                result["text"] = ["签到", "已签到","已完成"]
                result["get_ways"] = 0 #0-接口自动领取 1-前端调用领取
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/cumulative_sign"
                result_list.append(result)
            #邀请新用户
                ...
                result["get_ways"] = 1
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/invite_new_user"
                result_list.append(result)
            #邀请加入会员
                ...
                result["text"] = ["去邀请", "领取", "已完成"]
                result["get_ways"] = 1
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/invite_join_member"
                result_list.append(result)
            #关注店铺
                ...
                result["text"] = ["去关注", "已关注"]
                result["get_ways"] = 0
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/favor_store"
                result_list.append(result)
            #加入会员
                ...
                result["get_ways"] = 0
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/join_member"
                result_list.append(result)
            #收藏商品
                ...
                result["get_ways"] = 1
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/collect_goods"
                result_list.append(result)
            #浏览商品
                ...
                result["get_ways"] = 1
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/browse_goods"
                result_list.append(result)
            #浏览网址
                ...
                for sub_config_json in config_json:
                    ...
                    result = {}
                    result["route_url"] = task_info_dict["route_url"]
                    result["sort_index"] = task_info_dict["sort_index"]
                    result["task_id"] = task_info_dict["id"]
                    result["task_type"] = task_info_dict["task_type"]
                    ...
                    result["text"] = ["去浏览", "已完成"]
                    result["get_ways"] = 1
                    result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/browse_site"
                    result_list.append(result)
            #分享奖励
                ...
                result["get_ways"] = 1
                result["route_url"] = task_info_dict["route_url"] if task_info_dict["route_url"] else "/client/task_share"
                result_list.append(result)
