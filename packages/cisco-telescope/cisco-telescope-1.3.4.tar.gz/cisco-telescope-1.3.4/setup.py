...
['Flask>=2.1.2,<3.0.0',
 ...
 'cisco-opentelemetry-specifications>=0.0.18,<0.0.19',
 ...
 'opentelemetry-distro>=0.29b0,<0.30',
 'opentelemetry-exporter-otlp-proto-grpc>=1.10.0,<2.0.0',
 'opentelemetry-exporter-otlp-proto-http>=1.10.0,<2.0.0',
 'opentelemetry-exporter-otlp>=1.10.0,<2.0.0',
 'opentelemetry-instrumentation-aiohttp-client>=0.29b0,<0.30',
 'opentelemetry-instrumentation-fastapi>=0.29b0,<0.30',
 'opentelemetry-instrumentation-flask>=0.29b0,<0.30',
 'opentelemetry-instrumentation-grpc>=0.29b0,<0.30',
 'opentelemetry-instrumentation-httpx>=0.29b0,<0.30',
 'opentelemetry-instrumentation-requests>=0.29b0,<0.30',
 'opentelemetry-sdk>=1.10.0,<2.0.0',
 'opentelemetry-test-utils>=0.29b0,<0.30',
 'opentelemetry-util-http>=0.29b0,<0.30',
