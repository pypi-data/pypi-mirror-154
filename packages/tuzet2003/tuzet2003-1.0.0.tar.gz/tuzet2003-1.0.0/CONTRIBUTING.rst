...
**tuzet2003** could always use more documentation, whether as
part of the official **tuzet2003** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `tuzet2003` for local
development.

1. Fork the `tuzet2003` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/tuzet2003.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd tuzet2003
    (dvlpt) tuzet2003$ flake8
    (dvlpt) tuzet2003$ pytest
...
.. _issues: https://gitlab.com/b326/tuzet2003/issues
