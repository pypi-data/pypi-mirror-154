...
class MetadataStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetResourceUpdateStatus = channel.unary_unary(
                '/featureform.serving.metadata.proto.Metadata/SetResourceUpdateStatus',
                request_serializer=featureform_dot_proto_dot_metadata__pb2.SetUpdateStatusRequest.SerializeToString,
                response_deserializer=featureform_dot_proto_dot_metadata__pb2.Empty.FromString,
                )
...
class MetadataServicer(object):
    ...
    def SetResourceUpdateStatus(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MetadataServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetResourceUpdateStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.SetResourceUpdateStatus,
                    request_deserializer=featureform_dot_proto_dot_metadata__pb2.SetUpdateStatusRequest.FromString,
                    response_serializer=featureform_dot_proto_dot_metadata__pb2.Empty.SerializeToString,
            ),
...
class Metadata(object):
    ...
    @staticmethod
    def SetResourceUpdateStatus(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/featureform.serving.metadata.proto.Metadata/SetResourceUpdateStatus',
            featureform_dot_proto_dot_metadata__pb2.SetUpdateStatusRequest.SerializeToString,
            featureform_dot_proto_dot_metadata__pb2.Empty.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
