            ...
            while True:
                ...
                if (
                    ...
                    try:
                        ...
                        nb_errors += 1
                        logger.exception(
                            f"SKIP image: error getting info for {image_path_str}"
                        )
                        nb_todo -= 1
                        continue
                    ...
                    if (
                        ...
                        logger.info(
                            ...
                            f"{max_cloudcover_pct} for {image_path_str}"
                        )
                        nb_todo -= 1
                        continue
                    ...
                    try:
                        ...
                        if prepare_calc_result["nb_features_to_calc_total"] == 0:
                            for band in bands:
                                ...
                                create_file_atomic(output_band_path)
...
def load_features_file(
    ...
    if not (features_prepr_path_busy.exists() or features_prepr_path.exists()):
        ...
        if create_file_atomic(features_prepr_path_busy):
