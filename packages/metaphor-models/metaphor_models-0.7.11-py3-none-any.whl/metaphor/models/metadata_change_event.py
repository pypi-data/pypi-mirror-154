...
class DesignatedContact:
    ...
    def from_dict(obj: Any) -> 'DesignatedContact':
        ...
        value_type = from_union([ValueTypeEnum, from_none], obj.get("valueType"))
    ...
    def to_dict(self) -> dict:
        ...
        result["valueType"] = from_union([lambda x: to_enum(ValueTypeEnum, x), from_none], self.value_type)
        return result
...
@dataclass
class Ownership:
    type: Optional[ValueTypeEnum] = None
    value: Optional[str] = None

    @staticmethod
    def from_dict(obj: Any) -> 'Ownership':
        assert isinstance(obj, dict)
        type = from_union([ValueTypeEnum, from_none], obj.get("type"))
        value = from_union([from_str, from_none], obj.get("value"))
        return Ownership(type, value)

    def to_dict(self) -> dict:
        result: dict = {}
        result["type"] = from_union([lambda x: to_enum(ValueTypeEnum, x), from_none], self.type)
        result["value"] = from_union([from_str, from_none], self.value)
        return result
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, asset_contacts, dataset_created_at, deleted_at, documentation, entity_type, field_statistics, dataset_id, last_modified_at, logical_id, ownership_assignment, properties, query_history, schema, soda_data_quality, source_info, statistics, support_info, tag_assignment, upstream, usage, usage_history)
...
class ThoughtSpotColumn:
    ...
    def from_dict(obj: Any) -> 'ThoughtSpotColumn':
        ...
        name = from_union([from_str, from_none], obj.get("name"))
        type = from_union([from_str, from_none], obj.get("type"))
        return ThoughtSpotColumn(description, field, name, type)
