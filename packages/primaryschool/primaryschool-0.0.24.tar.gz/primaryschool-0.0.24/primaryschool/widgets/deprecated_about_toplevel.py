...
class AboutToplevel(WidgetABC):
    def __init__(
        ...
        super().__init__(ps)
        self.w = w or self.ps.get_screenwidth(of=4)
        self.h = h or self.ps.get_screenheight(of=4)
        self.x = x or 3 * self.ps.get_screenwidth(of=8)
        self.y = y or 3 * self.ps.get_screenheight(of=8)
        self.withdraw = False
