...
setup_kwargs = {
    'name': 'reflekt',
    'version': '0.1.8',
    'description': 'Reflekt enables anyone using dbt to automagically build a dbt package that models and documents the events in a tracking plan pulled from an Analytics Governance tool, ready for use in a dbt project.',
