...
def mult_convergence(search_dir,with_surrogate=True,werr=True,niters=None,nruns=None,debug=False,median=False,**kwargs):
    ...
    for fname in sorted(glob.glob(path)):
        ...
        for i,line in enumerate(content):
            ...
            if target_unc in line:
                ...
                data.append([loss,std]+network_prms+samples+[nevals,time])
                hps.append(samples)
