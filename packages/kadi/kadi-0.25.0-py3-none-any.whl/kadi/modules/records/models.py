...
class RecordVisiblity(StringEnum):
...
class RecordState(StringEnum):
    ...
    __values__ = [const.MODEL_STATE_ACTIVE, "deleted", "purged"]
...
class Record(
    ...
    class Meta:
        ...
        permissions = {
            ...
            "default_permissions": {"read": {"visibility": RecordVisiblity.PUBLIC}},
        }
        ...
        check_constraints = {
            ...
            "visibility": {"values": RecordVisiblity.__values__},
