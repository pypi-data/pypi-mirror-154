...
def update_file(file, **kwargs):
    ...
    Note that this function acquires a lock on the given file and issues a database
    commit or rollback.
...
def delete_file(file, create_revision=True, revision_user=None):
    ...
    Note that this function acquires a lock on the given file and issues one or more
    database commits.
