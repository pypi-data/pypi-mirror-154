...
from openapiipify import rest
from openapiipify.configuration import Configuration
from openapiipify.exceptions import ApiTypeError, ApiValueError, ApiException
from openapiipify.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_ip  # this is an instance of the class Endpoint
        api_instance.get_ip()  # this invokes api_instance.get_ip.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_ip.callable or self.callable in this class
