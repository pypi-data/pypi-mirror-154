...
# installed yet)
version = re.search(r'__version__ = "([^"]+)"', text_of("officeasy/__init__.py")).group(1)


NAME = "officeasy"
VERSION = version
DESCRIPTION = "office easy"
KEYWORDS = "office word ppt excel"
AUTHOR = "kerol"
AUTHOR_EMAIL = "ikerol@163.com"
URL = "https://github.com/kerol/officeasy"
