...
def table_aggregate(table, groupby, agg, map_values=None):
    ...
    # First go backwards sorting with groupby so that we have everything sorted
...
def table_to_dict(table, keyindex, valindex, keys=None, default=None):
