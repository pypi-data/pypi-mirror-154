...
class HTMLFormatter(OutputFormatter):
    def __init__(self, format="html", templatedir='', template=dict(), headers=dict()):
        OutputFormatter.__init__(self, format, templatedir, template, headers)
        self.figformat = "svg"
    ...
    def output(self, templatemarkdown, templatefile='', docformat='html', outputfile='', options={}):
