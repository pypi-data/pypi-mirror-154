...
def create_card_cell_link(board_filepath, card_id, notebook, cell_index):
    """Add link between a Halerium board card and notebook cell.

    Parameters
    ----------
    board_filepath :
        The file path of the board to add a card to.
    card_id :
        The id of the card.
    notebook:
    ...
    notebook['cells'][cell_index]['connections'].append(link)
