...
from .board import create_card, add_card_to_board
from ..utilities.model_description import get_model_description
...
def add_card_from_sklearn_model(board,
    ...
    ops = [{'attributes': {'header': '1'}, 'insert': f'{model_name}\n'},
           {'insert': description}]
