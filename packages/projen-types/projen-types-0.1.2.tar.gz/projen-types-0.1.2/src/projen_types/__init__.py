...
class MnsAwsCdkPythonApp(
    projen.awscdk.AwsCdkPythonApp,
    metaclass=jsii.JSIIMeta,
    jsii_type="projen-types.MnsAwsCdkPythonApp",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        options = projen.awscdk.AwsCdkPythonAppOptions(
...
class MnsAwsCdkTypeScriptApp(
    projen.awscdk.AwsCdkTypeScriptApp,
    metaclass=jsii.JSIIMeta,
    jsii_type="projen-types.MnsAwsCdkTypeScriptApp",
):
    '''AWS CDK app in Python.
    ...
    def __init__(
        ...
        *,
        ...
        :param renovatebot_options: (experimental) Options for renovatebot. Default: - default options
        '''
        options = projen.awscdk.AwsCdkTypeScriptAppOptions(
            app_entrypoint=app_entrypoint,
