...
if __name__ == '__main__':
    ...
    from flatspin.plotting import plot_h_ext

    enc = Sine(H0=0.5, H=1.0, phi=30, timesteps=100)
    print(enc)
    print('params:', enc.get_params())
    ...
    grid = [[0,.5,0],[.5,1,.5],[0,.5,0]]
    #enc = ConstantGrid(H0=0.5, H=1.0, grid=grid, phi=0)
    enc = SineGrid(H0=0.1, H=1.0, grid=grid, timesteps=100, phi=30)
