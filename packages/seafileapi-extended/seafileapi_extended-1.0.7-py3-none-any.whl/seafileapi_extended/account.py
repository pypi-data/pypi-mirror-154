from seafileapi_extended.utils import utf8lize
...
class Account(object):
    ...
    def __init__(
        self, client, id, email, create_time, is_active, is_staff, usage, total
    ):
        self.client = client
        self.id = id
        self.email = email
    ...
    def from_json(cls, client, account_json):
        ...
        return cls(
            client, account_id, email, create_time, is_active, is_staff, usage, total
        )
