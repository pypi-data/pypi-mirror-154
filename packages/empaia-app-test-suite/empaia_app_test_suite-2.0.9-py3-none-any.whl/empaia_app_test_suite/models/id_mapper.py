...
class Mapping(RestrictedBaseModel):
    empaia_id: UUID4 = Field(
        example="b10648a7-340d-43fc-a2d9-4d91cc86f33f", description="EMPAIA ID generated by Medical Data Service"
    )
    ...
    local_id: Id = Field(example="3a1e3715-8945-4c13-8fc6-9c1c549cf85d", description="Local ID provided by AP-LIS")
