...
class MainArgSignatureArgsItem:
    ...
    name: str
    typ: Union[MainArgSignatureArgsItemTypType0, MainArgSignatureArgsItemTypType1]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_typ(data: object) -> Union[MainArgSignatureArgsItemTypType0, MainArgSignatureArgsItemTypType1]:
            try:
                typ_type_0: MainArgSignatureArgsItemTypType0
            ...
            if not isinstance(data, dict):
                raise TypeError()
            typ_type_1: MainArgSignatureArgsItemTypType1
