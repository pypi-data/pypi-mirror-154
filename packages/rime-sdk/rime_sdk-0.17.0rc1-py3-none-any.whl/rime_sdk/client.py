...
from rime_sdk.stress_test_job import StressTestJob
...
class Client:
    ...
    def start_stress_test(
        ...
        try:
            ...
            with self._backend.get_model_testing_stub() as model_tester:
                ...
                return StressTestJob(self._backend, job.id)
        except grpc.RpcError as e:
            # TODO(blaine): differentiate on different error types.
            raise ValueError(e)
    ...
    def list_stress_test_jobs(
        ...
        try:
            with self._backend.get_model_testing_stub() as model_tester:
                ...
                return [StressTestJob(self._backend, job.id) for job in res.jobs]
        except grpc.RpcError as e:
            raise ValueError(e)
    ...
    def get_firewall_for_project(self, project_id: str) -> Firewall:
        ...
        try:
            with self._backend.get_firewall_stub() as firewall_tester:
                ...
                return Firewall(self._backend, mapping[project_id])
        except grpc.RpcError as e:
            raise ValueError(e)
    ...
    def start_firewall_from_reference(
        ...
        Returns:
            A ``StressTestJob`` providing information about the model stress test
            job.
