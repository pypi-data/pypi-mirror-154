...
from rime_sdk.protos.jobs.jobs_pb2 import JobType  # pylint: disable=unused-import
from rime_sdk.protos.jobs.jobs_pb2 import GetJobRequest, JobMetadata, JobStatus
...
class Job:
    ...
    def _get_successful_test_run_id(self) -> str:
        ...
        """
        with self._backend.get_job_reader_stub() as job_reader, self._backend.get_test_run_tracker_stub() as test_tracker:  # pylint: disable=line-too-long
            ...
            job_req = GetJobRequest(job_id=self._job_id, job_type=self._job_type)
            try:
    ...
    def get_status(
        ...
        with self._backend.get_job_reader_stub() as job_reader, self._backend.get_model_testing_stub() as model_tester, self._backend.get_test_run_tracker_stub() as test_tracker:  # pylint: disable=line-too-long
            job_req = GetJobRequest(job_id=self._job_id, job_type=self._job_type)
            try:
                job: JobMetadata = job_reader.GetJob(job_req).job
            except grpc.RpcError as e:
