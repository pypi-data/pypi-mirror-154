...
class Search():
    ...
    def __init__(self, df, varnames, df_test=None, dist=None, code_name="search",
        ...
        if df_test is None and multi_objective:
            ...
            if ind_id is not None:
                ...
                ids = np.random.choice(np.unique(ind_id), training_size, replace=False)
    ...
    def df_coeff_col(self, seed, names_asvars,
                     choiceset, var_alt):
        """
    ...
    def generate_sol(self, seed, asvars_avail, isvars_avail, rvars_avail,
    ...
    def evaluate_objective_function(self, df, seed, as_vars,
    ...
    def initialize_memory(self, choice_data, HMS, asvars_avail, isvars_avail,
        ...
        for i in range(len(seeds)):
            ...
            asconstant = \
                self.generate_sol(seed, asvars_avail,
    ...
    def harmony_consideration(self, har_mem, HMCR_itr, seeds, itr, HMS, df,
        ...
        if np.random.choice([0, 1], p=[1-HMCR_itr, HMCR_itr]) <= HMCR_itr:
            ...
            select_new_asvars = [i for (i, v) in zip(har_mem[m_pos]['asvars'],
                                                     ...
                                                     if v]
            select_new_asvars = list(np.random.choice(har_mem[m_pos]['asvars'],
            ...
            asvars, isvars, randvars, bcvars, corvars, bctrans, cor, class_params_spec, member_params_spec, asconstant = \
                self.generate_sol(seed, avail_asvars,
    ...
    def add_new_class_paramfeature(self, solution):
        ...
        ii = np.random.randint(0, len(class_params_spec))
    ...
    def add_new_member_paramfeature(self, solution):
        ...
        ii = np.random.randint(0, len(member_params_spec))
    ...
    def remove_asfeature(self, solution):
        ...
        """
        if solution['asvars']:
            rem_asvar = list(np.random.choice(solution['asvars'], 1))
    ...
    def remove_isfeature(self, solution):
        ...
        """
        if solution['isvars']:
            rem_isvar = list(np.random.choice(solution['isvars'], 1))
    ...
    def remove_bcfeature(self, solution):
        ...
        """
        if solution['bcvars']:
            rem_bcvar = list(np.random.choice(solution['bcvars'], 1))
    ...
    def remove_corfeature(self, solution):
        ...
        """
        if solution['cor_vars']:
            rem_corvar = list(np.random.choice(solution['cor_vars'], 1))
    ...
    def remove_member_paramfeature(self, solution):
        ...
        if solution['member_params_spec'] is not None:
            ...
            if len(member_i) > 0:
                rem_member_param = list(np.random.choice(member_i, 1))
    ...
    def assess_sol(self, solution, har_mem, seed):
        ...
        improved_sol, conv = \
            self.evaluate_objective_function(data, seed,
    ...
    def run_search(self, HMS=10, HMCR_min=0.6, HMCR_max=0.9, PAR_max=0.85,
        ...
        self.remove_redundant_asvars(asvars_new, self.trans_asvars, 3,
                                     self.asvarnames)
        self.generate_sol(2, avail_asvars, avail_isvars,
