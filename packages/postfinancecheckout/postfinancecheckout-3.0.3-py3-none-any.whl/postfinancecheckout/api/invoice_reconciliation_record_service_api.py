...
class InvoiceReconciliationRecordServiceApi:
    ...
    def link_transaction(self, space_id, id, invoice_id, **kwargs):
        """Link transaction

        Updates the invoice reconciliation record with the newly selected invoice and amount of its linked completion.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_transaction(space_id, id, invoice_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int space_id:  (required)
        :param int id: The ID of the invoice reconciliation record which should be linked. (required)
        :param int invoice_id: The ID of the transaction invoice which should be linked. (required)
        ...
        if kwargs.get('async_req'):
            return self.link_transaction_with_http_info(space_id, id, invoice_id, **kwargs)
        else:
            (data) = self.link_transaction_with_http_info(space_id, id, invoice_id, **kwargs)
            return data

    def link_transaction_with_http_info(self, space_id, id, invoice_id, **kwargs):
        """Link transaction

        Updates the invoice reconciliation record with the newly selected invoice and amount of its linked completion.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.link_transaction_with_http_info(space_id, id, invoice_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['space_id', 'id', 'invoice_id', 'amount']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method link_transaction" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'space_id' is set
        if ('space_id' not in params or
                params['space_id'] is None):
            raise ValueError("Missing the required parameter `space_id` when calling `link_transaction`")
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `link_transaction`")
        # verify the required parameter 'invoice_id' is set
        if ('invoice_id' not in params or
                params['invoice_id'] is None):
            raise ValueError("Missing the required parameter `invoice_id` when calling `link_transaction`")
        ...
        return self.api_client.call_api(
            '/invoice-reconciliation-record-service/link-transaction', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def unlink_transaction(self, space_id, id, linked_completion_id, **kwargs):
        """Unlink transaction

        Unlinks the invoice reconciliation record linked completion from invoice reconciliation record.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_transaction(space_id, id, linked_completion_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int space_id:  (required)
        :param int id: The ID of the invoice reconciliation record which should be unlinked. (required)
        :param int linked_completion_id: The ID of the invoice reconciliation record linked completion which should be unlinked. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            return self.unlink_transaction_with_http_info(space_id, id, linked_completion_id, **kwargs)
        else:
            (data) = self.unlink_transaction_with_http_info(space_id, id, linked_completion_id, **kwargs)
            return data

    def unlink_transaction_with_http_info(self, space_id, id, linked_completion_id, **kwargs):
        """Unlink transaction

        Unlinks the invoice reconciliation record linked completion from invoice reconciliation record.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.unlink_transaction_with_http_info(space_id, id, linked_completion_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['space_id', 'id', 'linked_completion_id']
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `unlink_transaction`")
        # verify the required parameter 'linked_completion_id' is set
        if ('linked_completion_id' not in params or
                params['linked_completion_id'] is None):
            raise ValueError("Missing the required parameter `linked_completion_id` when calling `unlink_transaction`")
        ...
        if 'id' in params:
            query_params.append(('id', params['id']))
        if 'linked_completion_id' in params:
            query_params.append(('linkedCompletionId', params['linked_completion_id']))
        ...
        return self.api_client.call_api(
            '/invoice-reconciliation-record-service/unlink-transaction', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
