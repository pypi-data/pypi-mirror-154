...
from tecton.declarative.base import BaseBatchDSConfig as CompatBaseBatchDSConfig
...
class RequestSource(RequestSourceBase):
    ...
    def __init__(
        ...
        :param schema: PySpark schema for the RequestSource inputs.
...
class FileConfig(BaseBatchConfig):
    ...
    def __init__(
        ...
        :param timestamp_field: (Optional) The timestamp column in this data source that should be used by `FilteredSource`
...
class KafkaConfig(BaseStreamDSConfig):
    """
