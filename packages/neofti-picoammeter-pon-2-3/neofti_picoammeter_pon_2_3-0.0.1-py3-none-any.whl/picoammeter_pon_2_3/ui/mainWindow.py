...
from picoammeter_pon_2_3 import chart
#Third party module
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self,parent=None):
        ...
        self.doubleSpinBoxIntegral1 = pg.SpinBox(value=0, suffix='P', siPrefix=True)
        ...
        self.doubleSpinBoxIntegral2 = pg.SpinBox(value=0, suffix='P', siPrefix=True)
        ...
        self.doubleSpinBoxIntegral3 = pg.SpinBox(value=0, suffix='P', siPrefix=True)
        ...
        self.doubleSpinBoxMean1 = pg.SpinBox(value=0, suffix='P', siPrefix=True)
        ...
        self.doubleSpinBoxMean2 = pg.SpinBox(value=0, suffix='P', siPrefix=True)
        ...
        self.doubleSpinBoxMean3 = pg.SpinBox(value=0, suffix='P', siPrefix=True)
    ...
    def spinBoxYMaxValueChanged(self,value:float):
        if self.checkBoxAutoScaleY.isChecked() or self.interfaceSigChangedOff: return
        self.__chart.setRangeY(self.spinBoxYMin.value(),self.spinBoxYMax.value())
    def setCycleAndIntegralData(self,valueCycle:int,valueCh1,valueCh2,valueCh3):
