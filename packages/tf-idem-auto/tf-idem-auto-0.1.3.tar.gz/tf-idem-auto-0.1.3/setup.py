...
_locals = {}
with pathlib.Path("tf_idem_auto", "version.py").open() as fp:
...
setup(
    ...
    url="https://gitlab.com/apriyank/tf-idem-auto",
    version=VERSION,
    ...
    entry_points={"console_scripts": ["tf_idem_auto = tf_idem_auto.scripts:start"]},
