...
#pylint: disable=too-many-lines, invalid-name, too-many-arguments, c-extension-no-member
...
class IsolationForest(PALBase):
    ...
    >>> isof.model_.collect()：
        TREE_INDEX                                      MODEL_CONTENT
                 0  {"NS":8,"NF":2,"FX":[0,1],"1":{"SF":0,"SV":5.5...
                 1  {"NS":8,"NF":2,"FX":[0,1],"1":{"SF":0,"SV":5.5...
                 2  {"NS":8,"NF":2,"FX":[1,0],"1":{"SF":0,"SV":4.6...
                 3  {"NS":8,"NF":2,"FX":[1,0],"1":{"SF":0,"SV":4.6...
                 4  {"NS":8,"NF":2,"FX":[1,0],"1":{"SF":0,"SV":5.3...
        ......
...
class FeatureNormalizer(PALBase):
    ...
    division_by_zero_handler : bool, optional

        - False: Ignores the column when encountering a division by zero. The column is not scaled.

        - True: Throws an error when encountering a division by zero.
