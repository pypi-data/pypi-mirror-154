...
class AreaAttributes(BaseProperty):
    ...
    environment_group_sound: AssetId = dataclasses.field(default=0xffffffff)
    ...
    override_sky: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=0xffffffffffffffff)
    ...
    def to_stream(self, data: typing.BinaryIO, default_override: typing.Optional[dict] = None):
        ...
        data.write(struct.pack(">Q", self.environment_group_sound))
