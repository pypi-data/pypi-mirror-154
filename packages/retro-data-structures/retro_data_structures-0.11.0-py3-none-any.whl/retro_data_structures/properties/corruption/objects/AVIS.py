...
class AVIS(BaseProperty):
    editor_properties: EditorProperties = dataclasses.field(default_factory=EditorProperties)
    visualization_file: AssetId = dataclasses.field(metadata={'asset_types': ['CAAD']}, default=0xffffffffffffffff)
    texture_file: AssetId = dataclasses.field(metadata={'asset_types': ['TXTR']}, default=0xffffffffffffffff)
