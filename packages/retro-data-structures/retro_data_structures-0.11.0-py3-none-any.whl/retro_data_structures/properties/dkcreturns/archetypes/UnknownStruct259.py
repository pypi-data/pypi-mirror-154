...
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct254 import UnknownStruct254
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct255 import UnknownStruct255
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct257 import UnknownStruct257
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct258 import UnknownStruct258
...
class UnknownStruct259(BaseProperty):
    ...
    additive_state_machine: AssetId = dataclasses.field(metadata={'asset_types': ['FSMC']}, default=0xffffffffffffffff)
    unknown_0x06435aff: int = dataclasses.field(default=-1)
    unknown_0xb073b311: int = dataclasses.field(default=-1)
    unknown_0x719345cf: int = dataclasses.field(default=-1)
    spike_move_speed: float = dataclasses.field(default=12.0)
    unknown_0x0483a338: int = dataclasses.field(default=-1)
