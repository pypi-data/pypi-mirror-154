...
from retro_data_structures.properties.dkcreturns.archetypes.GeneratedObjectDeleterProperties import GeneratedObjectDeleterProperties


@dataclasses.dataclass()
class GeneratedObjectDeleter(BaseProperty):
...
def _decode_generated_object_deleter_properties(data: typing.BinaryIO, property_size: int):
    return GeneratedObjectDeleterProperties.from_stream(data, property_size)
