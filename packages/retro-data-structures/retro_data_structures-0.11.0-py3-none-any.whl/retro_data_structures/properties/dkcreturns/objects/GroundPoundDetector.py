...
from retro_data_structures.properties.dkcreturns.archetypes.GroundPoundDetectorData import GroundPoundDetectorData


@dataclasses.dataclass()
class GroundPoundDetector(BaseProperty):
