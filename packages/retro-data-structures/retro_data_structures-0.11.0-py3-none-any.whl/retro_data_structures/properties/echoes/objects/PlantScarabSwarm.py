...
class PlantScarabSwarm(BaseProperty):
    ...
    grenade_explosion_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    part: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    grenade_trail_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    grenade_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    grenade_bounce_sound: AssetId = dataclasses.field(default=0x0)
    ...
    grenade_explosion_sound: AssetId = dataclasses.field(default=0x0)
