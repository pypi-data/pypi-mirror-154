...
class FishCloud(BaseProperty):
    editor_properties: EditorProperties = dataclasses.field(default_factory=EditorProperties)
    active: bool = dataclasses.field(default=True)
    fish_model: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=0xffffffff)
    ...
    death_effect0: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    death_effect0_count: int = dataclasses.field(default=0)
    death_effect1: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    death_effect1_count: int = dataclasses.field(default=0)
    death_effect2: AssetId = dataclasses.field(metadata={'asset_types': []}, default=0xffffffff)
    death_effect2_count: int = dataclasses.field(default=0)
    death_effect3: AssetId = dataclasses.field(metadata={'asset_types': []}, default=0xffffffff)
    death_effect3_count: int = dataclasses.field(default=0)
    death_sound: AssetId = dataclasses.field(default=0x0)
