...
class Shrieker(BaseProperty):
    ...
    melee_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    ...
    sound_missile_deflection: AssetId = dataclasses.field(default=0x0)
