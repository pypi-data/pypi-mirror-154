...
class Blogg(BaseProperty):
    ...
    projectile_particle_effect: AssetId = dataclasses.field(metadata={'asset_types': ['WPSC']}, default=0xffffffff)
    ...
    mouth_open_sound: int = dataclasses.field(default=-1)
