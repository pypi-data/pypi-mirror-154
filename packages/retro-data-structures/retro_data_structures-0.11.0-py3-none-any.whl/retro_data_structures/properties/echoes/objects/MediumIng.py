...
class MediumIng(BaseProperty):
    ...
    ing_spot_blob_fx: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
    ing_spot_sound: AssetId = dataclasses.field(default=0x0)
