...
class OmegaPirate(BaseProperty):
    ...
    grenade_model: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=0xffffffff)
    ...
    sound_id_4: AssetId = dataclasses.field(default=0x0)
    ...
    sound_id_5: AssetId = dataclasses.field(default=0x0)
    unknown_17: bool = dataclasses.field(default=False)
    unknown_18: bool = dataclasses.field(default=False)
    x_ray_model: AssetId = dataclasses.field(metadata={'asset_types': ['CMDL']}, default=0xffffffff)
    x_ray_cskr: AssetId = dataclasses.field(metadata={'asset_types': ['CSKR']}, default=0xffffffff)
    x_ray_cinf: AssetId = dataclasses.field(metadata={'asset_types': ['CINF']}, default=0xffffffff)
