...
from retro_data_structures.properties.dkcreturns.archetypes.BeatUpHandlerStruct import BeatUpHandlerStruct
from retro_data_structures.properties.dkcreturns.archetypes.ControlCommands import ControlCommands
...
class Data(BaseProperty):
    ...
    hit_sound: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=0xffffffffffffffff)
