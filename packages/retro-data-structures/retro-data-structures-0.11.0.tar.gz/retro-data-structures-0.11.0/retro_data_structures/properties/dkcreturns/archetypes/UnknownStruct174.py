...
from retro_data_structures.properties.dkcreturns.archetypes.IslandHudStruct import IslandHudStruct
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct170 import UnknownStruct170
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct171 import UnknownStruct171
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct172 import UnknownStruct172
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct173 import UnknownStruct173
...
class UnknownStruct174(BaseProperty):
    ...
    images: AssetId = dataclasses.field(metadata={'asset_types': ['STRG']}, default=0xffffffffffffffff)
    music: AssetId = dataclasses.field(metadata={'asset_types': ['STRG']}, default=0xffffffffffffffff)
    unlocked: AssetId = dataclasses.field(metadata={'asset_types': ['STRG']}, default=0xffffffffffffffff)
