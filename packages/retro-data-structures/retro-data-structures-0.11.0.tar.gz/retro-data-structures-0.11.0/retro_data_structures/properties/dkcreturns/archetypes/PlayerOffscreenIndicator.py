...
from retro_data_structures.properties.dkcreturns.archetypes.PlayerOffscreenIndicatorIconData import PlayerOffscreenIndicatorIconData
from retro_data_structures.properties.dkcreturns.archetypes.PlayerOffscreenIndicatorTextData import PlayerOffscreenIndicatorTextData
...
class PlayerOffscreenIndicator(BaseProperty):
    ...
    offscreen_timer_tick_sound: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=0xffffffffffffffff)
    offscreen_timer_alert_sound: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=0xffffffffffffffff)
