...
from retro_data_structures.properties.dkcreturns.archetypes.PlayerType import PlayerType
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct277 import UnknownStruct277
...
class Tutorial(BaseProperty):
    ...
    sound_show_tutorial: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=0xffffffffffffffff)
    sound_hide_tutorial: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=0xffffffffffffffff)
