...
from retro_data_structures.properties.dkcreturns.archetypes.TextProperties import TextProperties
...
class TextPane(BaseProperty):
    ...
    default_string: AssetId = dataclasses.field(metadata={'asset_types': ['STRG']}, default=0xffffffffffffffff)
