...
from retro_data_structures.properties.dkcreturns.archetypes.PickupData import PickupData
from retro_data_structures.properties.dkcreturns.archetypes.SavedStateID import SavedStateID
from retro_data_structures.properties.dkcreturns.archetypes.UnknownStruct244 import UnknownStruct244
...
class Pickup(BaseProperty):
    ...
    ghost_model: AssetId = dataclasses.field(metadata={'asset_types': []}, default=0xffffffffffffffff)
