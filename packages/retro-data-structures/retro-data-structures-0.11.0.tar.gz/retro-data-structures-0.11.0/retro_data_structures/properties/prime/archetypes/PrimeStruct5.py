...
class PrimeStruct5(BaseProperty):
    unknown_1: AssetId = dataclasses.field(metadata={'asset_types': ['TXTR']}, default=0xffffffff)
    unknown_2: int = dataclasses.field(default=0)
    unknown_3: AssetId = dataclasses.field(metadata={'asset_types': ['ELSC']}, default=0xffffffff)
    unknown_4: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffff)
