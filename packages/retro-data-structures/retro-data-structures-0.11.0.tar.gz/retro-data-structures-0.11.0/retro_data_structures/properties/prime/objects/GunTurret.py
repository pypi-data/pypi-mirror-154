...
class GunTurret(BaseProperty):
    ...
    unknown_18: AssetId = dataclasses.field(metadata={'asset_types': ['WPSC']}, default=0xffffffff)
    ...
    unknown_19: AssetId = dataclasses.field(default=0x0)
    unknown_20: AssetId = dataclasses.field(default=0x0)
    unknown_21: AssetId = dataclasses.field(default=0x0)
    unknown_22: AssetId = dataclasses.field(default=0x0)
    unknown_23: AssetId = dataclasses.field(default=0x0)
    unknown_24: AssetId = dataclasses.field(default=0x0)
