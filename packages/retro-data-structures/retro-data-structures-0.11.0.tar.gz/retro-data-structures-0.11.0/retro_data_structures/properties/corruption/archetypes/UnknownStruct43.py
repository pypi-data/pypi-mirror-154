...
class UnknownStruct43(BaseProperty):
    ...
    explode_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffffffffffff)
    explode_sound: AssetId = dataclasses.field(metadata={'asset_types': []}, default=0xffffffffffffffff)
    explode_damage: DamageInfo = dataclasses.field(default_factory=DamageInfo)
    visor_goo_effect: AssetId = dataclasses.field(metadata={'asset_types': ['PART']}, default=0xffffffffffffffff)
