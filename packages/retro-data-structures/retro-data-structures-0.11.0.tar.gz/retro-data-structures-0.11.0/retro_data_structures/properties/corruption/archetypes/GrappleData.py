...
class GrappleData(BaseProperty):
    ...
    sound_effect: AssetId = dataclasses.field(metadata={'asset_types': ['CAUD']}, default=0xffffffffffffffff)
    ...
    unknown_0x07648f63: int = dataclasses.field(default=-1)
    ...
    def to_stream(self, data: typing.BinaryIO, default_override: typing.Optional[dict] = None):
        ...
        if self.sound_effect != default_override.get('sound_effect', 0xffffffffffffffff):
            num_properties_written += 1
