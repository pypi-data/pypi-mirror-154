...
class SnakeWeedSwarm(BaseProperty):
    ...
    sound_looped: AssetId = dataclasses.field(default=0x0)
    sound_into_ground: AssetId = dataclasses.field(default=0x0)
    sound_outof_ground: AssetId = dataclasses.field(default=0x0)
