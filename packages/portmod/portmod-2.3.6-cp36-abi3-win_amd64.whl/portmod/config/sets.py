...
def _get_set_path(package_set: str, parent_dir: Optional[str] = None) -> str:
    ...
    if package_set == "selected-packages":
        return os.path.join(variable_data_dir(), "sets", "world")
    if package_set == "selected-sets":
        return os.path.join(variable_data_dir(), "sets", "world_sets")
    if package_set in ("rebuild"):
        return os.path.join(variable_data_dir(), "sets", package_set)
