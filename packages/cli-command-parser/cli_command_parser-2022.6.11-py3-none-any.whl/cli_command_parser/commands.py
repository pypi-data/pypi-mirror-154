...
# TODO: Make sure config to subcommand overrides base, even for errors, esp error_handler
# TODO: If a subcommand overwrites a name/ short form, warn or something?
