...
install_requires = \
['PyYAML>=6,<7', 'click>=8.0.3,<9.0.0', 'pydantic>=1.6.2', 'pyxdg>=0.27']

extras_require = \
{'admin': ['SQLAlchemy[asyncio]>=1.4.25,<2.0.0',
           'bcrypt>=3.2,<4.0',
           'fastapi>=0.70'],
 'all': ['SQLAlchemy[asyncio]>=1.4.25,<2.0.0',
         'alembic>=1.7.5,<2.0.0',
         'bcrypt>=3.2,<4.0',
         'fastapi>=0.70',
         'uvicorn>=0.15',
 ...
 'dev-shell': ['SQLAlchemy[asyncio]>=1.4.25,<2.0.0',
               ...
               'bcrypt>=3.2,<4.0',
               'ipython>=7.29'],
 'legacy': ['Jinja2>=3.0.3,<4.0.0', 'httpx>=0.18.2'],
 'postgresql': ['asyncpg>=0.25,<0.26', 'psycopg2>=2.9.2,<3.0.0'],
