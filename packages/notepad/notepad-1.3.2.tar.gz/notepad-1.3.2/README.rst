...
A simple open-source text editor written in Python.
...
版本:1.3.2 (改进: 代码高亮显示可适应主题背景色; 改善了查找和替换功能的体验。
新增: 默认在新窗口中打开文件; 编辑二进制文件中, 可直接在解码文字显示区域编辑内容。)
...
.. image:: https://img-blog.csdnimg.cn/d337813dfd2e49fbabc3894c792e7e09.png
    :alt: 编辑二进制文件图片