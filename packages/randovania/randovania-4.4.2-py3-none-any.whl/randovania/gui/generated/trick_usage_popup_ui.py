...
class Ui_TrickUsagePopup(object):
    ...
    def retranslateUi(self, TrickUsagePopup):
        ...
        self.title_label.setText(QCoreApplication.translate("TrickUsagePopup", u"<html><head/><body><p>This popup lists all occurences of tricks that are in logical use for this preset.</p><p>Enabled tricks:<br/>{trick_levels}</p><p>Click a room name to open it in the Data Visualizer for more details.</p></body></html>", None))
