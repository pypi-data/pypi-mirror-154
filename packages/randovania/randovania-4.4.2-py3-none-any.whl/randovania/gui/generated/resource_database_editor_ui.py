...
class Ui_ResourceDatabaseEditor(object):
    def setupUi(self, ResourceDatabaseEditor):
        ...
        self.tab_template = QScrollArea()
        self.tab_template.setObjectName(u"tab_template")
        self.tab_template.setWidgetResizable(True)
        self.tab_template_contents = QWidget()
        self.tab_template_contents.setObjectName(u"tab_template_contents")
        self.tab_template_contents.setGeometry(QRect(0, 0, 394, 249))
        self.tab_template_layout = QVBoxLayout(self.tab_template_contents)
        self.tab_template_layout.setObjectName(u"tab_template_layout")
        self.tab_template.setWidget(self.tab_template_contents)
