...
class Ui_DataEditorWindow(object):
    def setupUi(self, DataEditorWindow):
        ...
        self.nodes_scroll_contents.setGeometry(QRect(0, 0, 166, 239))
        ...
        self.other_node_alternatives_contents.setGeometry(QRect(0, 0, 235, 204))
        ...
        self.area_view_canvas = DataEditorCanvas()
        self.area_view_canvas.setObjectName(u"area_view_canvas")
        self.area_view_dock.setWidget(self.area_view_canvas)
