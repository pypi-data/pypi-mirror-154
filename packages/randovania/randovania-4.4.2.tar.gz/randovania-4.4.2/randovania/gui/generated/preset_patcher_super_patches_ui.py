...
class Ui_PresetPatcherSuperPatches(object):
    def setupUi(self, PresetPatcherSuperPatches):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 474, 2126))
    ...
    def retranslateUi(self, PresetPatcherSuperPatches):
        ...
        self.skip_intro_label.setText(QCoreApplication.translate("PresetPatcherSuperPatches", u"Removes the game's intro cutscene.", None))
#if QT_CONFIG(tooltip)
