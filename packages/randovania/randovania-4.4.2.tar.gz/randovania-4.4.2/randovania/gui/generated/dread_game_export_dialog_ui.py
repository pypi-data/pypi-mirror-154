...
class Ui_DreadGameExportDialog(object):
    def setupUi(self, DreadGameExportDialog):
        ...
        self.exlaunch_check = QCheckBox(DreadGameExportDialog)
        self.exlaunch_check.setObjectName(u"exlaunch_check")

        self.root_layout.addWidget(self.exlaunch_check, 5, 0, 1, 3)
        ...
        self.root_layout.addWidget(self.output_tab_widget, 7, 0, 2, 3)
        ...
        self.root_layout.addWidget(self.auto_save_spoiler_check, 10, 0, 1, 1)
        ...
        self.root_layout.addWidget(self.cancel_button, 11, 2, 1, 1)
    ...
    def retranslateUi(self, DreadGameExportDialog):
...
#if QT_CONFIG(tooltip)
        self.exlaunch_check.setToolTip(QCoreApplication.translate("DreadGameExportDialog", u"<html><head/><body><p>This option reduces the size of the output folder from 1.4GB to 17MB, but certain features such as map icons won't work.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.exlaunch_check.setText(QCoreApplication.translate("DreadGameExportDialog", u"Reduce mod file size (?)", None))
        ...
        self.custom_path_label.setText(QCoreApplication.translate("DreadGameExportDialog", u"<html><head/><body><p>Saves the mod to a path or your choosing, leaving the responsibility of placing the files in the correct location to you.</p><p>It's recommended to use one of the other options.</p></body></html>", None))
