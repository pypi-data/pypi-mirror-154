...
class Stocks(Config):
        ...
        def extract_forecast(self,df_prep,df_fcst,df_invopt,date_cols,frequency_,months_,location,column_forecast='ForecastCollab',weeks_=4,join_='left'):      
            ...
            >>> df_extract = extract_forecast (df_prep,df_fcst,df_invopt,date_cols='Date', location=stks.use_location, frequency_= stks.dataset_frequency,join_='left')
            >>> df_extract =
        ...
        def forecast_with_leadtimes(self,df_LeadTimes ,df_Forecast,df_Prep,df_inv,column_forecast,frequency_,location,actualdate,join_='left'):
            ...
            >>> df_forecats = extract_forecast_by_leadtimes(df_LeadTimes=df_lead_time, 
                                                            df_Forecast=df_fcst,
                                                            df_Prep=df_prep,
                                                            df_inv=df_inv,
            ...
            try:
                ...
                if frequency_ == 'M':
                      ...
                      if not df_fcst_1.empty:       
                        ...
                        df_extract_forecast1 = stks.extract_forecast(df_Prep, df_fcst_1b, df_inv, column_forecast=column_forecast, location=location,frequency_= frequency_ ,
                      ...
                      if not df_fcst_2.empty:     
                        ...
                        df_extract_forecast2 = stks.extract_forecast(df_Prep, df_fcst_2b, df_inv, column_forecast=column_forecast, location=location,frequency_= frequency_ ,
                      ...
                      if not df_fcst_3.empty:      
                        ...
                        df_extract_forecast3 = stks.extract_forecast(df_Prep, df_fcst_3b, df_inv, column_forecast=column_forecast, location=location,frequency_= frequency_ ,
                      ...
                      if not df_fcst_4.empty:     
                        ...
                        df_extract_forecast4 = stks.extract_forecast(df_Prep, df_fcst_4b, df_inv, column_forecast=column_forecast, location=location,frequency_= frequency_ ,
                      ...
                      if not df_fcst_5.empty:     
                        ...
                        df_extract_forecast5 = stks.extract_forecast(df_Prep, df_fcst_5b, df_inv, column_forecast=column_forecast, location=location,frequency_= frequency_ ,
                      ...
                      if not df_fcst_6.empty:
                        ...
                        df_extract_forecast6 = stks.extract_forecast(df_Prep, df_fcst_6b, df_inv, column_forecast=column_forecast, location=location,frequency_= frequency_ ,
                      ...
                      if not df_fcst_7.empty:
                        ...
                        df_extract_forecast7 = stks.extract_forecast(df_Prep, df_fcst_7b, df_inv, column_forecast=column_forecast, location=location,frequency_= frequency_ ,
        ...
        def forecast_with_leadtimes_location(self,df_LeadTimes,df_Forecast,df_Prep,df_inv,column_forecast,frequency_,location,actualdate,join_='left'):      
            ...
            >>> df_forecast = extract_forecast_by_leadtimes(df_LeadTimes=df_lead_time, 
                                                            df_Forecast=df_fcst,
                                                            df_Prep=df_prep,
                                                            df_inv=df_inv,
                                                            column_forecast='SuggestedForecast',
        ...
        def next_forecast_with_leadtimes(self,df_LeadTimes ,df_Forecast,df_Prep,df_inv,column_forecast,frequency_,location,actualdate,join_='left'):
            ...
            >>> df_forecats = next_extract_forecast_by_leadtimes(df_LeadTimes=df_lead_time, 
                                                            df_Forecast=df_fcst,
                                                            df_Prep=df_prep,
                                                            df_inv=df_inv,
                                                            column_forecast='SuggestedForecast',
        ...
        def next_forecast_with_leadtimes_location(self,df_LeadTimes,df_Forecast,df_Prep,df_inv,column_forecast,frequency_,location,actualdate,join_='left'):      
            ...
            >>> df_forecast = next_extract_forecast_by_leadtimes(df_LeadTimes=df_lead_time, 
                                                            df_Forecast=df_fcst,
                                                            df_Prep=df_prep,
                                                            df_inv=df_inv,
                                                            column_forecast='SuggestedForecast',
