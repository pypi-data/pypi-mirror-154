...
function GetOciSubcommands_iam() {
    $ociSubcommands = @{
        ...
        'iam tag-namespace' = 'cascade-delete change-compartment create delete get list update'
...
function GetOciCommandsToLongParams_iam() {
    $ociCommandsToLongParams = @{
        ...
        'iam tag create-tag-default-tag-definition-validator' = 'defined-tags description freeform-tags from-json help is-cost-tracking max-wait-seconds name tag-namespace-id wait-for-state wait-interval-seconds'
        'iam tag create-tag-enum-tag-definition-validator' = 'defined-tags description freeform-tags from-json help is-cost-tracking max-wait-seconds name tag-namespace-id validator-values wait-for-state wait-interval-seconds'
        ...
        'iam tag update' = 'defined-tags description force freeform-tags from-json help if-match is-cost-tracking is-retired max-wait-seconds tag-name tag-namespace-id validator wait-for-state wait-interval-seconds'
        'iam tag update-tag-default-tag-definition-validator' = 'defined-tags description force freeform-tags from-json help if-match is-cost-tracking is-retired max-wait-seconds tag-name tag-namespace-id wait-for-state wait-interval-seconds'
        'iam tag update-tag-enum-tag-definition-validator' = 'defined-tags description force freeform-tags from-json help if-match is-cost-tracking is-retired max-wait-seconds tag-name tag-namespace-id validator-values wait-for-state wait-interval-seconds'
        ...
        'iam tag-namespace update' = 'defined-tags description force freeform-tags from-json help is-retired max-wait-seconds tag-namespace-id wait-for-state wait-interval-seconds'
