...
[aiobotocore.SSMIncidents 2.3.3](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ssm-incidents.html#SSMIncidents)
...
def get_structure() -> SsmAutomationTypeDef:
    return {
      ...
    }
```
