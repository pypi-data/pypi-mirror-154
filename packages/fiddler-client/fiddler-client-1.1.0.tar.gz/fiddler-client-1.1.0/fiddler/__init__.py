...
class FiddlerApi:
    ...
    def __new__(
        ...
        url, org_id, auth_token = cls.__get_connection_parameters(
        ...
        if version == 2:
            ...
            # obj.publish_events_log = client_v1.publish_events_log
            obj.publish_events_batch_schema = client_v1.publish_events_batch_schema
