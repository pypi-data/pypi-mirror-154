...
from .geo import geocode, check_tweet_location_inside_bbox
...
def main(args):
    ...
    if location := geocode(args.location):
    ...
    def on_status(status):
        ...
        if args.json:
            ...
            if args.verbose:
                print(f"// place: {status.coordinates or status.place and status.place.name}")
