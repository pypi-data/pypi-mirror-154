...
class TestExperiment(TestInitializedClientSDK):
    ...
    def test_log(self,):
        ...
        self.experiment.log("line", [1, 2, 3, 4], "line", single_thread=True)  # test log line
        # test log replace value
        self.experiment.log("value", 26, "value", True)
        self.experiment.log("value", 26, "value", True, single_thread=True)
        ...
        self.experiment.log("line", [5, 6, 7], "line", single_thread=True)  # test log append lines
