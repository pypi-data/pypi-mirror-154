...
def baixa_extrato_de_um_mes(driver, nome):
    ...
    # grava a variacao
    lista_header['tipo_conta'] = ['Poupança' if x != '' else 'Conta Corrente' for x in lista_header['variacao']]
    lista['tipo_conta'] = ['Poupança' if x != '' else 'Conta Corrente' for x in lista['variacao']]
