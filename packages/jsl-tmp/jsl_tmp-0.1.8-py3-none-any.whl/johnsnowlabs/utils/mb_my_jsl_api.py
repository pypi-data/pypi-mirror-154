...
#         exit(1)
#     accessToken = data["data"]["getAccessToken"]["ok"]["token"]
#     return accessToken
#
#
...
# }
#  """
#     data = http_request(f"{MYJSL_ORIGIN}/graphql", {"query": licenses_query})
#     if data:
#         if "errors" in data:
...
#         else:
#             if not args.email:
#                 print("please enter email and password or access token")
#             if args.password:
#                 password = args.password
#             else:  # user doesn't entered password as parameter
