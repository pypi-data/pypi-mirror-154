...
def func2(n: int) -> float:
    a = 5 / 7 * 2 ** n
    b = -2 / 3
    c = (-1 / 42 - 3 ** 0.5 * 1j / 14) * (-0.5 + 3 ** 0.5 * 0.5j) ** n
    d = (-1 / 42 + 3 ** 0.5 * 1j / 14) * (-0.5 - 3 ** 0.5 * 0.5j) ** n
    return a + b + c + d
...
def f(n: int):
    ...
    for i in [2, 3, 4, 5, 7]:
        for j in range(i, n + 1, i):
            a[j] = 0
    print(len([i for i in a if i]), [i for i in a if i])
