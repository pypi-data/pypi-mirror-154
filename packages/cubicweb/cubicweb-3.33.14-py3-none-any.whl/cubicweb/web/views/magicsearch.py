        ...
        try:
            ...
            if restrictions:
                return [
                    ...
                    for suggestion in self.rql_build_suggestions(
    ...
    def vocabulary(self, select, rql_var, user_rtype, rtype_incomplete_value):
        ...
        for sol in select.solutions:
            ...
            if cstr is not None:
                ...
                vocab += [value for value, in self._cw.execute(vocab_rql, vocab_kwargs)]
        return sorted(set(vocab))


class RQLNoSuggestionsBuilder(RQLSuggestionsBuilder):
    __regid__ = "rql.no-suggestions"

    def build_suggestions(self, *args):
        return []

    def rql_build_suggestions(self, *args):
        return []

    def etypes_suggestion_set(self):
        return []

    def possible_etypes(self, *args, **kwargs):
        return []

    def possible_relations(self, *args, **kwargs):
        return []
...
def rql_suggest(self):
    rql_builder = self._cw.vreg["components"].select_or_none(
