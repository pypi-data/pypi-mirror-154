...
contextFreeBoxTitleBg = lazystr(
    '%(contextFreeBoxTitleBgColor)s url("contextFreeBoxHeader.png") repeat-x 50%% 50%%'
)
contextFreeBoxTitleColor = "#000"

contextualBoxTitleBgColor = "#FF9900"
contextualBoxTitleBg = lazystr(
    '%(contextualBoxTitleBgColor)s url("contextualBoxHeader.png") repeat-x 50%% 50%%'
)
...
incontextBoxTitleBg = lazystr(
    '%(incontextBoxTitleBgColor)s url("incontextBoxHeader.png") repeat-x 50%% 50%%'
)
...
facet_vocabMaxHeight = (
    "12em"  # ensure < FACET_GROUP_HEIGHT by some const. factor (e.g 3em)
)
