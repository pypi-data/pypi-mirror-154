...
""",
        ...
        self.assertEqual(msg.get("from"), "oim <oim@logilab.fr>")
        self.assertEqual(msg.get("to"), "test@logilab.fr")
        self.assertEqual(
            msg.get("reply-to"), "oim <oim@logilab.fr>, BimBam <bim@boum.fr>"
        )
...
""",
        ...
        self.assertEqual(msg.get("to"), "test@logilab.fr")
        self.assertEqual(msg.get("reply-to"), "oîm <oim@logilab.fr>")
        self.assertEqual(msg.get_payload(decode=True), "un petit cöucou €")
    ...
    def test_format_mail_from_reply_to(self):
        ...
        self.assertEqual(msg.get("reply-to"), "tutu <tutu@logilab.fr>")
        msg = format_mail(
            {"name": "tutu", "email": "tutu@logilab.fr"},
            ["test@logilab.fr"],
            "un petit cöucou €",
        ...
        self.assertEqual(
            msg.get("reply-to"), "cubicweb-test <cubicweb-test@logilab.fr>"
        )
        ...
        msg = message_from_string(msg.as_string())
        self.assertEqual(msg.get("from"), "cubicweb-test <tutu@logilab.fr>")
        self.assertEqual(
            msg.get("reply-to"),
            "cubicweb-test <tutu@logilab.fr>, cubicweb-test <cubicweb-test@logilab.fr>",
        )
        ...
        self.assertEqual(msg.get("reply-to"), "tutu <cubicweb-test@logilab.fr>")
