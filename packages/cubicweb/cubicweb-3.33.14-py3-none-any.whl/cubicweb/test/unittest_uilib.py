...
class UILIBTC(TestCase):
    ...
    def test_fallback_safe_cut(self):
        self.assertEqual(
            uilib.fallback_safe_cut('ab <a href="hello">cd</a>', 4), "ab c..."
        )
        self.assertEqual(
            uilib.fallback_safe_cut('ab <a href="hello">cd</a>', 5),
            'ab <a href="hello">cd</a>',
        )
        self.assertEqual(
            uilib.fallback_safe_cut('ab <a href="hello">&amp;d</a>', 4), "ab &amp;..."
        )
        self.assertEqual(
            uilib.fallback_safe_cut('ab <a href="hello">&amp;d</a> ef', 5),
            "ab &amp;d...",
        )
        self.assertEqual(
            uilib.fallback_safe_cut('ab <a href="hello">&igrave;d</a>', 4), "ab ì..."
        )
        self.assertEqual(
            uilib.fallback_safe_cut('&amp; <a href="hello">&amp;d</a> ef', 4),
            "&amp; &amp;d...",
        )

    def test_lxml_safe_cut(self):
        self.assertEqual(
            uilib.safe_cut("aaa<div>aaad</div> ef", 4), "<p>aaa</p><div>a...</div>"
        )
        self.assertEqual(
            uilib.safe_cut("aaa<div>aaad</div> ef", 7), "<p>aaa</p><div>aaad</div>..."
        )
        self.assertEqual(
            uilib.safe_cut("aaa<div>aaad</div>", 7), "<p>aaa</p><div>aaad</div>"
        )
        # Missing ellipsis due to space management but we don't care
        self.assertEqual(
            uilib.safe_cut('ab <a href="hello">&amp;d</a>', 4),
            '<p>ab <a href="hello">&amp;...</a></p>',
        )
...
quis nostrud exercitation ullamco laboris nisi",
    ...
    def test_soup2xhtml_1_1(self):
        self.assertEqual(uilib.soup2xhtml("hop", "ascii"), "hop")
        self.assertEqual(uilib.soup2xhtml("hop<div>", "ascii"), "hop<div/>")
        self.assertEqual(uilib.soup2xhtml("hop <div>", "ascii"), "hop <div/>")
        self.assertEqual(uilib.soup2xhtml("<div> hop", "ascii"), "<div> hop</div>")
        self.assertEqual(
            uilib.soup2xhtml("hop <div> hop", "ascii"), "hop <div> hop</div>"
        )

    def test_soup2xhtml_1_2(self):
        self.assertEqual(uilib.soup2xhtml("hop </div>", "ascii"), "hop ")
        self.assertEqual(uilib.soup2xhtml("</div> hop", "ascii"), "<div/> hop")
        self.assertEqual(
            uilib.soup2xhtml("hop </div> hop", "ascii"), "<div>hop </div> hop"
        )

    def test_soup2xhtml_2_1(self):
        self.assertEqual(uilib.soup2xhtml("hop <body>", "ascii"), "hop ")
        self.assertEqual(uilib.soup2xhtml("<body> hop", "ascii"), " hop")
        self.assertEqual(uilib.soup2xhtml("hop <body> hop", "ascii"), "hop  hop")
    ...
    @skipIf(
        lxml_version < ["2", "2"], "expected behaviour on recent version of lxml only"
    )
    def test_soup2xhtml_2_2b(self):
        self.assertEqual(uilib.soup2xhtml("hop </body> hop", "ascii"), "hop  hop")

    def test_soup2xhtml_3_1(self):
        self.assertEqual(uilib.soup2xhtml("hop <html>", "ascii"), "hop ")
        self.assertEqual(uilib.soup2xhtml("<html> hop", "ascii"), " hop")
        self.assertEqual(uilib.soup2xhtml("hop <html> hop", "ascii"), "hop  hop")
    ...
    def test_soup2xhtml_3_3(self):
        self.assertEqual(
            uilib.soup2xhtml("<script>test</script> hop ", "ascii"), " hop "
        )

    def test_js(self):
        self.assertEqual(str(uilib.js.pouet(1, "2")), 'pouet(1,"2")')
        self.assertEqual(str(uilib.js.cw.pouet(1, "2")), 'cw.pouet(1,"2")')
        self.assertEqual(
            str(uilib.js.cw.pouet(1, "2").pouet(None)), 'cw.pouet(1,"2").pouet(null)'
        )
        self.assertEqual(
            str(uilib.js.cw.pouet(1, cwutils.JSString("$")).pouet(None)),
            "cw.pouet(1,$).pouet(null)",
        )
        self.assertEqual(
            str(
                uilib.js.cw.pouet(1, {"call back": cwutils.JSString("cw.cb")}).pouet(
                    None
                )
            ),
