...
class RequestTC(TestCase):
    ...
    def test_build_url(self):
        ...
        self.assertEqual(req.build_url(None), "http://testing.fr/cubicweb/view")
        self.assertEqual(req.build_url("one"), "http://testing.fr/cubicweb/one")
        self.assertEqual(
            req.build_url(param="ok"), "http://testing.fr/cubicweb/view?param=ok"
        )
...
class RequestCWTC(CubicWebTC):
    ...
    def test_exists(self):
        with self.admin_access.web_request() as req:
            ...
            self.assertFalse(req.exists("CWUser", login="hitler"))
