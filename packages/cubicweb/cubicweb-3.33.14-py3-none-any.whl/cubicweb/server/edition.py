...
class EditedEntity(dict):
    ...
    def check(self, creation=False):
        ...
        if creation:
            ...
            relations = [entity._cw.vreg.schema.rschema(rtype) for rtype in self]
        try:
            entity.e_schema.check(
                dict_protocol_catcher(entity), creation=creation, relations=relations
            )
