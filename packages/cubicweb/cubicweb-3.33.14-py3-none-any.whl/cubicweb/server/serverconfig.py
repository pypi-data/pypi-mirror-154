...
class ServerConfiguration(CubicWebConfiguration):
    ...
    cubicweb_appobject_path = CubicWebConfiguration.cubicweb_appobject_path | {
        "sobjects",
        "hooks",
    }
    cube_appobject_path = CubicWebConfiguration.cube_appobject_path | {
        "sobjects",
        "hooks",
    }
...
notified of every changes.",
            ...
            (
                "zmq-address-sub",
                {
                    ...
                    "default": (),
                    "help": (
                        "List of ZMQ addresses to subscribe to (requires pyzmq) "
            ...
            (
                "zmq-address-pub",
                {
                    ...
                    "default": None,
                    "help": (
                        "ZMQ address to use for publishing (requires pyzmq) "
                        "(of the form `tcp://<ipaddr>:<port>`)"
                    ),
                    "group": "zmq",
                    "level": 1,
    ...
    def write_sources_file(self, sourcescfg):
        ...
        for section in ("admin", "system"):
            ...
            if isinstance(sconfig, dict):
                ...
                sconfig = _sconfig
            stream.write("[{}]\n{}\n".format(section, generate_source_config(sconfig)))
