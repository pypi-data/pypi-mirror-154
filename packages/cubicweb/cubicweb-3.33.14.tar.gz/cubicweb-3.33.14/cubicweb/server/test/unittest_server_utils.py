...
class HTMLHeadTC(CubicWebTC):
    ...
    def test_concat_urls(self):
        ...
        expected = "http://test.fr/data/??bob1.js,bob2.js,bob3.js"
    ...
    def test_getvalue_with_concat(self):
        ...
        head.add_ie_css(base_url + "bob8.css")
        head.add_ie_css(base_url + "bob9.css", "print", "[if lt IE 7]")
