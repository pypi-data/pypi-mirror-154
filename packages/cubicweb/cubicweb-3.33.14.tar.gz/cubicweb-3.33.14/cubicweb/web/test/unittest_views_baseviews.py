...
class BaseViewsTC(CubicWebTC):
    ...
    def test_incontext(self):
        with self.admin_access.web_request() as req:
            ...
            expected = (
                '<a href="http://testing.fr/cubicweb/%d" title="">'
                "&lt;script&gt;&lt;/script&gt;</a>" % entity.eid
            )
...
"""
    ...
    def test_simplelist(self):
        with self.admin_access.web_request() as req:
            ...
            expected = (
                ...
                "&lt;script&gt;&lt;/script&gt;</a></div>"
                '<div class="section">'
                '<a href="http://testing.fr/cubicweb/cwuser/admin" title="">admin</a></div>'
                '<div class="section">'
                '<a href="http://testing.fr/cubicweb/cwuser/anon" title="">anon</a></div>'
                % entity.eid
            )
            self.assertEqual(result, expected)
    ...
    def test_sameetypelist(self):
        with self.admin_access.web_request() as req:
            ...
            expected = (
                '<a href="http://testing.fr/cubicweb/%d" title="">&lt;script&gt;&lt;/script&gt;</a>, '
