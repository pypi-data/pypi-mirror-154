...
class RQLSensor(Sensor):
    ...
    def get_configurator(self):
        ...
        configurator.add_entry(
            _(
                "ID",
            ),
            "appid",
            _("The application id of this source"),
        )
        configurator.add_entry(
            _(
                "User",
            ...
            "user",
            _("The user to connect to this source"),
        )
        configurator.add_entry(
            _(
                "Password",
            ...
            "passwd",
            _("The user's password to connect to this source"),
        )
        configurator.add_entry(
            _(
                "URL",
            ...
            "url",
            _("The url of the web interface for this source"),
        )
        configurator.add_entry(
            _(
                "RQL",
        ...
        configurator.add_entry(
            ...
            "delay",
            _("Delay in seconds between updates"),
        )
        return configurator
    ...
    def __get_connection(self):
        try:
            ...
            appid, user, passwd = (
                self._get_config("appid"),
                self._get_config("user"),
                self._get_config("passwd"),
            )
