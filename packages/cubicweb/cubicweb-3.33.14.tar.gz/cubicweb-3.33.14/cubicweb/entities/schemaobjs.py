...
class CWEType(AnyEntity):
    ...
    def dc_title(self):
        return "{} ({})".format(self.name, self._cw._(self.name))
    ...
    def dc_long_title(self):
        ...
        if stereotypes:
            return "{} <<{}>>".format(self.dc_title(), ", ".join(stereotypes))
...
class CWConstraint(AnyEntity):
    ...
    def dc_title(self):
        return "{}({})".format(self.cstrtype[0].name, self.value or "")
...
class RQLExpression(AnyEntity):
    ...
    def dc_long_title(self):
        return "{}({})".format(self.exprtype, self.expression or "")
