...
import fileFormats as ff #file formats
import waveformFileClass as wf #the waveform file information
import resultFileClass as rf #stuff for results
...
print('Due to some ongoing work on experimental GPU features, some warning statments may print during import')
print('If you see statements about CUDA or cupy, they should be safe to ignore')
print('If you have any questions feel free to email me: dgma224@g.uky.edu')
...
try:
	...
	__gpuAvailable = False
	print("GPU not available to accelerate processing")
	print(e)
