...
class Api():
    ...
    def wksp_job_metrics(self, wksp: str, jobkey: str) -> dict:
        '''GET /{workspace}/job/{jobKey}/metrics - Get cpu and memory usage of a job
    ...
    def wksp_share_folder(self, wksp: str, dir_path: str, targetUsers: str, includeHidden = False):
