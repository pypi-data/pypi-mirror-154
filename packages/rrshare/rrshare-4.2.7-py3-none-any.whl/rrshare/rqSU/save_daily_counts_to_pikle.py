...
@timer
def save_daily_counts_pickle(table_name='stock_day_adj_fillna', N=START_DATE_COUNT):
    """  read large stockday N>250 need 10mins, cron read data save to pickle for speed"""
    USERPATH = os.path.expanduser('~')
    #print(USERPATH)
    file_path = f'{USERPATH}/.rrsdk/data'
...
if  __name__ == "__main__":
    ...
    save_daily_counts_pickle(table_name='swl_day')
    #save_daily_counts_pickle(table_name="stock_day_adj_fillna")
