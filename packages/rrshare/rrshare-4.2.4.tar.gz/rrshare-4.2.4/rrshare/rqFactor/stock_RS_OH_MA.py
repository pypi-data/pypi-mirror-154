...
def read_stock_day_N_to_pickle(table_name='stock_day_adj_fillna', N=100):
...
read_stock_day_N_to_pickle()
       

def stock_RT_HH_MA_pre(table_name='stock_day_adj_fillna', N=250): # ok
    ...
    #df = pd.read_pickle("~/.rrsdk/data/stock_day_250.pkl")
    #print(df.tail())
    #df =df[~df['code'].isin(delist_code)]
...
def stock_RS_OH_MA_last(table_name='stock_day_adj_fillna', N=250): # ok
