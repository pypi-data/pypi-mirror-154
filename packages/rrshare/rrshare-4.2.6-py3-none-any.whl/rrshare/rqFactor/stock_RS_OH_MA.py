...
def stock_RT_HH_MA_pre(table_name='stock_day_adj_fillna', N=START_DATE_COUNT): # ok
...
def stock_RS_OH_MA_last(table_name='stock_day_adj_fillna', N=START_DATE_COUNT): # ok
