...
class TestHistoryHandler(TestCase):
    ...
    def setUp(self):
        self.output_folder = os.path.join(
            os.path.dirname(__file__), "data", "dummy_model"
        )
    ...
    def test_get_train_data(self):
        ...
        target = np.array(
            [
                (250.0, 0.00018755, 0.487258, 0.756687),
                (500.0, 0.00056265, 0.291661, 0.874188),
                (250.0, 0.0350691, 0.0589843, 0.977938),
                (500.0, 0.0354442, 0.0554589, 0.980375),
            ],
            dtype=[
                ("Batch", "<f8"),
                ("Batch_float", "<f8"),
