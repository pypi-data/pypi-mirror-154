...
from cccs.filestore.transport.base import TransportException
...
def test_minio():
    ...
    fs = FileStore('s3://storage_key:Ch@ngeTh!sPa33w0rd@localhost:9000/?s3_bucket=test&use_ssl=False')
