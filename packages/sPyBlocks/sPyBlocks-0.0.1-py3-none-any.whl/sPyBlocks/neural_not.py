...
class NeuralNot:
    """
    This class defines the NOT block.
    """
    ...
    def connect_excitation(self, input_population, conn=None, conn_all=True, rcp_type="excitatory",
        ...
        """
        Connects an input population to the neurons to be excited by the Constant Spike Source block.

        :param sim.Population, sim.PopulationView, sim.Assembly, list input_population: A PyNN object or a list of PyNN objects containing the population to connect to the excited neurons.
    ...
    def get_excited_neuron(self, flat=False):
        """
        Gets a list containing all the neurons excited by the Constant Spike Source block.

        :param bool flat: Unused.
        :return: The list containing all the excited neurons of the block
        :rtype: list
        """
...
class MultipleNeuralNot:
    """
    This class allows to create multiple NOT blocks of the same type.
    """
    ...
    def get_excited_neurons(self, flat=False):
        """
        Gets a list containing all the neurons excited by the Constant Spike Source block.

        :param bool flat: A boolean value indicating whether or not to flatten the list. False by default.
        :return: The list containing all the excited neurons of the blocks
        :rtype: list
        """
        excited_neurons = []
        ...
        if flat:
            return flatten(excited_neurons)
        else:
