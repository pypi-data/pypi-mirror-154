...
VERSION = '0.0.23'
DESCRIPTION = 'A powerfull module for animating drawing of image with turtle'
LONG_DESCRIPTION = '''
# Welcome to sketchpy
...
setup(
    ...
    install_requires=['opencv-python','turtle==0.0.1', 'wheel', 'numpy','svg.path','svgpathtools','tqdm'],
