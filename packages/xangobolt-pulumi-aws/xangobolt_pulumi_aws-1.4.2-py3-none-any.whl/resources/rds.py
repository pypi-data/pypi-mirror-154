...
def Instance(stem, props, username=None, password=None, instance_class=None, snetgrp_name=None, secgrp_ids=None, optgrp_name=None, provider=None, parent=None, depends_on=None):
