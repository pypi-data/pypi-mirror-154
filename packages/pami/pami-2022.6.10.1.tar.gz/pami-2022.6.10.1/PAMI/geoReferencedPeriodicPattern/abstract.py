...
class _geoReferencedPeriodicPatterns(_ABC):
    ...
    ----------
        ...
        maxDist: integer or float or str
            The user can specify maxDist either in count or proportion of database size.
            If the program detects the data type of maxDist is integer, then it treats maxDist is expressed in count.
            Otherwise, it will be treated as float.
            Example: maxDist=10 will be treated as integer, while maxDist=10.0 will be treated as float
        ...
        cutIAT: integer or float or str
            The user can specify cutIAT either in count or proportion of database size.
            If the program detects the data type of cutIAT is integer, then it treats cutIAT is expressed in count.
            Otherwise, it will be treated as float.
            Example: cutIAT = 10 will be treated as integer, while cutIAT=10.0 will be treated as float
        sep : str
    ...
    def __init__(self, iFile, nFile, maxDist, maxIAT, minPS, cutIAT, sep="\t"):
        ...
        :type nFile: str
        :param maxDist: To calaculate the distance between each item and pruning items which are > maxDist
        :type maxDist: int or float or str
        ...
        :param cutIAT: constraint to prune the itemsets which are >= cutIAT
        :type cutIAT: int or float or str
