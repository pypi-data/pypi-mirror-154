...
class Amendment(object):
    ...
    def code(self):
        """Gets the code of this Amendment.  # noqa: E501
         ...
         A unique alphanumeric string that identifies the amendment.   **Character limit**: 50  **Values**: automatically generated   # noqa: E501
    ...
    def customer_acceptance_date(self):
        ...
        The date when the customer accepts the amendment's changes to the subscription.  This field is only required if [Zuora is configured to require customer acceptance in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Acceptance status (the value of the `Status` field is currently `PendingAcceptance`).  Use this field together with the `Status` field. When you set a date in this field as a customer acceptance date, you should also set the `Status` field as `Completed`.   # noqa: E501
    ...
    def destination_account_id(self):
        """Gets the destination_account_id of this Amendment.  # noqa: E501
         ...
         The ID of the subscription owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid account ID   # noqa: E501
    ...
    def destination_invoice_owner_id(self):
        """Gets the destination_invoice_owner_id of this Amendment.  # noqa: E501
         ...
         The ID of the invoice owner that the subscription is being transferred to.   **Character limit**: 32  **Values**: a valid invoice ID   # noqa: E501
    ...
    def externally_managed_by(self):
        """Gets the externally_managed_by of this Amendment.  # noqa: E501
        ...
        :return: The externally_managed_by of this Amendment.  # noqa: E501
        :rtype: str
        """
    ...
    def externally_managed_by(self, externally_managed_by):
        """Sets the externally_managed_by of this Amendment.

        An enum field on the Subscription object to indicate the name of a third-party store. This field is used to represent subscriptions created through third-party stores.   # noqa: E501

        :param externally_managed_by: The externally_managed_by of this Amendment.  # noqa: E501
        :type: str
        """
    ...
    def resume_date(self):
        """Gets the resume_date of this Amendment.  # noqa: E501

        The date when the subscription resumption takes effect. See [Resume Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Resume_a_Subscription#Resume_Date) for more information.  This field is only required if you resume a suspended subscription.   # noqa: E501

        :return: The resume_date of this Amendment.  # noqa: E501
        :rtype: date
        """
    ...
    def resume_date(self, resume_date):
        """Sets the resume_date of this Amendment.

        The date when the subscription resumption takes effect. See [Resume Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Resume_a_Subscription#Resume_Date) for more information.  This field is only required if you resume a suspended subscription.   # noqa: E501

        :param resume_date: The resume_date of this Amendment.  # noqa: E501
        :type: date
        """
    ...
    def service_activation_date(self):
        ...
        The date when service is activated.  This field is only required if [Zuora is configured to require service activation in Z-Billing](https://knowledgecenter.zuora.com/CB_Billing/W_Billing_and_Payments_Settings/Define_Default_Subscription_Settings) and the subscription is currently in the Pending Activation status (the value of the `Status` field is currently `PendingActivation`).  Use this field together with the `Status` field. When you set a date in this field as a service activation date, you should also set the `Status` field as the expected next phase status: `Completed` or `PendingAcceptance`.   # noqa: E501
    ...
    def subscription_id(self):
        """Gets the subscription_id of this Amendment.  # noqa: E501
         ...
         The ID of the subscription that the amendment changes. The ID can be the latest version or any history version of ID.   **Character limit**: 32  **Values**: a valid subscription ID   # noqa: E501
    ...
    def suspend_date(self):
        """Gets the suspend_date of this Amendment.  # noqa: E501

        The date when the subscription suspension takes effect. See [Suspend Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Suspend_a_Subscription#Suspend_Date) for more information.  This field is only required if you suspend an active subscription.   # noqa: E501

        :return: The suspend_date of this Amendment.  # noqa: E501
        :rtype: date
        """
    ...
    def suspend_date(self, suspend_date):
        """Sets the suspend_date of this Amendment.

        The date when the subscription suspension takes effect. See [Suspend Date](https://knowledgecenter.zuora.com/BC_Subscription_Management/Subscriptions/Suspend_a_Subscription#Suspend_Date) for more information.  This field is only required if you suspend an active subscription.   # noqa: E501

        :param suspend_date: The suspend_date of this Amendment.  # noqa: E501
        :type: date
        """
