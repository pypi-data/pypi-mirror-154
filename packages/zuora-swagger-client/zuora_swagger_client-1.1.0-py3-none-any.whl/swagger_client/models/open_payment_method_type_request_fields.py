...
class OpenPaymentMethodTypeRequestFields(object):
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["string", "date", "datetime", "number", "boolean"]  # noqa: E501
