...
class AmendResult(object):
    ...
    swagger_types = {
        ...
        'credit_memo_datas': 'list[ActionAmendCreditMemoData]',
        'credit_memo_id': 'str',
        'errors': 'list[ActionsErrorResponse]',
        'gateway_response': 'str',
        'gateway_response_code': 'str',
        'invoice_datas': 'list[ActionAmendInvoiceData]',
        'invoice_id': 'str',
        'payment_id': 'str',
    ...
    attribute_map = {
        ...
        'charge_metrics_data': 'ChargeMetricsData',
        'credit_memo_datas': 'CreditMemoDatas',
    ...
    def __init__(self, amendment_ids=None, charge_metrics_data=None, credit_memo_datas=None, credit_memo_id=None, errors=None, gateway_response=None, gateway_response_code=None, invoice_datas=None, invoice_id=None, payment_id=None, payment_transaction_number=None, subscription_id=None, success=None, total_delta_mrr=None, total_delta_tcv=None):  # noqa: E501
        """AmendResult - a model defined in Swagger"""  # noqa: E501
        self._amendment_ids = None
        self._charge_metrics_data = None
        self._credit_memo_datas = None
        ...
        if credit_memo_datas is not None:
            self.credit_memo_datas = credit_memo_datas
    ...
    @property
    def credit_memo_datas(self):
        """Gets the credit_memo_datas of this AmendResult.  # noqa: E501


        :return: The credit_memo_datas of this AmendResult.  # noqa: E501
        :rtype: list[ActionAmendCreditMemoData]
        """
        return self._credit_memo_datas

    @credit_memo_datas.setter
    def credit_memo_datas(self, credit_memo_datas):
        """Sets the credit_memo_datas of this AmendResult.


        :param credit_memo_datas: The credit_memo_datas of this AmendResult.  # noqa: E501
        :type: list[ActionAmendCreditMemoData]
        """

        self._credit_memo_datas = credit_memo_datas

    @property
    def credit_memo_id(self):
        """Gets the credit_memo_id of this AmendResult.  # noqa: E501


        :return: The credit_memo_id of this AmendResult.  # noqa: E501
        :rtype: str
        """
    ...
    def credit_memo_id(self, credit_memo_id):
        """Sets the credit_memo_id of this AmendResult.


        :param credit_memo_id: The credit_memo_id of this AmendResult.  # noqa: E501
        :type: str
        """
    ...
    def invoice_datas(self):
        ...
        This array of invoices contains one invoice only as one invoice is generated for one subscription.   # noqa: E501

        :return: The invoice_datas of this AmendResult.  # noqa: E501
        :rtype: list[ActionAmendInvoiceData]
        """
    ...
    def invoice_datas(self, invoice_datas):
        ...
        :type: list[ActionAmendInvoiceData]
        """
    ...
    def total_delta_mrr(self):
        ...
        `TotalDeltaMrr` is calculated by the following formula:   TotalDeltaMrr = newSubscription.CMRR - originalSubscription.CMRR   See [here](https://knowledgecenter.zuora.com/Billing/Subscriptions/Customer_Accounts/A_How_to_Manage_Customer_Accounts/E_Key_Metrics/B_Monthly_Recurring_Revenue#Contracted_MRR) for the definition of CMRR. The new subscriptin represents the later version of an subscription after an amendment. The original subscription represents the original version of the subscription before the amendment.    # noqa: E501
