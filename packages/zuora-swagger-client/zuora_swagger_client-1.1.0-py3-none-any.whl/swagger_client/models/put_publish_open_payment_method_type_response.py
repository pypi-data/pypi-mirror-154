...
class PUTPublishOpenPaymentMethodTypeResponse(object):
    ...
    def __init__(self, entity_id=None, fields=None, internal_name=None, label=None, method_reference_id_field=None, revision=None, status=None, sub_type_field=None, tenant_id=None, user_reference_id_field=None, version=None):  # noqa: E501
        """PUTPublishOpenPaymentMethodTypeResponse - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def entity_id(self):
        """Gets the entity_id of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        ...
        :return: The entity_id of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def entity_id(self, entity_id):
        """Sets the entity_id of this PUTPublishOpenPaymentMethodTypeResponse.

        If an entity UUID is provided, this custom payment method type is specific to this entity only. If no entity UUID is provided, the custom payment method type is available to the global entity and all the sub entities in the tenant.   # noqa: E501

        :param entity_id: The entity_id of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fields(self):
        """Gets the fields of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501

        An array containing field metadata of the custom payment method type.   # noqa: E501

        :return: The fields of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
    ...
    def fields(self, fields):
        """Sets the fields of this PUTPublishOpenPaymentMethodTypeResponse.

        An array containing field metadata of the custom payment method type.   # noqa: E501

        :param fields: The fields of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
    ...
    def internal_name(self):
        """Gets the internal_name of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        ...
        :return: The internal_name of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def internal_name(self, internal_name):
        """Sets the internal_name of this PUTPublishOpenPaymentMethodTypeResponse.

        A string to identify the custom payment method type in the API name of the payment method type.  This field is used along with the `tenantId` field by the system to construct and generate the API name of the custom payment method type in the following way:  `<internalName>__c_<tenantId>`  For example, if `internalName` is `AmazonPay`, and `tenantId` is `12368`, the API name of the custom payment method type will be `AmazonPay__c_12368`.   # noqa: E501

        :param internal_name: The internal_name of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501

        The label that is used to refer to this type in the Zuora UI.   # noqa: E501

        :return: The label of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this PUTPublishOpenPaymentMethodTypeResponse.

        The label that is used to refer to this type in the Zuora UI.   # noqa: E501

        :param label: The label of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    def method_reference_id_field(self):
        """Gets the method_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501

        The identification reference of the custom payment method.  This field should be mapped to a field name defined in the `fields` array for the purpose of being used as a filter in reporting tools such as Payment Method Data Source Exports and Data Query.   # noqa: E501

        :return: The method_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def method_reference_id_field(self, method_reference_id_field):
        """Sets the method_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.

        The identification reference of the custom payment method.  This field should be mapped to a field name defined in the `fields` array for the purpose of being used as a filter in reporting tools such as Payment Method Data Source Exports and Data Query.   # noqa: E501

        :param method_reference_id_field: The method_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def revision(self):
        """Gets the revision of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        ...
        :return: The revision of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: int
        """
    ...
    def revision(self, revision):
        """Sets the revision of this PUTPublishOpenPaymentMethodTypeResponse.

        The revision number of the custom payment method type, which starts from 1 and increases by 1 when you update a published revision for the first time.   # noqa: E501

        :param revision: The revision of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def status(self):
        """Gets the status of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501

        The status of the custom payment method type.   # noqa: E501

        :return: The status of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this PUTPublishOpenPaymentMethodTypeResponse.

        The status of the custom payment method type.   # noqa: E501

        :param status: The status of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    def sub_type_field(self):
        """Gets the sub_type_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        ...
        :return: The sub_type_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_type_field(self, sub_type_field):
        """Sets the sub_type_field of this PUTPublishOpenPaymentMethodTypeResponse.

        The identification reference indicating the subtype of the custom payment method.  This field should be mapped to a field name defined in the `fields` array for the purpose of being used as a filter in reporting tools such as Data Source Exports and Data Query.   # noqa: E501

        :param sub_type_field: The sub_type_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tenant_id(self):
        """Gets the tenant_id of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        ...
        :return: The tenant_id of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def tenant_id(self, tenant_id):
        """Sets the tenant_id of this PUTPublishOpenPaymentMethodTypeResponse.

        Zuora tenant ID. If multi-entity is enabled in your tenant, this is the ID of the parent tenant of all the sub entities.   # noqa: E501

        :param tenant_id: The tenant_id of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    def user_reference_id_field(self):
        """Gets the user_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        ...
        :return: The user_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def user_reference_id_field(self, user_reference_id_field):
        """Sets the user_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.

        The identification reference of the user or customer account.  This field should be mapped to a field name defined in the `fields` array for the purpose of being used as a filter in reporting tools such as Data Source Exports and Data Query.   # noqa: E501

        :param user_reference_id_field: The user_reference_id_field of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def version(self):
        """Gets the version of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501

        The time when the custom payment method type was first published.   # noqa: E501

        :return: The version of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this PUTPublishOpenPaymentMethodTypeResponse.

        The time when the custom payment method type was first published.   # noqa: E501

        :param version: The version of this PUTPublishOpenPaymentMethodTypeResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PUTPublishOpenPaymentMethodTypeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PUTPublishOpenPaymentMethodTypeResponse):
            return False
