...
class POSTSubscriptionCancellationType(object):
    ...
    def __init__(self, application_order=None, apply_credit=None, apply_credit_balance=None, cancellation_effective_date=None, cancellation_policy=None, collect=False, contract_effective_date=None, credit_memo_reason_code=None, document_date=None, invoice=None, invoice_collect=False, invoice_target_date=None, run_billing=False, target_date=None):  # noqa: E501
    ...
    def application_order(self):
        """Gets the application_order of this POSTSubscriptionCancellationType.  # noqa: E501
        ...
        :return: The application_order of this POSTSubscriptionCancellationType.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def application_order(self, application_order):
        """Sets the application_order of this POSTSubscriptionCancellationType.

        The priority order to apply credit memos and/or unapplied payments to an invoice. Possible item values are: `CreditMemo`, `UnappliedPayment`.  **Note:**   - This field is valid only if the `applyCredit` field is set to `true`.   - If no value is specified for this field, the default priority order is used, [\"CreditMemo\", \"UnappliedPayment\"], to apply credit memos first and then apply unapplied payments.   - If only one item is specified, only the items of the spedified type are applied to invoices. For example, if the value is `[\"CreditMemo\"]`, only credit memos are used to apply to invoices.   # noqa: E501

        :param application_order: The application_order of this POSTSubscriptionCancellationType.  # noqa: E501
        :type: list[str]
        """
    ...
    def apply_credit(self):
        """Gets the apply_credit of this POSTSubscriptionCancellationType.  # noqa: E501
        ...
        :return: The apply_credit of this POSTSubscriptionCancellationType.  # noqa: E501
        :rtype: bool
        """
    ...
    def apply_credit(self, apply_credit):
        """Sets the apply_credit of this POSTSubscriptionCancellationType.

        Whether to automatically apply credit memos or unapplied payments, or both to an invoice.  If the value is `true`, the credit memo or unapplied payment, or both will be automatically applied to the invoice. If no value is specified or the value is `false`, no action is taken.  **Note:** This field is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.   # noqa: E501

        :param apply_credit: The apply_credit of this POSTSubscriptionCancellationType.  # noqa: E501
        :type: bool
        """
    ...
    def contract_effective_date(self):
        """Gets the contract_effective_date of this POSTSubscriptionCancellationType.  # noqa: E501

        The date when the customer notifies you that they want to cancel their subscription.   # noqa: E501

        :return: The contract_effective_date of this POSTSubscriptionCancellationType.  # noqa: E501
        :rtype: date
        """
    ...
    def contract_effective_date(self, contract_effective_date):
        """Sets the contract_effective_date of this POSTSubscriptionCancellationType.

        The date when the customer notifies you that they want to cancel their subscription.   # noqa: E501

        :param contract_effective_date: The contract_effective_date of this POSTSubscriptionCancellationType.  # noqa: E501
        :type: date
        """
    ...
    def credit_memo_reason_code(self):
        """Gets the credit_memo_reason_code of this POSTSubscriptionCancellationType.  # noqa: E501
        ...
        :return: The credit_memo_reason_code of this POSTSubscriptionCancellationType.  # noqa: E501
        :rtype: str
        """
    ...
    def credit_memo_reason_code(self, credit_memo_reason_code):
        """Sets the credit_memo_reason_code of this POSTSubscriptionCancellationType.

        A code identifying the reason for the credit memo transaction that is generated by the request. The value must be an existing reason code. If you do not pass the field or pass the field with empty value, Zuora uses the default reason code.  # noqa: E501

        :param credit_memo_reason_code: The credit_memo_reason_code of this POSTSubscriptionCancellationType.  # noqa: E501
        :type: str
        """
