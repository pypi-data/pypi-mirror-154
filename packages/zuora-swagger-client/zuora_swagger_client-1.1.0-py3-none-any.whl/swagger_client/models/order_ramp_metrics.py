...
class OrderRampMetrics(object):
    ...
    swagger_types = {
        ...
        'gross_tcb': 'float',
        'gross_tcv': 'float',
        'intervals': 'list[OrderRampIntervalMetrics]',
        'name': 'str',
        'net_tcb': 'float',
        'net_tcv': 'float',
        'number': 'str'
    ...
    def __init__(self, description=None, discount_tcb=None, discount_tcv=None, gross_tcb=None, gross_tcv=None, intervals=None, name=None, net_tcb=None, net_tcv=None, number=None):  # noqa: E501
        """OrderRampMetrics - a model defined in Swagger"""  # noqa: E501
    ...
    def description(self):
        """Gets the description of this OrderRampMetrics.  # noqa: E501

        The short description of the ramp.  # noqa: E501

        :return: The description of this OrderRampMetrics.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this OrderRampMetrics.

        The short description of the ramp.  # noqa: E501

        :param description: The description of this OrderRampMetrics.  # noqa: E501
        :type: str
        """
    ...
    def discount_tcb(self):
        """Gets the discount_tcb of this OrderRampMetrics.  # noqa: E501

        The discount amount for the TCB.  # noqa: E501

        :return: The discount_tcb of this OrderRampMetrics.  # noqa: E501
        :rtype: float
        """
    ...
    def discount_tcb(self, discount_tcb):
        """Sets the discount_tcb of this OrderRampMetrics.

        The discount amount for the TCB.  # noqa: E501

        :param discount_tcb: The discount_tcb of this OrderRampMetrics.  # noqa: E501
        :type: float
        """
    ...
    def discount_tcv(self):
        """Gets the discount_tcv of this OrderRampMetrics.  # noqa: E501

        The discount amount for the TCV.  # noqa: E501

        :return: The discount_tcv of this OrderRampMetrics.  # noqa: E501
        :rtype: float
        """
    ...
    def discount_tcv(self, discount_tcv):
        """Sets the discount_tcv of this OrderRampMetrics.

        The discount amount for the TCV.  # noqa: E501

        :param discount_tcv: The discount_tcv of this OrderRampMetrics.  # noqa: E501
        :type: float
        """
    ...
    @property
    def gross_tcb(self):
        """Gets the gross_tcb of this OrderRampMetrics.  # noqa: E501

        The gross TCB value before discount charges are applied.  # noqa: E501

        :return: The gross_tcb of this OrderRampMetrics.  # noqa: E501
        :rtype: float
        """
    ...
    def gross_tcb(self, gross_tcb):
        """Sets the gross_tcb of this OrderRampMetrics.

        The gross TCB value before discount charges are applied.  # noqa: E501

        :param gross_tcb: The gross_tcb of this OrderRampMetrics.  # noqa: E501
        :type: float
        """
    ...
    @property
    def gross_tcv(self):
        """Gets the gross_tcv of this OrderRampMetrics.  # noqa: E501

        The gross TCV value before discount charges are applied.  # noqa: E501

        :return: The gross_tcv of this OrderRampMetrics.  # noqa: E501
        :rtype: float
        """
    ...
    def gross_tcv(self, gross_tcv):
        """Sets the gross_tcv of this OrderRampMetrics.

        The gross TCV value before discount charges are applied.  # noqa: E501

        :param gross_tcv: The gross_tcv of this OrderRampMetrics.  # noqa: E501
        :type: float
        """
    ...
    @property
    def intervals(self):
        """Gets the intervals of this OrderRampMetrics.  # noqa: E501

        The ramp metrics for each ramp intervals in its timeline.  # noqa: E501

        :return: The intervals of this OrderRampMetrics.  # noqa: E501
        :rtype: list[OrderRampIntervalMetrics]
        """
        return self._intervals

    @intervals.setter
    def intervals(self, intervals):
        """Sets the intervals of this OrderRampMetrics.

        The ramp metrics for each ramp intervals in its timeline.  # noqa: E501

        :param intervals: The intervals of this OrderRampMetrics.  # noqa: E501
        :type: list[OrderRampIntervalMetrics]
        """
    ...
    @property
    def name(self):
        """Gets the name of this OrderRampMetrics.  # noqa: E501

        The name of the ramp.  # noqa: E501

        :return: The name of this OrderRampMetrics.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OrderRampMetrics.

        The name of the ramp.  # noqa: E501

        :param name: The name of this OrderRampMetrics.  # noqa: E501
        :type: str
        """
    ...
    @property
    def net_tcb(self):
        """Gets the net_tcb of this OrderRampMetrics.  # noqa: E501

        The net TCB value after discount charges are applied.  # noqa: E501

        :return: The net_tcb of this OrderRampMetrics.  # noqa: E501
        :rtype: float
        """
    ...
    def net_tcb(self, net_tcb):
        """Sets the net_tcb of this OrderRampMetrics.

        The net TCB value after discount charges are applied.  # noqa: E501

        :param net_tcb: The net_tcb of this OrderRampMetrics.  # noqa: E501
        :type: float
        """
    ...
    @property
    def net_tcv(self):
        """Gets the net_tcv of this OrderRampMetrics.  # noqa: E501

        The net TCV value after discount charges are applied.  # noqa: E501

        :return: The net_tcv of this OrderRampMetrics.  # noqa: E501
        :rtype: float
        """
    ...
    def net_tcv(self, net_tcv):
        """Sets the net_tcv of this OrderRampMetrics.

        The net TCV value after discount charges are applied.  # noqa: E501

        :param net_tcv: The net_tcv of this OrderRampMetrics.  # noqa: E501
        :type: float
        """
    ...
    @property
    def number(self):
        """Gets the number of this OrderRampMetrics.  # noqa: E501

        The number of the ramp. It is automaticcally generated by the billing system.  # noqa: E501

        :return: The number of this OrderRampMetrics.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this OrderRampMetrics.

        The number of the ramp. It is automaticcally generated by the billing system.  # noqa: E501

        :param number: The number of this OrderRampMetrics.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderRampMetrics, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderRampMetrics):
            return False
