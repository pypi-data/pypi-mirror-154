...
class GetWorkflowResponse(object):
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["Queued", "Processing", "Stopping", "Stopped", "Finished"]  # noqa: E501
