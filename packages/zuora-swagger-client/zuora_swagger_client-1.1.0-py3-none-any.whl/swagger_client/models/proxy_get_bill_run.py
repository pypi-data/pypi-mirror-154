...
class ProxyGetBillRun(object):
    ...
    @property
    def batches(self):
        """Gets the batches of this ProxyGetBillRun.  # noqa: E501

        The specific batches of customer accounts to be included in the bill run.   **Note**: To use this field, you must set the `X-Zuora-WSDL-Version` request header to `102` or later. Otherwise, an error occurs.  **Character limit:** 20  **Values:** `AllBatches`, `Batch`*n* or an array of `Batch`*n* where *n* is a number between 1 and 50   # noqa: E501

        :return: The batches of this ProxyGetBillRun.  # noqa: E501
        :rtype: str
        """
    ...
    def batches(self, batches):
        """Sets the batches of this ProxyGetBillRun.

        The specific batches of customer accounts to be included in the bill run.   **Note**: To use this field, you must set the `X-Zuora-WSDL-Version` request header to `102` or later. Otherwise, an error occurs.  **Character limit:** 20  **Values:** `AllBatches`, `Batch`*n* or an array of `Batch`*n* where *n* is a number between 1 and 50   # noqa: E501

        :param batches: The batches of this ProxyGetBillRun.  # noqa: E501
        :type: str
        """
