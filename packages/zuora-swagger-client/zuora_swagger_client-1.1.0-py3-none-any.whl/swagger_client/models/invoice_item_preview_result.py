...
class InvoiceItemPreviewResult(object):
    ...
    def processing_type(self, processing_type):
        ...
        :type: str
        """
        allowed_values = ["Charge", "Discount", "Tax"]  # noqa: E501
        if processing_type not in allowed_values:
            raise ValueError(
                "Invalid value for `processing_type` ({0}), must be one of {1}"  # noqa: E501
