...
class GetWorkflowSetupResponse(object):
    ...
    def __init__(self, callout_trigger=None, created_at=None, description=None, id=None, interval=None, name=None, ondemand_trigger=None, priority=None, scheduled_trigger=None, status=None, timezone=None, updated_at=None):  # noqa: E501
        """GetWorkflowSetupResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def callout_trigger(self):
        """Gets the callout_trigger of this GetWorkflowSetupResponse.  # noqa: E501

        If true, the workflow will run upon an API callout. This field must be `true` for integrating with the Configurable Payment Retry feature or the Collections Window feature in Collect.   # noqa: E501

        :return: The callout_trigger of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def callout_trigger(self, callout_trigger):
        """Sets the callout_trigger of this GetWorkflowSetupResponse.

        If true, the workflow will run upon an API callout. This field must be `true` for integrating with the Configurable Payment Retry feature or the Collections Window feature in Collect.   # noqa: E501

        :param callout_trigger: The callout_trigger of this GetWorkflowSetupResponse.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def created_at(self):
        """Gets the created_at of this GetWorkflowSetupResponse.  # noqa: E501

        The date and time when the workflow was created, in the `YYYY-MM-DD HH:MM:SS` format   # noqa: E501

        :return: The created_at of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def created_at(self, created_at):
        """Sets the created_at of this GetWorkflowSetupResponse.

        The date and time when the workflow was created, in the `YYYY-MM-DD HH:MM:SS` format   # noqa: E501

        :param created_at: The created_at of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this GetWorkflowSetupResponse.  # noqa: E501

        The description of the workflow definition   # noqa: E501

        :return: The description of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this GetWorkflowSetupResponse.

        The description of the workflow definition   # noqa: E501

        :param description: The description of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def id(self):
        """Gets the id of this GetWorkflowSetupResponse.  # noqa: E501

        The unique ID of the workflow definition   # noqa: E501

        :return: The id of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this GetWorkflowSetupResponse.

        The unique ID of the workflow definition   # noqa: E501

        :param id: The id of this GetWorkflowSetupResponse.  # noqa: E501
        :type: int
        """
    ...
    @property
    def interval(self):
        """Gets the interval of this GetWorkflowSetupResponse.  # noqa: E501

        The cron expression for workflows with scheduled_trigger as `true`   # noqa: E501

        :return: The interval of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def interval(self, interval):
        """Sets the interval of this GetWorkflowSetupResponse.

        The cron expression for workflows with scheduled_trigger as `true`   # noqa: E501

        :param interval: The interval of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this GetWorkflowSetupResponse.  # noqa: E501

        The name of the workflow definition   # noqa: E501

        :return: The name of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this GetWorkflowSetupResponse.

        The name of the workflow definition   # noqa: E501

        :param name: The name of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    def ondemand_trigger(self):
        """Gets the ondemand_trigger of this GetWorkflowSetupResponse.  # noqa: E501

        If true, the workflow will run when manually initiated.   # noqa: E501

        :return: The ondemand_trigger of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def ondemand_trigger(self, ondemand_trigger):
        """Sets the ondemand_trigger of this GetWorkflowSetupResponse.

        If true, the workflow will run when manually initiated.   # noqa: E501

        :param ondemand_trigger: The ondemand_trigger of this GetWorkflowSetupResponse.  # noqa: E501
        :type: bool
        """
    ...
    def priority(self, priority):
        """Sets the priority of this GetWorkflowSetupResponse.

        Can be `High`, `Medium`, or `Low`. Higher-priority workflows take precedence over lower-priority workflows. When a workflow of higher priority is initiated, it will be placed ahead of lower-priority workflows that are running. Depending on the available resources, lower-priority workflows may be paused until resources are released.   # noqa: E501

        :param priority: The priority of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    def scheduled_trigger(self):
        """Gets the scheduled_trigger of this GetWorkflowSetupResponse.  # noqa: E501

        If true, the workflow will run based on the configured schedule with the interval field.   # noqa: E501

        :return: The scheduled_trigger of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def scheduled_trigger(self, scheduled_trigger):
        """Sets the scheduled_trigger of this GetWorkflowSetupResponse.

        If true, the workflow will run based on the configured schedule with the interval field.   # noqa: E501

        :param scheduled_trigger: The scheduled_trigger of this GetWorkflowSetupResponse.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def status(self):
        """Gets the status of this GetWorkflowSetupResponse.  # noqa: E501
        ...
        :return: The status of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this GetWorkflowSetupResponse.

        Can be `Active` or `Inactive`. Active workfow definitions run like normal. Inactive workflow definitions cannot be run.   # noqa: E501

        :param status: The status of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timezone(self):
        """Gets the timezone of this GetWorkflowSetupResponse.  # noqa: E501

        The timezone that corresponds with the cron expression in the interval field. See the [list of accepted timezone values](https://docs.google.com/spreadsheets/d/1skhepi-q5l9LyaMUPZjU_V9gzTphNMqNyV6ST5mygEo/edit?usp=sharing).   # noqa: E501

        :return: The timezone of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this GetWorkflowSetupResponse.

        The timezone that corresponds with the cron expression in the interval field. See the [list of accepted timezone values](https://docs.google.com/spreadsheets/d/1skhepi-q5l9LyaMUPZjU_V9gzTphNMqNyV6ST5mygEo/edit?usp=sharing).   # noqa: E501

        :param timezone: The timezone of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def updated_at(self):
        """Gets the updated_at of this GetWorkflowSetupResponse.  # noqa: E501

        The date and time when the workflow was updated the last time, in the `YYYY-MM-DD HH:MM:SS` format   # noqa: E501

        :return: The updated_at of this GetWorkflowSetupResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def updated_at(self, updated_at):
        """Sets the updated_at of this GetWorkflowSetupResponse.

        The date and time when the workflow was updated the last time, in the `YYYY-MM-DD HH:MM:SS` format   # noqa: E501

        :param updated_at: The updated_at of this GetWorkflowSetupResponse.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GetWorkflowSetupResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GetWorkflowSetupResponse):
            return False
