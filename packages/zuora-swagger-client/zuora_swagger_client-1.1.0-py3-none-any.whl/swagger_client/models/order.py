...
class Order(object):
    ...
    swagger_types = {
        ...
        'order_date': 'date',
        'order_line_items': 'list[OrderLineItemRetrieveOrder]',
        'order_number': 'str',
        'status': 'str',
    ...
    def __init__(self, created_by=None, created_date=None, currency=None, custom_fields=None, description=None, existing_account_number=None, order_date=None, order_line_items=None, order_number=None, status=None, subscriptions=None, updated_by=None, updated_date=None):  # noqa: E501
    ...
    def order_line_items(self):
        ...
        :rtype: list[OrderLineItemRetrieveOrder]
        """
    ...
    def order_line_items(self, order_line_items):
        ...
        :type: list[OrderLineItemRetrieveOrder]
        """
