...
class ProxyCreateBillRun(object):
    ...
    def __init__(self, account_id=None, auto_email=False, auto_post=False, auto_renewal=False, batch=None, batches=None, bill_cycle_day=None, charge_type_to_exclude=None, invoice_date=None, no_email_for_zero_amount_invoice=False, target_date=None):  # noqa: E501
    ...
    @property
    def batches(self):
        """Gets the batches of this ProxyCreateBillRun.  # noqa: E501

        The specific batches of customer accounts to be included in the bill run.   You cannot set the `Batches` field to a value consisting of both `AllBatches` and `Batch`*n*. Otherwise, the `INVALID_VALUE` error occurs. For example, `AllBatches,Batch3` is an invalid value for this field. Batch of accounts for this bill run.   **Note**: To use this field, you must set the `X-Zuora-WSDL-Version` request header to `102` or later. Otherwise, an error occurs.  **Character limit:** 20  **Values:** `AllBatches`, `Batch`*n* or an array of `Batch`*n* where *n* is a number between 1 and 50   # noqa: E501

        :return: The batches of this ProxyCreateBillRun.  # noqa: E501
        :rtype: str
        """
    ...
    def batches(self, batches):
        """Sets the batches of this ProxyCreateBillRun.

        The specific batches of customer accounts to be included in the bill run.   You cannot set the `Batches` field to a value consisting of both `AllBatches` and `Batch`*n*. Otherwise, the `INVALID_VALUE` error occurs. For example, `AllBatches,Batch3` is an invalid value for this field. Batch of accounts for this bill run.   **Note**: To use this field, you must set the `X-Zuora-WSDL-Version` request header to `102` or later. Otherwise, an error occurs.  **Character limit:** 20  **Values:** `AllBatches`, `Batch`*n* or an array of `Batch`*n* where *n* is a number between 1 and 50   # noqa: E501

        :param batches: The batches of this ProxyCreateBillRun.  # noqa: E501
        :type: str
        """
