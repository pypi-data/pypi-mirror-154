...
class PaymentMethodsApi(object):
    ...
    def d_elete_payment_methods_with_http_info(self, payment_method_id, **kwargs):  # noqa: E501
        ...
        all_params = ['payment_method_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
    ...
    def g_et_payment_methods_credit_card_with_http_info(self, account_key, **kwargs):  # noqa: E501
        ...
        all_params = ['account_key', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_et_stored_credential_profiles_with_http_info(self, payment_method_id, **kwargs):  # noqa: E501
        ...
        all_params = ['payment_method_id', 'zuora_track_id', 'zuora_entity_ids', 'include_all']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def object_post_payment_method(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_post_payment_method(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProxyCreatePaymentMethod body: (required)
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.object_post_payment_method_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.object_post_payment_method_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def object_post_payment_method_with_http_info(self, body, **kwargs):  # noqa: E501
        """CRUD: Create a payment method  # noqa: E501

        Use this operation to create either a payment method associated with a specific customer account, or an orphan payment method that is not associated with any customer account. The orphan payment method must be associated with a customer account within 10 days. Otherwise, it will be deleted.  After a credit card payment method is created, it is recommended to enable [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method. See [Migrate an existing payment method for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions/Configuration_procedures/Migrate_an_existing_payment_method) or [Migrate all existing payment methods for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions/Configuration_procedures/Migrate_all_existing_payment_methods_for_stored_credential_transactions) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_post_payment_method_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'zuora_entity_ids', 'zuora_track_id', 'reject_unknown_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `object_post_payment_method`")  # noqa: E501
    ...
    def object_put_payment_method(self, body, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_payment_method(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProxyModifyPaymentMethod body: (required)
        :param str id: Object id (required)
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param bool reject_unknown_fields: Specifies whether the call fails if the request body contains unknown fields. With `rejectUnknownFields` set to `true`, Zuora returns a 400 response if the request body contains unknown fields. The body of the 400 response is:  ```json {     \"message\": \"Error - unrecognised fields\" } ```  By default, Zuora ignores unknown fields in the request body. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.object_put_payment_method_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.object_put_payment_method_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def object_put_payment_method_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """CRUD: Update a payment method  # noqa: E501

        For a use case of this operation, see [Configure Payment Methods](https://www.zuora.com/developer/api-guides/#Configure-payment-methods).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_payment_method_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'id', 'zuora_entity_ids', 'zuora_track_id', 'reject_unknown_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `object_put_payment_method`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
    ...
    def p_ost_cancel_authorization(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Cancel authorization  # noqa: E501

        Allows you to cancel an authorization.   The following payment gateways support this operation:   - Adyen Integration v2.0   - CyberSource 1.28 and 1.97   - Chase Paymentech Orbital   - Ingenico ePayments   - Verifi Global Payment Gateway   - SlimPay   - WePay   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_cancel_authorization(body, payment_method_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTVoidAuthorize body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_cancel_authorization_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_cancel_authorization_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
            return data

    def p_ost_cancel_authorization_with_http_info(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Cancel authorization  # noqa: E501

        Allows you to cancel an authorization.   The following payment gateways support this operation:   - Adyen Integration v2.0   - CyberSource 1.28 and 1.97   - Chase Paymentech Orbital   - Ingenico ePayments   - Verifi Global Payment Gateway   - SlimPay   - WePay   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_cancel_authorization_with_http_info(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'payment_method_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_cancel_authorization`")  # noqa: E501
        # verify the required parameter 'payment_method_id' is set
        if ('payment_method_id' not in params or
                params['payment_method_id'] is None):
    ...
    def p_ost_cancel_stored_credential_profile_with_http_info(self, payment_method_id, profile_number, **kwargs):  # noqa: E501
        ...
        all_params = ['payment_method_id', 'profile_number', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ost_create_authorization(self, body, payment_method_id, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_authorization_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_authorization_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
            return data

    def p_ost_create_authorization_with_http_info(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Create authorization  # noqa: E501

        Enables you to authorize the availability of funds for a transaction but delay the capture of funds until a later time. Subsequently, use [CRUD: Create a payment](https://www.zuora.com/developer/api-reference/#operation/Object_POSTPayment) or [Create a payment](https://www.zuora.com/developer/api-reference/#operation/POST_CreatePayment) to capture the authorized funds, or use [Cancel authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CancelAuthorization) to cancel the authorization.   The following payment gateways support this operation:  * Adyen Integration v2.0 * CyberSource 1.28 * CyberSource 1.97 * CyberSource 2.0 - This gateway supports the Delayed Capture feature for both Credit Cards and Credit Card Reference payment methods. This gateway does not support [Cancel authorization](https://www.zuora.com/developer/api-reference/#operation/POST_CancelAuthorization). * Chase Paymentech Orbital * Ingenico ePayments * SlimPay * Verifi Global Payment Gateway * WePay  If you have the Invoice Settlement feature enabled, use the [Create payment](https://www.zuora.com/developer/api-reference/#operation/POST_CreatePayment) operation to capture the funds instead of the [CRUD: Create payment](https://www.zuora.com/developer/api-reference/#operation/Object_POSTPayment) operation.          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_authorization_with_http_info(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_create_authorization`")  # noqa: E501
        # verify the required parameter 'payment_method_id' is set
        if ('payment_method_id' not in params or
                params['payment_method_id'] is None):
    ...
    def p_ost_create_stored_credential_profile(self, body, payment_method_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_stored_credential_profile(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_create_stored_credential_profile_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_create_stored_credential_profile_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
            return data

    def p_ost_create_stored_credential_profile_with_http_info(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Create a stored credential profile  # noqa: E501

        Creates a stored credential profile within a payment method.  The stored credential profile represents a consent agreement that you have established with a customer. When you use the payment method in a transaction, Zuora may include information from the stored credential profile to inform the payment processor that the transaction is related to your pre-existing consent agreement with the customer.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_create_stored_credential_profile_with_http_info(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_create_stored_credential_profile`")  # noqa: E501
        # verify the required parameter 'payment_method_id' is set
        if ('payment_method_id' not in params or
                params['payment_method_id'] is None):
    ...
    def p_ost_payment_methods(self, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_payment_methods_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_payment_methods_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def p_ost_payment_methods_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a payment method  # noqa: E501

        You can use this operation to create either a payment method associated with a specific customer account, or an orphan payment method that is not associated with any customer account. The orphan payment method must be associated with a customer account within 10 days. Otherwise, it will be deleted.  This operation supports the payment methods listed below.  ### PayPal Express Checkout The following request body fields are specific to this payment method: * `BAID` (required) * `email` (required)  ### PayPal Native Express Checkout The following request body fields are specific to this payment method: * `BAID` (required) * `email` (optional)  ### PayPal Adaptive The following request body fields are specific to this payment method: * `preapprovalKey` (required) * `email` (required)  ### Credit Card The following request body fields are applicable to this payment method: * `cardHolderInfo` (`cardHolderName` required) * `cardNumber` (required) * `cardType` (required) * `expirationMonth` (required) * `expirationYear` (required) * `mitConsentAgreementRef` * `mitConsentAgreementSrc` * `mitNetworkTransactionId` * `mitProfileAction` * `mitProfileType` * `mitProfileAgreedOn` * `securityCode` * `checkDuplicated` * `mandateInfo`  When creating a credit card payment method, it is recommended to enable [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method. Specify the [required fields](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions/Configuration_procedures/Create_a_new_payment_method) to enable the support.  ### Credit Card (CC) Reference Transaction The following request body fields are applicable to this payment method: * `tokenId` (required) * `secondTokenId` * `creditCardMaskNumber` * `mandateInfo`  ### ACH The following request body fields are applicable to this payment method: * `bankABACode` (required) * `bankAccountName` (required) * `bankAccountNumber` (required) * `bankAccountType` (required) * `bankName` (required) * `addressLine1` * `addressLine2` * `phone` * `email` * `city` * `country` * `state` * `zipCode` * `mandateInfo`  ### SEPA The following request body fields are applicable to this payment method: * `IBAN` (required) * `accountHolderInfo` (required) * `businessIdentificationCode` * `mandateInfo`  ### Betalingsservice (Direct Debit DK) The following request body fields are applicable to this payment method: * `accountNumber` (required) * `identityNumber` (required) * `bankCode` (required) * `accountHolderInfo` (required) * `mandateInfo`  ### Autogiro (Direct Debit SE) The following request body fields are applicable to this payment method:         * `accountNumber` (required) * `identityNumber` (required) * `branchCode` (required) * `accountHolderInfo` (required)  * `mandateInfo`  ### Bacs (Direct Debit UK) The following request body fields are applicable to this payment method:         * `accountNumber` (required) * `bankCode` (required) * `accountHolderInfo` (required) * `mandateInfo`  ### Becs (Direct Entry AU) The following request body fields are applicable to this payment method:         * `accountNumber` (required) * `branchCode` (required) * `accountHolderInfo` (required) * `mandateInfo`  ### Becsnz (Direct Debit NZ) The following request body fields are applicable to this payment method:         * `accountNumber` (required) * `bankCode` (required) * `branchCode` (required) * `accountHolderInfo` (required) * `mandateInfo`  ### PAD (Pre-Authorized Debit) The following request body fields are applicable to this payment method: * `accountNumber` (required) * `bankCode` (required) * `branchCode` (required) * `accountHolderInfo` (required) * `mandateInfo`  ### Apple Pay on Adyen Integration v2.0 See [Set up Adyen Apple Pay](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Payment_Method_Types/Apple_Pay_on_Web/Set_up_Adyen_Apple_Pay) for details.  ### Google Pay on Adyen Integration v2.0 This feature is in the Early Adopter phase. See [Set up Adyen Google Pay](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Payment_Method_Types/Set_up_Adyen_Google_Pay) for details.  ### Custom payment methods With the support of Universal Payment Connector (UPC) and Open Payment Method (OPM) services, you can create custom payment methods by using the fields defined in a definition file for this type of custom payment method. See [Set up custom payment gateways and payment methods](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/MB_Set_up_custom_payment_gateways_and_payment_methods) for details.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_payment_methods_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_payment_methods`")  # noqa: E501
    ...
    def p_ost_payment_methods_credit_card(self, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_payment_methods_credit_card_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_payment_methods_credit_card_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def p_ost_payment_methods_credit_card_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a credit card payment method  # noqa: E501

        You can create a credit card payment method for a customer account or an orphan credit card payment method that is not associated with any customer account. The orphan payment method must be associated with a customer account within 10 days. Otherwise, it will be deleted.  This API call is CORS Enabled. Use client-side JavaScript to invoke the call.   **Note**: If you use this operation to create credit card payment methods instead of using the [iFrame of Hosted Payment Pages](https://knowledgecenter.zuora.com/CB_Billing/LA_Hosted_Payment_Pages/C_Hosted_Payment_Pages/B_Implementing_Hosted_Payment_Pages_on_Your_Website/C_Embed_and_Submit_the_iFrame), you are subject to PCI-compliance audit requirements.  When creating a credit card payment method, it is recommended to enable [the support for stored credential transactions](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions) for this payment method. Specify the [required fields](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/L_Payment_Methods/Stored_credential_transactions/Configuration_procedures/Create_a_new_payment_method) to enable the support.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_payment_methods_credit_card_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_payment_methods_credit_card`")  # noqa: E501
    ...
    def p_ost_payment_methods_decryption(self, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_payment_methods_decryption_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_payment_methods_decryption_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def p_ost_payment_methods_decryption_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create an Apple Pay payment method  # noqa: E501

        The decryption API endpoint can conditionally perform 4 tasks in one atomic call:   * Decrypt Apple Pay Payment token   * Create Credit Card Payment Method in Zuora with decrypted Apple Pay information   * Create a stored credential profile within the Apple Pay payment method (optional)   * Process Payment on a specified Invoice (optional)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_payment_methods_decryption_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_payment_methods_decryption`")  # noqa: E501
    ...
    def p_ut_payment_method(self, body, payment_method_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_payment_method(body, payment_method_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTPaymentMethodRequest body: (required)
        :param str payment_method_id: Unique ID of the payment method to update. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_payment_method_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_payment_method_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
            return data

    def p_ut_payment_method_with_http_info(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Update a payment method  # noqa: E501

        This operation allows you to update an existing payment method.   The following request body fields can be updated regardless of payment method types: * `authGateway` * `gatewayOptions` * `accountHolderInfo` * Custom fields  The following request body fields can be updated only for the Credit Card payment method: * `expirationMonth`  * `expirationYear` * `securityCode`  The following request body field can be updated for the Credit Card, Credit Card Reference Transaction, ACH, and Bank Transfer payment methods: * `mandateInfo`    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_payment_method_with_http_info(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_payment_method`")  # noqa: E501
        # verify the required parameter 'payment_method_id' is set
        if ('payment_method_id' not in params or
                params['payment_method_id'] is None):
    ...
    def p_ut_payment_methods_credit_card(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Update a credit card payment method  # noqa: E501

        Updates an existing credit card payment method.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_payment_methods_credit_card(body, payment_method_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTPaymentMethodType body: (required)
        :param str payment_method_id: Unique ID of the payment method to update. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_payment_methods_credit_card_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_payment_methods_credit_card_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
            return data

    def p_ut_payment_methods_credit_card_with_http_info(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Update a credit card payment method  # noqa: E501

        Updates an existing credit card payment method.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_payment_methods_credit_card_with_http_info(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_payment_methods_credit_card`")  # noqa: E501
        # verify the required parameter 'payment_method_id' is set
        if ('payment_method_id' not in params or
                params['payment_method_id'] is None):
    ...
    def p_ut_verify_payment_methods(self, body, payment_method_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_verify_payment_methods(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_verify_payment_methods_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_verify_payment_methods_with_http_info(body, payment_method_id, **kwargs)  # noqa: E501
            return data

    def p_ut_verify_payment_methods_with_http_info(self, body, payment_method_id, **kwargs):  # noqa: E501
        """Verify a payment method  # noqa: E501

        Sends an authorization request to the corresponding payment gateway to verify the payment method, even though no changes are made for the payment method. Supported payment methods are Credit Cards and Paypal.  Zuora now supports performing a standalone zero dollar verification or one dollar authorization for credit cards. It also supports a billing agreement status check on PayPal payment methods.  If a payment method is created by Hosted Payment Pages and is not assigned to any billing account, the payment method cannot be verified through this operation.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_verify_payment_methods_with_http_info(body, payment_method_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'payment_method_id', 'zuora_track_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
