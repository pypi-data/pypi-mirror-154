...
class RevenueItemsApi(object):
    ...
    def g_et_revenue_items_by_charge_revenue_event_number(self, event_number, **kwargs):  # noqa: E501
        """List revenue items by revenue event number  # noqa: E501
    ...
    def g_et_revenue_items_by_charge_revenue_event_number_with_http_info(self, event_number, **kwargs):  # noqa: E501
        ...
        all_params = ['event_number', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
    ...
    def g_et_revenue_items_by_charge_revenue_summary_number(self, crs_number, **kwargs):  # noqa: E501
        """List revenue items by charge revenue summary number  # noqa: E501
    ...
    def g_et_revenue_items_by_charge_revenue_summary_number_with_http_info(self, crs_number, **kwargs):  # noqa: E501
        ...
        all_params = ['crs_number', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_et_revenue_items_by_revenue_schedule(self, rs_number, **kwargs):  # noqa: E501
        """List all revenue items of a revenue schedule  # noqa: E501
    ...
    def g_et_revenue_items_by_revenue_schedule_with_http_info(self, rs_number, **kwargs):  # noqa: E501
        ...
        all_params = ['rs_number', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_event(self, body, event_number, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_custom_fieldson_revenue_items_by_revenue_event(body, event_number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTEventRIDetailType body: (required)
        :param str event_number: The number associated with the revenue event. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(body, event_number, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(body, event_number, **kwargs)  # noqa: E501
            return data

    def p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(self, body, event_number, **kwargs):  # noqa: E501
        """Update custom fields on revenue items by revenue event number  # noqa: E501

        This REST API reference describes how to update custom fields on revenue items by specifying the revenue event number. Request and response field descriptions and sample code are provided.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_custom_fieldson_revenue_items_by_revenue_event_with_http_info(body, event_number, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'event_number', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_event`")  # noqa: E501
        # verify the required parameter 'event_number' is set
        if ('event_number' not in params or
                params['event_number'] is None):
    ...
    def p_ut_custom_fieldson_revenue_items_by_revenue_schedule(self, body, rs_number, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_custom_fieldson_revenue_items_by_revenue_schedule(body, rs_number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTScheduleRIDetailType body: (required)
        :param str rs_number: Revenue schedule number. The revenue schedule number is always prefixed with \"RS\", for example, \"RS-00000001\". (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: CommonResponseType
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(body, rs_number, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(body, rs_number, **kwargs)  # noqa: E501
            return data

    def p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(self, body, rs_number, **kwargs):  # noqa: E501
        """Update custom fields on revenue items by revenue schedule number  # noqa: E501

        This REST API reference describes how to update custom fields on revenue Items by specifying the revenue schedule number. Request and response field descriptions and sample code are provided.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_custom_fieldson_revenue_items_by_revenue_schedule_with_http_info(body, rs_number, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_custom_fieldson_revenue_items_by_revenue_schedule`")  # noqa: E501
        # verify the required parameter 'rs_number' is set
        if ('rs_number' not in params or
                params['rs_number'] is None):
