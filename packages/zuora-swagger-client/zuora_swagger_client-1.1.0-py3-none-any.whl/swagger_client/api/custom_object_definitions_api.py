...
class CustomObjectDefinitionsApi(object):
    ...
    def delete_custom_object_definition_by_type_with_http_info(self, authorization, object, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'object', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
    ...
    def g_et_all_custom_object_definitions_in_namespace_with_http_info(self, authorization, **kwargs):  # noqa: E501
        ...
        all_params = ['authorization', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version', 'select']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ost_custom_object_definitions(self, body, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_custom_object_definitions(body, authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_custom_object_definitions_with_http_info(body, authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_custom_object_definitions_with_http_info(body, authorization, **kwargs)  # noqa: E501
            return data

    def p_ost_custom_object_definitions_with_http_info(self, body, authorization, **kwargs):  # noqa: E501
        """Create custom object definitions  # noqa: E501

        You can post custom object definitions with the request body schema described below.   This operation also allows you to use the [List custom object definitions](https://www.zuora.com/developer/api-reference/#operation/GET_AllCustomObjectDefinitionsInNamespace) response schema as its request schema. If you want to copy all the existing custom objects from an old tenant to a new tenant, you can make a [List custom object definitions](https://www.zuora.com/developer/api-reference/#operation/GET_AllCustomObjectDefinitionsInNamespace) call in your old tenant and then use its response directly as the request of this operation in the new tenant to import all the custom objects from the old tenant.  The `label` field is the UI label of the custom object. The `object` field contains the API Name of the custom object.  ## Limitations   This custom object definition has the following limitations:  * The maximum number of characters for the Custom Object API Name (`object`) is 64. * The maximum number of characters for the Custom Object Label (`label`) is 64. * The maximum number of characters for the Custom Object Description 250. * The maximum number of custom fields in an custom object is 50. * The maximum number of characters for the custom field API name is 64. * The maximum number of characters for the custom field label (`label`) is 64. * The maximum number of characters for the custom field Description is 250. * The maximum number of picklist options is 250. * The default maximum number of characters for the Text field is 512. You can configure the max length up to 8,192 characters when creating or updating the custom object definition via API.   However, if the Text field is filterable, the max length must be 512 or less. * The maximum number of digits to the left of the decimal point for the Number field is 13, and to the right is 9.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_custom_object_definitions_with_http_info(body, authorization, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_custom_object_definitions`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
    ...
    def p_ost_update_custom_object_definition(self, body, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_update_custom_object_definition(body, authorization, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_update_custom_object_definition_with_http_info(body, authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_update_custom_object_definition_with_http_info(body, authorization, **kwargs)  # noqa: E501
            return data

    def p_ost_update_custom_object_definition_with_http_info(self, body, authorization, **kwargs):  # noqa: E501
        """Update a custom object definition  # noqa: E501

        Updates a custom object definition by posting migration resource to initiate the migration of definitions.  ## Limitations   Updating custom field definition has the following limitations:  * You can only have one action per update request. * You cannot delete fields from custom objects that contain records. * You can only add required fields to custom objects with no records. * You can change optional fields to required only on the custom objects with no records.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_update_custom_object_definition_with_http_info(body, authorization, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_update_custom_object_definition`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
