...
class RevenueSchedulesApi(object):
    ...
    def d_eleters(self, rs_number, **kwargs):  # noqa: E501
        """Delete a revenue schedule  # noqa: E501

        Deletes a revenue schedule by specifying its revenue schedule number ## Prerequisites You must have the Delete Custom Revenue Schedule permissions in Zuora Finance.  The revenue schedule must not be associated with any invoice item, invoice item adjustment, or credit/debit memo item in Zuora Billing.   # noqa: E501
    ...
    def d_eleters_with_http_info(self, rs_number, **kwargs):  # noqa: E501
        ...
        all_params = ['rs_number', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
    ...
    def g_etr_sby_credit_memo_item(self, cmi_id, **kwargs):  # noqa: E501
        """Retrieve a revenue schedule by credit memo item ID   # noqa: E501
    ...
    def g_etr_sby_credit_memo_item_with_http_info(self, cmi_id, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves the details about a revenue schedule by specifying a valid credit memo item ID.   # noqa: E501
        ...
        all_params = ['cmi_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_etr_sby_debit_memo_item(self, dmi_id, **kwargs):  # noqa: E501
        """Retrieve a revenue schedule by debit memo item ID   # noqa: E501
    ...
    def g_etr_sby_debit_memo_item_with_http_info(self, dmi_id, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves the details about a revenue schedule by specifying a valid debit memo item ID.   # noqa: E501
        ...
        all_params = ['dmi_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_etr_sby_invoice_item(self, invoice_item_id, **kwargs):  # noqa: E501
        """Retrieve a revenue schedule by invoice item ID  # noqa: E501
    ...
    def g_etr_sby_invoice_item_with_http_info(self, invoice_item_id, **kwargs):  # noqa: E501
        ...
        all_params = ['invoice_item_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_etr_sby_invoice_item_adjustment(self, invoice_item_adj_key, **kwargs):  # noqa: E501
        """Retrieve a revenue schedule by invoice item adjustment key  # noqa: E501
        ...
        :param async_req bool
        :param str invoice_item_adj_key: ID of the Invoice Item Adjustment, for example, e20b07fd416dcfcf0141c81164fd0a72. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: GETRSDetailType
                 If the method is called asynchronously,
    ...
    def g_etr_sby_invoice_item_adjustment_with_http_info(self, invoice_item_adj_key, **kwargs):  # noqa: E501
        ...
        all_params = ['invoice_item_adj_key', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_etr_sby_product_charge_and_billing_account(self, account_key, charge_key, **kwargs):  # noqa: E501
        """List revenue schedules of a product charge by charge ID and account key   # noqa: E501
    ...
    def g_etr_sby_product_charge_and_billing_account_with_http_info(self, account_key, charge_key, **kwargs):  # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Retrieves the details about all revenue schedules of a product rate plan charge by specifying the charge ID and billing account ID.   # noqa: E501
        ...
        all_params = ['account_key', 'charge_key', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_etr_sfor_subsc_charge(self, charge_key, **kwargs):  # noqa: E501
        """List revenue schedules by subscription charge key  # noqa: E501
    ...
    def g_etr_sfor_subsc_charge_with_http_info(self, charge_key, **kwargs):  # noqa: E501
        ...
        all_params = ['charge_key', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_etrs(self, rs_number, **kwargs):  # noqa: E501
        """List all details of a revenue schedule  # noqa: E501
    ...
    def p_ostr_sfor_credit_memo_item_distribute_by_date_range(self, body, cmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a credit memo item (distribute by date range)   # noqa: E501
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a credit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_credit_memo_item_distribute_by_date_range(body, cmi_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTRevenueScheduleByTransactionRatablyCMType body: (required)
        :param str cmi_id: The unique ID of a credit memo item. You can get the credit memo item ID from the response of [Get credit memo items](https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoItems).  (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(body, cmi_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(body, cmi_id, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(self, body, cmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a credit memo item (distribute by date range)   # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a credit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_credit_memo_item_distribute_by_date_range_with_http_info(body, cmi_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'cmi_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ostr_sfor_credit_memo_item_manual_distribution(self, body, cmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a credit memo item (manual distribution)   # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a credit memo item, and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_credit_memo_item_manual_distribution(body, cmi_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_credit_memo_item_manual_distribution_with_http_info(body, cmi_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_credit_memo_item_manual_distribution_with_http_info(body, cmi_id, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_credit_memo_item_manual_distribution_with_http_info(self, body, cmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a credit memo item (manual distribution)   # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a credit memo item, and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_credit_memo_item_manual_distribution_with_http_info(body, cmi_id, async_req=True)
        >>> result = thread.get()
    ...
    def p_ostr_sfor_debit_memo_item_distribute_by_date_range(self, body, dmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a debit memo item (distribute by date range)   # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a debit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_debit_memo_item_distribute_by_date_range(body, dmi_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTRevenueScheduleByTransactionRatablyDMType body: (required)
        :param str dmi_id: The unique ID of a debit memo item. You can get the debit memo item ID from the response of [Get debit memo items](https://www.zuora.com/developer/api-reference/#operation/GET_DebitMemoItems).  (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: POSTRevenueScheduleByTransactionResponseType
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(body, dmi_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(body, dmi_id, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(self, body, dmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a debit memo item (distribute by date range)   # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a debit memo item, and automatically distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_debit_memo_item_distribute_by_date_range_with_http_info(body, dmi_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'dmi_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ostr_sfor_debit_memo_item_manual_distribution(self, body, dmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a debit memo item (manual distribution)   # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a debit memo item, and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_debit_memo_item_manual_distribution(body, dmi_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_debit_memo_item_manual_distribution_with_http_info(body, dmi_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_debit_memo_item_manual_distribution_with_http_info(body, dmi_id, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_debit_memo_item_manual_distribution_with_http_info(self, body, dmi_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for a debit memo item (manual distribution)   # noqa: E501

        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.  Creates a revenue schedule for a debit memo item, and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_debit_memo_item_manual_distribution_with_http_info(body, dmi_id, async_req=True)
        >>> result = thread.get()
    ...
    def p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range(self, body, invoice_item_adj_key, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item adjustment (distribute by date range)  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range(body, invoice_item_adj_key, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTRevenueScheduleByDateRangeType body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range_with_http_info(body, invoice_item_adj_key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range_with_http_info(body, invoice_item_adj_key, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range_with_http_info(self, body, invoice_item_adj_key, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item adjustment (distribute by date range)  # noqa: E501

        Creates a revenue schedule for an Invoice Item Adjustment and distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range_with_http_info(body, invoice_item_adj_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'invoice_item_adj_key', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ostr_sfor_invoice_item_adjustment_distribute_by_date_range`")  # noqa: E501
        # verify the required parameter 'invoice_item_adj_key' is set
        if ('invoice_item_adj_key' not in params or
                params['invoice_item_adj_key'] is None):
    ...
    def p_ostr_sfor_invoice_item_adjustment_manual_distribution(self, body, invoice_item_adj_key, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item adjustment (manual distribution)  # noqa: E501

        Creates a revenue schedule for an Invoice Item Adjustment and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_adjustment_manual_distribution(body, invoice_item_adj_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_invoice_item_adjustment_manual_distribution_with_http_info(body, invoice_item_adj_key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_invoice_item_adjustment_manual_distribution_with_http_info(body, invoice_item_adj_key, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_invoice_item_adjustment_manual_distribution_with_http_info(self, body, invoice_item_adj_key, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item adjustment (manual distribution)  # noqa: E501

        Creates a revenue schedule for an Invoice Item Adjustment and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_adjustment_manual_distribution_with_http_info(body, invoice_item_adj_key, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ostr_sfor_invoice_item_adjustment_manual_distribution`")  # noqa: E501
        # verify the required parameter 'invoice_item_adj_key' is set
        if ('invoice_item_adj_key' not in params or
                params['invoice_item_adj_key'] is None):
    ...
    def p_ostr_sfor_invoice_item_distribute_by_date_range(self, body, invoice_item_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item (distribute by date range)  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_distribute_by_date_range(body, invoice_item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_invoice_item_distribute_by_date_range_with_http_info(body, invoice_item_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_invoice_item_distribute_by_date_range_with_http_info(body, invoice_item_id, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_invoice_item_distribute_by_date_range_with_http_info(self, body, invoice_item_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item (distribute by date range)  # noqa: E501

        Creates a revenue schedule for an Invoice Item and distribute the revenue by specifying the recognition start and end dates.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_distribute_by_date_range_with_http_info(body, invoice_item_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'invoice_item_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ostr_sfor_invoice_item_distribute_by_date_range`")  # noqa: E501
        # verify the required parameter 'invoice_item_id' is set
        if ('invoice_item_id' not in params or
                params['invoice_item_id'] is None):
    ...
    def p_ostr_sfor_invoice_item_manual_distribution(self, body, invoice_item_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item (manual distribution)  # noqa: E501

        Creates a revenue schedule for an Invoice Item and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_manual_distribution(body, invoice_item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_invoice_item_manual_distribution_with_http_info(body, invoice_item_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_invoice_item_manual_distribution_with_http_info(body, invoice_item_id, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_invoice_item_manual_distribution_with_http_info(self, body, invoice_item_id, **kwargs):  # noqa: E501
        """Create a revenue schedule for an invoice item (manual distribution)  # noqa: E501

        Creates a revenue schedule for an Invoice Item and manually distribute the revenue.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_invoice_item_manual_distribution_with_http_info(body, invoice_item_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ostr_sfor_invoice_item_manual_distribution`")  # noqa: E501
        # verify the required parameter 'invoice_item_id' is set
        if ('invoice_item_id' not in params or
                params['invoice_item_id'] is None):
    ...
    def p_ostr_sfor_subsc_charge(self, body, charge_key, **kwargs):  # noqa: E501
        """Create a revenue schedule by subscription charge key  # noqa: E501

        Creates a revenue schedule by specifying the subscription charge. This method is for custom unlimited revenue recognition only.  **Note**: You can create a maximum of 3,000 revenue schedules for a subscription charge.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_subsc_charge(body, charge_key, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTRevenueScheduleByChargeType body: (required)
        :param str charge_key: ID of the subscription rate plan charge; for example, 402892793e173340013e173b81000012. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ostr_sfor_subsc_charge_with_http_info(body, charge_key, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ostr_sfor_subsc_charge_with_http_info(body, charge_key, **kwargs)  # noqa: E501
            return data

    def p_ostr_sfor_subsc_charge_with_http_info(self, body, charge_key, **kwargs):  # noqa: E501
        """Create a revenue schedule by subscription charge key  # noqa: E501

        Creates a revenue schedule by specifying the subscription charge. This method is for custom unlimited revenue recognition only.  **Note**: You can create a maximum of 3,000 revenue schedules for a subscription charge.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ostr_sfor_subsc_charge_with_http_info(body, charge_key, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'charge_key', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ostr_sfor_subsc_charge`")  # noqa: E501
        # verify the required parameter 'charge_key' is set
        if ('charge_key' not in params or
                params['charge_key'] is None):
    ...
    def p_ut_revenue_across_ap(self, body, rs_number, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_revenue_across_ap(body, rs_number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTAllocateManuallyType body: (required)
        :param str rs_number: Revenue schedule number. The revenue schedule number is always prefixed with \"RS\", for example, \"RS-00000001\".  (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_revenue_across_ap_with_http_info(body, rs_number, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_revenue_across_ap_with_http_info(body, rs_number, **kwargs)  # noqa: E501
            return data

    def p_ut_revenue_across_ap_with_http_info(self, body, rs_number, **kwargs):  # noqa: E501
        """Distribute revenue across accounting periods  # noqa: E501

        Distributes revenue by specifying the revenue schedule number. Request and response field descriptions and sample code are provided.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_revenue_across_ap_with_http_info(body, rs_number, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'rs_number', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_revenue_across_ap`")  # noqa: E501
        # verify the required parameter 'rs_number' is set
        if ('rs_number' not in params or
                params['rs_number'] is None):
    ...
    def p_ut_revenue_by_recognition_startand_end_dates(self, body, rs_number, **kwargs):  # noqa: E501
        """Distribute revenue in a recognition period  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_revenue_by_recognition_startand_end_dates(body, rs_number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTRSTermType body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_revenue_by_recognition_startand_end_dates_with_http_info(body, rs_number, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_revenue_by_recognition_startand_end_dates_with_http_info(body, rs_number, **kwargs)  # noqa: E501
            return data

    def p_ut_revenue_by_recognition_startand_end_dates_with_http_info(self, body, rs_number, **kwargs):  # noqa: E501
        """Distribute revenue in a recognition period  # noqa: E501

        Distributes revenue by specifying the recognition start and end dates. Request and response field descriptions and sample code are provided.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_revenue_by_recognition_startand_end_dates_with_http_info(body, rs_number, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_revenue_by_recognition_startand_end_dates`")  # noqa: E501
        # verify the required parameter 'rs_number' is set
        if ('rs_number' not in params or
                params['rs_number'] is None):
    ...
    def p_ut_revenue_specific_date(self, body, rs_number, **kwargs):  # noqa: E501
        """Distribute revenue on a specific date  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_revenue_specific_date(body, rs_number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTSpecificDateAllocationType body: (required)
        :param str rs_number: Revenue schedule number. The revenue schedule number is always prefixed with \"RS\", for example, \"RS-00000001\".  (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: PUTRevenueScheduleResponseType
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_revenue_specific_date_with_http_info(body, rs_number, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_revenue_specific_date_with_http_info(body, rs_number, **kwargs)  # noqa: E501
            return data

    def p_ut_revenue_specific_date_with_http_info(self, body, rs_number, **kwargs):  # noqa: E501
        """Distribute revenue on a specific date  # noqa: E501

        Distributes revenue on a specific recognition date. Request and response field descriptions and sample code are provided.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_revenue_specific_date_with_http_info(body, rs_number, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_revenue_specific_date`")  # noqa: E501
        # verify the required parameter 'rs_number' is set
        if ('rs_number' not in params or
                params['rs_number'] is None):
    ...
    def p_utrs_basic_info(self, body, rs_number, **kwargs):  # noqa: E501
        """Update a revenue schedule  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_utrs_basic_info(body, rs_number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTRSBasicInfoType body: (required)
        :param str rs_number: Revenue schedule number. The revenue schedule number is always prefixed with \"RS\", for example, \"RS-00000001\".  (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: CommonResponseType
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_utrs_basic_info_with_http_info(body, rs_number, **kwargs)  # noqa: E501
        else:
            (data) = self.p_utrs_basic_info_with_http_info(body, rs_number, **kwargs)  # noqa: E501
            return data

    def p_utrs_basic_info_with_http_info(self, body, rs_number, **kwargs):  # noqa: E501
        """Update a revenue schedule  # noqa: E501

        Retrieves basic information of a revenue schedule by specifying the revenue schedule number. Request and response field descriptions and sample code are provided.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_utrs_basic_info_with_http_info(body, rs_number, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_utrs_basic_info`")  # noqa: E501
        # verify the required parameter 'rs_number' is set
        if ('rs_number' not in params or
                params['rs_number'] is None):
