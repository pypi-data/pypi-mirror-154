...
class CustomObjectBulkJobResponse(object):
    ...
    def namespace(self):
        ...
        The namespace of the object. Custom objects belong to the `default` namespace. Zuora standard objects belong to the `com_zuora` namespace. Bulk job operations on the following Zuora standard objects are supported: * SavedQuery   # noqa: E501
    ...
    def namespace(self, namespace):
        ...
        :type: str
        """
        allowed_values = ["default", "com_zuora"]  # noqa: E501
    ...
    def operation(self, operation):
        ...
        :type: str
        """
        allowed_values = ["delete", "create"]  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["accepted", "pending", "in_progress", "completed", "failed", "cancelled"]  # noqa: E501
