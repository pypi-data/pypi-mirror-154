...
class GETAmendmentType(object):
    ...
    def __init__(self, auto_renew=None, base_rate_plan_id=None, base_subscription_id=None, booking_date=None, code=None, contract_effective_date=None, current_term=None, current_term_period_type=None, customer_acceptance_date=None, description=None, destination_account_id=None, destination_invoice_owner_id=None, effective_date=None, effective_policy=None, id=None, name=None, new_rate_plan_id=None, new_subscription_id=None, renewal_setting=None, renewal_term=None, renewal_term_period_type=None, resume_date=None, service_activation_date=None, specific_update_date=None, status=None, sub_type=None, success=None, suspend_date=None, term_start_date=None, term_type=None, type=None):  # noqa: E501
    ...
    def booking_date(self):
        """Gets the booking_date of this GETAmendmentType.  # noqa: E501

        The date when the amendment is signed. This field is to standardize the booking date information to increase audit ability and traceability of data between Zuora Billing and Zuora Revenue. It is mapped as the booking date for a sale order line in Zuora Revenue.   # noqa: E501

        :return: The booking_date of this GETAmendmentType.  # noqa: E501
        :rtype: date
        """
    ...
    def booking_date(self, booking_date):
        """Sets the booking_date of this GETAmendmentType.

        The date when the amendment is signed. This field is to standardize the booking date information to increase audit ability and traceability of data between Zuora Billing and Zuora Revenue. It is mapped as the booking date for a sale order line in Zuora Revenue.   # noqa: E501

        :param booking_date: The booking_date of this GETAmendmentType.  # noqa: E501
        :type: date
        """
    ...
    def effective_policy(self):
        """Gets the effective_policy of this GETAmendmentType.  # noqa: E501
        ...
        :return: The effective_policy of this GETAmendmentType.  # noqa: E501
        :rtype: str
        """
    ...
    def effective_policy(self, effective_policy):
        """Sets the effective_policy of this GETAmendmentType.

         Effective Policy for the subscription. Possible values are:  - EffectiveImmediately  - EffectiveEndOfBillingPeriod  - SpecificDate  The value depends on the following conditions: * If the rate plan change (from old to new) is an upgrade, the effective policy is `EffectiveImmediately` by default. * If the rate plan change (from old to new) is a downgrade, the effective policy is `EffectiveEndOfBillingPeriod` by default. * Otherwise, the effective policy is `SpecificDate` by default.  **Note:** This feature is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).   # noqa: E501

        :param effective_policy: The effective_policy of this GETAmendmentType.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sub_type(self):
        """Gets the sub_type of this GETAmendmentType.  # noqa: E501

        Sub type for the subscription.   Possible values are:  - Upgrade  - Downgrade  - Crossgrade  - PlanChanged  When the old and new rate plans are within the same Grading catalog group: * If the grade of new plan is greater than that of the old plan, this is an \"Upgrade\". * If the grade of new plan is less than that of the old plan, this is a \"Downgrade\". * If the grade of new plan equals that of the old plan, this is a \"Crossgrade\".  When the old and new rate plans are not in the same Grading catalog group, or either has no group, this is \"PlanChanged\".  **Note:** This feature is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).   # noqa: E501

        :return: The sub_type of this GETAmendmentType.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_type(self, sub_type):
        """Sets the sub_type of this GETAmendmentType.

        Sub type for the subscription.   Possible values are:  - Upgrade  - Downgrade  - Crossgrade  - PlanChanged  When the old and new rate plans are within the same Grading catalog group: * If the grade of new plan is greater than that of the old plan, this is an \"Upgrade\". * If the grade of new plan is less than that of the old plan, this is a \"Downgrade\". * If the grade of new plan equals that of the old plan, this is a \"Crossgrade\".  When the old and new rate plans are not in the same Grading catalog group, or either has no group, this is \"PlanChanged\".  **Note:** This feature is in the **Early Adopter** phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).   # noqa: E501

        :param sub_type: The sub_type of this GETAmendmentType.  # noqa: E501
        :type: str
        """
