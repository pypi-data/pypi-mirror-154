...
class SubscribeResult(object):
    ...
    swagger_types = {
        ...
        'credit_memo_data': 'list[ActionSubscribeCreditMemoData]',
        'credit_memo_id': 'str',
        'credit_memo_number': 'str',
        'credit_memo_result': 'CreditMemoResult',
        'errors': 'list[ActionsErrorResponse]',
        'gateway_response': 'str',
        'gateway_response_code': 'str',
        'invoice_data': 'list[ActionSubscribeInvoiceData]',
        'invoice_id': 'str',
        'invoice_number': 'str',
    ...
    def __init__(self, account_id=None, account_number=None, charge_metrics_data=None, credit_memo_data=None, credit_memo_id=None, credit_memo_number=None, credit_memo_result=None, errors=None, gateway_response=None, gateway_response_code=None, invoice_data=None, invoice_id=None, invoice_number=None, invoice_result=None, payment_id=None, payment_transaction_number=None, subscription_id=None, subscription_number=None, success=None, total_mrr=None, total_tcv=None):  # noqa: E501
        ...
        if credit_memo_data is not None:
            self.credit_memo_data = credit_memo_data
        ...
        if credit_memo_result is not None:
            self.credit_memo_result = credit_memo_result
    ...
    @property
    def credit_memo_data(self):
        """Gets the credit_memo_data of this SubscribeResult.  # noqa: E501

        Container for credit memo data.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the `X-Zuora-WSDL-Version` request header to `107` or later.   # noqa: E501

        :return: The credit_memo_data of this SubscribeResult.  # noqa: E501
        :rtype: list[ActionSubscribeCreditMemoData]
        """
        return self._credit_memo_data

    @credit_memo_data.setter
    def credit_memo_data(self, credit_memo_data):
        """Sets the credit_memo_data of this SubscribeResult.

        Container for credit memo data.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the `X-Zuora-WSDL-Version` request header to `107` or later.   # noqa: E501

        :param credit_memo_data: The credit_memo_data of this SubscribeResult.  # noqa: E501
        :type: list[ActionSubscribeCreditMemoData]
        """

        self._credit_memo_data = credit_memo_data

    @property
    def credit_memo_id(self):
        """Gets the credit_memo_id of this SubscribeResult.  # noqa: E501

        The ID of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the `X-Zuora-WSDL-Version` request header to `107` or later.   # noqa: E501

        :return: The credit_memo_id of this SubscribeResult.  # noqa: E501
        :rtype: str
        """
    ...
    def credit_memo_id(self, credit_memo_id):
        """Sets the credit_memo_id of this SubscribeResult.

        The ID of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the `X-Zuora-WSDL-Version` request header to `107` or later.   # noqa: E501

        :param credit_memo_id: The credit_memo_id of this SubscribeResult.  # noqa: E501
        :type: str
        """
    ...
    def credit_memo_number(self):
        """Gets the credit_memo_number of this SubscribeResult.  # noqa: E501

        The number of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the `X-Zuora-WSDL-Version` request header to `107` or later.   # noqa: E501

        :return: The credit_memo_number of this SubscribeResult.  # noqa: E501
        :rtype: str
        """
    ...
    def credit_memo_number(self, credit_memo_number):
        """Sets the credit_memo_number of this SubscribeResult.

        The number of the credit memo.  **Note**: This field is only available if you have the Invoice Settlement feature enabled and set the `X-Zuora-WSDL-Version` request header to `107` or later.   # noqa: E501

        :param credit_memo_number: The credit_memo_number of this SubscribeResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def credit_memo_result(self):
        """Gets the credit_memo_result of this SubscribeResult.  # noqa: E501


        :return: The credit_memo_result of this SubscribeResult.  # noqa: E501
        :rtype: CreditMemoResult
        """
        return self._credit_memo_result

    @credit_memo_result.setter
    def credit_memo_result(self, credit_memo_result):
        """Sets the credit_memo_result of this SubscribeResult.


        :param credit_memo_result: The credit_memo_result of this SubscribeResult.  # noqa: E501
        :type: CreditMemoResult
        """

        self._credit_memo_result = credit_memo_result
    ...
    def invoice_data(self):
        ...
        :rtype: list[ActionSubscribeInvoiceData]
        """
    ...
    def invoice_data(self, invoice_data):
        ...
        :type: list[ActionSubscribeInvoiceData]
        """
