...
class POSTPublicEmailTemplateRequest(object):
    ...
    def __init__(self, active=True, bcc_email_address=None, cc_email_address=None, cc_email_type='SpecificEmails', description=None, email_body=None, email_subject=None, encoding_type='UTF8', event_category=None, event_type_name=None, event_type_namespace=None, from_email_address=None, from_email_type=None, from_name=None, is_html=False, name=None, reply_to_email_address=None, reply_to_email_type=None, to_email_address=None, to_email_type=None):  # noqa: E501
    ...
    def cc_email_type(self):
        ...
        Email CC type. * When the base object for the event is associated with `Account`, `ccEmailType` can be any values in the enum list.  * When the base object for the event is not associated with `Account`, `ccEmailType` must be `TenantAdmin`, `RunOwner`, or `SpecificEmail`.   # noqa: E501
    ...
    def to_email_type(self):
        ...
        Email receive type. * When the base object for the event is associated with `Account`, `toEmailType` can be any values in the enum list.  * When the base object for the event is not associated with `Account`, `toEmailType` must be `TenantAdmin`, `RunOwner`, or `SpecificEmail`.   # noqa: E501
