...
class GetBillingPreviewRunResponse(object):
    ...
    def __init__(self, assume_renewal=None, batch=None, batches=None, charge_type_to_exclude=None, created_by_id=None, created_date=None, end_date=None, error_message=None, including_draft_items=None, including_evergreen_subscription=None, result_file_url=None, run_number=None, start_date=None, status=None, succeeded_accounts=None, success=None, target_date=None, total_accounts=None, updated_by_id=None, updated_date=None):  # noqa: E501
