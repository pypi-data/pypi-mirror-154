...
class PreviewOrderChargeOverride(object):
    ...
    swagger_types = {
        ...
        'start_date': 'PreviewOrderTriggerParams',
        'unique_token': 'str',
    ...
    def __init__(self, billing=None, charge_number=None, custom_fields=None, description=None, drawdown_rate=None, end_date=None, prepaid_quantity=None, pricing=None, product_rate_plan_charge_id=None, rev_rec_code=None, rev_rec_trigger_condition=None, revenue_recognition_rule_name=None, start_date=None, unique_token=None, validity_period_type=None):  # noqa: E501
    ...
    def start_date(self):
        ...
        :rtype: PreviewOrderTriggerParams
        """
