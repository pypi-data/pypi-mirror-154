...
class PostOrderLineItemUpdateType(object):
    ...
    def uom(self):
        ...
        Specifies the units to measure usage.  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def accounting_code(self):
        ...
        The accountingCode for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def adjustment_liability_accounting_code(self):
        ...
        The accounting code on the Order Line Item object for customers using [Zuora Billing - Revenue Integration](https://knowledgecenter.zuora.com/Zuora_Revenue/Zuora_Billing_-_Revenue_Integration).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def amount_per_unit(self):
        ...
        The actual charged amount per unit for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def bill_target_date(self):
        ...
        The target date for the Order Line Item (OLI) to be picked up by bill run for generating invoice.  To generate invoice for an OLI, you must set this field and set the `itemState` field to `SentToBilling`.  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def deferred_revenue_accounting_code(self):
        ...
        The deferred revenue accounting code for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def description(self):
        ...
        The description of the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def item_name(self):
        ...
        The name of the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def item_number(self):
        ...
        The number for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def item_state(self):
        ...
        The state of the Order Line Item (OLI). See [Order Line Item states, Order states, and state transitions](https://knowledgecenter.zuora.com/Billing/Subscriptions/Orders/Order_Line_Items/AB_Order_Line_Item_States_and_Order_States) for more information.  To generate invoice for an OLI, you must set this field to `SentToBilling` and set the `billTargetDate` field .  You can update this field for an OLI only when the OLI is in the `Executing` or `SentToBilling`state (when the `itemState` field is set as `Executing` or `SentToBilling`).   # noqa: E501
    ...
    def item_type(self):
        ...
        The type of the Order Line Item (OLI).   You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def list_price_per_unit(self):
        ...
        The list price per unit for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def product_code(self):
        ...
        The product code for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def purchase_order_number(self):
        ...
        Used by customers to specify the Purchase Order Number provided by the buyer.  You can update this field for an Order Line Item (OLI) only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def quantity(self):
        ...
        The quantity of units, such as the number of authors in a hosted wiki service.  You can update this field for an Order Line Item (OLI) only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def recognized_revenue_accounting_code(self):
        ...
        The recognized revenue accounting code for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def related_subscription_number(self):
        ...
        Use this field to relate an order line item to an subscription. Specify this field to the subscription number of the subscription to relate.  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def revenue_recognition_rule(self):
        ...
        The Revenue Recognition rule for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def tax_code(self):
        ...
        The tax code for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def tax_mode(self):
        ...
        The tax mode for the Order Line Item (OLI).  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def transaction_end_date(self):
        ...
        The date a transaction is completed. The default value of this field is the transaction start date. Also, the value of this field should always equal or be later than the value of the `transactionStartDate` field.  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
    ...
    def transaction_start_date(self):
        ...
        The date a transaction starts. The default value of this field is the order date.  You can update this field for an OLI only when the OLI is in the `Executing` state (when the `itemState` field is set as `Executing`).   # noqa: E501
