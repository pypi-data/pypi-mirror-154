...
class POSTPaymentMethodDecryption(object):
    ...
    def mit_consent_agreement_src(self):
        ...
        Required if you set the `mitProfileAction` field. This field is only available for CyberSource v2.0 integration.   # noqa: E501
    ...
    def mit_profile_type(self):
        ...
        Required if you set the `mitProfileAction` field. Indicates the type of the stored credential profile to process recurring or unsecheduled transactions. This field is only available for CyberSource v2.0 integration.        # noqa: E501
