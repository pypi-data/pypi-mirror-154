...
class PaymentRunsApi(object):
    ...
    def d_elete_payment_run_with_http_info(self, payment_run_id, **kwargs):  # noqa: E501
        ...
        all_params = ['payment_run_id', 'zuora_track_id']  # noqa: E501
    ...
    def g_et_payment_run_with_http_info(self, payment_run_id, **kwargs):  # noqa: E501
        ...
        all_params = ['payment_run_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def g_et_payment_run_data(self, payment_run_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_payment_run_data(payment_run_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_payment_run_data_with_http_info(payment_run_id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_payment_run_data_with_http_info(payment_run_id, **kwargs)  # noqa: E501
            return data

    def g_et_payment_run_data_with_http_info(self, payment_run_id, **kwargs):  # noqa: E501
        """Retrieve payment run data  # noqa: E501

        Retrieves payment run data and the processing result with details, if the `data` field was specified in the Create payment run operation.       # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_payment_run_data_with_http_info(payment_run_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_payment_run_data" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'payment_run_id' is set
        if ('payment_run_id' not in params or
                params['payment_run_id'] is None):
            raise ValueError("Missing the required parameter `payment_run_id` when calling `g_et_payment_run_data`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/payment-runs/{paymentRunId}/data', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def g_et_payment_runs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['zuora_track_id', 'zuora_entity_ids', 'page_size', 'created_by_id', 'created_date', 'status', 'target_date', 'updated_by_id', 'updated_date', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ut_payment_run(self, body, payment_run_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_payment_run(body, payment_run_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_payment_run_with_http_info(body, payment_run_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_payment_run_with_http_info(body, payment_run_id, **kwargs)  # noqa: E501
            return data

    def p_ut_payment_run_with_http_info(self, body, payment_run_id, **kwargs):  # noqa: E501
        """Update a payment run  # noqa: E501

        Updates the information about an unexecuted payment run. Only pending payment runs can be updated.  If none of the **accountId**, **batch**, **billCycleDay**, **currency**, **paymentGatewayId**, and **billingRunId** fields is specified in the request body, the corresponding payment run collects payments for all accounts.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_payment_run_with_http_info(body, payment_run_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'payment_run_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
