...
class BillingDocumentsApi(object):
    ...
    def g_et_billing_document_files_deletion_job_with_http_info(self, job_id, **kwargs):  # noqa: E501
        ...
        all_params = ['job_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
    ...
    def g_et_billing_documents_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['account_id', 'zuora_track_id', 'zuora_entity_ids', 'page_size', 'document_date', 'status', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
