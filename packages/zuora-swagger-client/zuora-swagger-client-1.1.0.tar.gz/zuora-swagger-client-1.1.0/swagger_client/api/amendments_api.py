...
class AmendmentsApi(object):
    ...
    def g_et_amendments_by_key(self, amendment_key, **kwargs):  # noqa: E501
        """Retrieve an amendment  # noqa: E501
    ...
    def g_et_amendments_by_key_with_http_info(self, amendment_key, **kwargs):  # noqa: E501
        ...
        all_params = ['amendment_key', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
    ...
    def g_et_amendments_by_subscription_id(self, subscription_id, **kwargs):  # noqa: E501
        """List all amendments of a subscription  # noqa: E501
    ...
    def g_et_amendments_by_subscription_id_with_http_info(self, subscription_id, **kwargs):  # noqa: E501
        ...
        all_params = ['subscription_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def object_delete_amendment(self, id, **kwargs):  # noqa: E501
        """CRUD: Delete an amendment  # noqa: E501

         Invoiced amendments cannot usually be deleted. One exception to this rule is auto-renew amendments. You can delete the last auto-renew amendment even if an invoice has been generated.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def object_get_amendment(self, id, **kwargs):  # noqa: E501
        """CRUD: Retrieve an amendment  # noqa: E501
    ...
    def object_put_amendment(self, body, id, **kwargs):  # noqa: E501
        """CRUD: Update an amendment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_amendment(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProxyModifyAmendment body: (required)
        :param str id: Object id (required)
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.object_put_amendment_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.object_put_amendment_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def object_put_amendment_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """CRUD: Update an amendment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.object_put_amendment_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `object_put_amendment`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
