...
class AccountingCodesApi(object):
    ...
    def d_elete_accounting_code_with_http_info(self, ac_id, **kwargs):  # noqa: E501
        ...
        all_params = ['ac_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
    ...
    def p_ost_accounting_code(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_accounting_code(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTAccountingCodeType body: (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_accounting_code_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_accounting_code_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def p_ost_accounting_code_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create an accounting code  # noqa: E501

        This reference describes how to create a new accounting code through the REST API.  The accounting code will be active as soon as it has been created.  ## Prerequisites   If you have Zuora Finance enabled on your tenant, you must have the  Configure Accounting Codes permission.    # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_accounting_code_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_accounting_code`")  # noqa: E501
    ...
    def p_ut_accounting_code(self, body, ac_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_accounting_code(body, ac_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTAccountingCodeType body: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_accounting_code_with_http_info(body, ac_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_accounting_code_with_http_info(body, ac_id, **kwargs)  # noqa: E501
            return data

    def p_ut_accounting_code_with_http_info(self, body, ac_id, **kwargs):  # noqa: E501
        """Update an accounting code  # noqa: E501

        This reference describes how to update an existing accounting code through the REST API. ## Prerequisites   If you have Zuora Finance enabled on your tenant, you must have the  Manage Accounting Code permission.  ## Limitations You can only update accounting codes that are not already associated with any transactions.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_accounting_code_with_http_info(body, ac_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'ac_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_accounting_code`")  # noqa: E501
        # verify the required parameter 'ac_id' is set
        if ('ac_id' not in params or
                params['ac_id'] is None):
