...
class SummaryJournalEntriesApi(object):
    ...
    def d_elete_summary_journal_entry_with_http_info(self, je_number, **kwargs):  # noqa: E501
        ...
        all_params = ['je_number', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
    ...
    def g_et_all_summary_journal_entries_with_http_info(self, jr_number, **kwargs):  # noqa: E501
        ...
        all_params = ['jr_number', 'zuora_track_id', 'zuora_entity_ids', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def p_ost_summary_journal_entry(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_summary_journal_entry(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTJournalEntryType body: (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_summary_journal_entry_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_summary_journal_entry_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def p_ost_summary_journal_entry_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a summary journal entry  # noqa: E501

        This REST API reference describes how to manually create a summary journal entry. Request and response field descriptions and sample code are provided. ## Requirements 1.The sum of debits must equal the sum of credits in the summary journal entry.  2.The following applies only if you use foreign currency conversion:   * If you have configured Aggregate transactions with different currencies during a Journal Run to \"Yes\", the value of the **currency** field must be the same as your tenant's home currency. That is, you must create journal entries using your home currency.   * All journal entries in an accounting period must either all be aggregated or all be unaggregated. You cannot have a mix of aggregated and unaggregated journal entries in the same accounting period.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_summary_journal_entry_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_summary_journal_entry`")  # noqa: E501
    ...
    def p_ut_basic_summary_journal_entry(self, body, je_number, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_basic_summary_journal_entry(body, je_number, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PUTBasicSummaryJournalEntryType body: (required)
        :param str je_number: Journal entry number in the format JE-00000001. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :return: CommonResponseType
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ut_basic_summary_journal_entry_with_http_info(body, je_number, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ut_basic_summary_journal_entry_with_http_info(body, je_number, **kwargs)  # noqa: E501
            return data

    def p_ut_basic_summary_journal_entry_with_http_info(self, body, je_number, **kwargs):  # noqa: E501
        """Update a summary journal entry  # noqa: E501

         This REST API reference describes how to update the basic information of a summary journal entry. Request and response field descriptions and sample code are provided.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ut_basic_summary_journal_entry_with_http_info(body, je_number, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'je_number', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ut_basic_summary_journal_entry`")  # noqa: E501
        # verify the required parameter 'je_number' is set
        if ('je_number' not in params or
                params['je_number'] is None):
