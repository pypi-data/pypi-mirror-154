...
class PaymentGatewayReconciliationApi(object):
    ...
    def p_ost_reconcile_refund(self, body, refund_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.p_ost_reconcile_refund(body, refund_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTReconcileRefundRequest body: (required)
        :param str refund_id: Unique ID of the refund. (required)
        ...
        if kwargs.get('async_req'):
            return self.p_ost_reconcile_refund_with_http_info(body, refund_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_reconcile_refund_with_http_info(body, refund_id, **kwargs)  # noqa: E501
            return data

    def p_ost_reconcile_refund_with_http_info(self, body, refund_id, **kwargs):  # noqa: E501
        """Reconcile a refund  # noqa: E501

        Reconciles a refund when receiving the gateway reconciliation request or event.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_reconcile_refund_with_http_info(body, refund_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'refund_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method p_ost_reconcile_refund" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_reconcile_refund`")  # noqa: E501
        # verify the required parameter 'refund_id' is set
        if ('refund_id' not in params or
                params['refund_id'] is None):
            raise ValueError("Missing the required parameter `refund_id` when calling `p_ost_reconcile_refund`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'refund_id' in params:
            path_params['refund-id'] = params['refund_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/refunds/{refund-id}/reconcile', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='POSTReconcileRefundResponse',  # noqa: E501
    ...
    def p_ost_reject_payment(self, body, payment_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_reject_payment(body, payment_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTRejectPaymentRequest body: (required)
        :param str payment_id: Unique ID of the payment. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_reject_payment_with_http_info(body, payment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_reject_payment_with_http_info(body, payment_id, **kwargs)  # noqa: E501
            return data

    def p_ost_reject_payment_with_http_info(self, body, payment_id, **kwargs):  # noqa: E501
        """Reject a payment  # noqa: E501

        Sets the Gateway State field of the payment to \"FailedToSettle\", creates a refund for the payment amount, and returns the Refund object as response.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_reject_payment_with_http_info(body, payment_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'payment_id', 'zuora_track_id', 'zuora_entity_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_reject_payment" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_reject_payment`")  # noqa: E501
        # verify the required parameter 'payment_id' is set
        if ('payment_id' not in params or
                params['payment_id'] is None):
            raise ValueError("Missing the required parameter `payment_id` when calling `p_ost_reject_payment`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/gateway-settlement/payments/{payment-id}/reject', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='POSTRejectPaymentResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ost_reverse_payment(self, body, payment_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_reverse_payment(body, payment_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTReversePaymentRequest body: (required)
        :param str payment_id: Unique ID of the payment. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_reverse_payment_with_http_info(body, payment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_reverse_payment_with_http_info(body, payment_id, **kwargs)  # noqa: E501
            return data

    def p_ost_reverse_payment_with_http_info(self, body, payment_id, **kwargs):  # noqa: E501
        """Reverse a payment  # noqa: E501

        Sets the Gateway State field of the payment to \"Settled\", creates a refund for the amount specified in the request, and returns the Refund object as response.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_reverse_payment_with_http_info(body, payment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_reverse_payment" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_reverse_payment`")  # noqa: E501
        # verify the required parameter 'payment_id' is set
        if ('payment_id' not in params or
                params['payment_id'] is None):
            raise ValueError("Missing the required parameter `payment_id` when calling `p_ost_reverse_payment`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/gateway-settlement/payments/{payment-id}/chargeback', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='POSTReversePaymentResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ost_settle_payment(self, body, payment_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_settle_payment(body, payment_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param POSTSettlePaymentRequest body: (required)
        :param str payment_id: Unique ID of the payment. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_settle_payment_with_http_info(body, payment_id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_settle_payment_with_http_info(body, payment_id, **kwargs)  # noqa: E501
            return data

    def p_ost_settle_payment_with_http_info(self, body, payment_id, **kwargs):  # noqa: E501
        """Settle a payment  # noqa: E501

        Sets the Gateway State field of the payment to \"Settled\" and returns the Payment object as response.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_settle_payment_with_http_info(body, payment_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_settle_payment" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_settle_payment`")  # noqa: E501
        # verify the required parameter 'payment_id' is set
        if ('payment_id' not in params or
                params['payment_id'] is None):
            raise ValueError("Missing the required parameter `payment_id` when calling `p_ost_settle_payment`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/gateway-settlement/payments/{payment-id}/settle', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='POSTSettlePaymentResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
