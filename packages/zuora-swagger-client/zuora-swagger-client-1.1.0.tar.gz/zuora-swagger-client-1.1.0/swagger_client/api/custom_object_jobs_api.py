...
class CustomObjectJobsApi(object):
    ...
    def g_et_all_custom_object_bulk_jobs(self, authorization, **kwargs):  # noqa: E501
        ...
        >>> thread = api.g_et_all_custom_object_bulk_jobs(authorization, async_req=True)
        >>> result = thread.get()
        ...
        :param int page_size: Page size of the result. The maximum page size is 100. The defaut page size is 25.
        :param str cursor: The `cursor` points to the last job of the previous result set. The cursor job is not included in this query result. The call returns the first page if `cursor` is not provided and `pageSize` is valid.
        ...
        if kwargs.get('async_req'):
            return self.g_et_all_custom_object_bulk_jobs_with_http_info(authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_all_custom_object_bulk_jobs_with_http_info(authorization, **kwargs)  # noqa: E501
            return data

    def g_et_all_custom_object_bulk_jobs_with_http_info(self, authorization, **kwargs):  # noqa: E501
        """List all custom object bulk jobs  # noqa: E501

        Lists all custom object bulk jobs submitted by your tenant.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_all_custom_object_bulk_jobs_with_http_info(authorization, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version', 'page_size', 'cursor']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method g_et_all_custom_object_bulk_jobs" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('authorization' not in params or
            ...
            raise ValueError("Missing the required parameter `authorization` when calling `g_et_all_custom_object_bulk_jobs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='CustomObjectBulkJobResponseCollection',  # noqa: E501
    ...
    def g_et_custom_object_bulk_job(self, authorization, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_custom_object_bulk_job(authorization, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: `Bearer {token}` for a valid OAuth token.  (required)
        :param str id: The ID of the custom object bulk job to be retrieved. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param date zuora_version: API version that determines the response schema. The default version is used if this parameter is not included. Specify `Zuora-Version` in the request header if you expect a specific response schema.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_custom_object_bulk_job_with_http_info(authorization, id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_custom_object_bulk_job_with_http_info(authorization, id, **kwargs)  # noqa: E501
            return data

    def g_et_custom_object_bulk_job_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        """Retrieve a custom object bulk job  # noqa: E501

        Retrieves the custom object bulk job details by job ID.  Only the users that have the \"View Custom Objects\" permission can retrieve custom object bulk jobs. See [Platform Permissions](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/h_Platform_Roles#Platform_Permissions) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_custom_object_bulk_job_with_http_info(authorization, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['authorization', 'id', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_custom_object_bulk_job" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `g_et_custom_object_bulk_job`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `g_et_custom_object_bulk_job`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CustomObjectBulkJobResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def g_et_custom_object_bulk_job_errors(self, authorization, id, **kwargs):  # noqa: E501
        """List all errors for a custom object bulk job  # noqa: E501

        Lists all errors for a custom object bulk job.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_custom_object_bulk_job_errors(authorization, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str authorization: `Bearer {token}` for a valid OAuth token.  (required)
        :param str id: The ID of the custom object bulk job that you retrieve errors for. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param date zuora_version: API version that determines the response schema. The default version is used if this parameter is not included. Specify `Zuora-Version` in the request header if you expect a specific response schema.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.g_et_custom_object_bulk_job_errors_with_http_info(authorization, id, **kwargs)  # noqa: E501
        else:
            (data) = self.g_et_custom_object_bulk_job_errors_with_http_info(authorization, id, **kwargs)  # noqa: E501
            return data

    def g_et_custom_object_bulk_job_errors_with_http_info(self, authorization, id, **kwargs):  # noqa: E501
        """List all errors for a custom object bulk job  # noqa: E501

        Lists all errors for a custom object bulk job.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.g_et_custom_object_bulk_job_errors_with_http_info(authorization, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method g_et_custom_object_bulk_job_errors" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `g_et_custom_object_bulk_job_errors`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `g_et_custom_object_bulk_job_errors`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CustomObjectBulkJobErrorResponseCollection',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def p_ost_custom_object_bulk_job(self, body, authorization, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_custom_object_bulk_job(body, authorization, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CustomObjectBulkJobRequest body: Custom Objects bulk job request (required)
        :param str authorization: `Bearer {token}` for a valid OAuth token.  (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param date zuora_version: API version that determines the response schema. The default version is used if this parameter is not included. Specify `Zuora-Version` in the request header if you expect a specific response schema.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_custom_object_bulk_job_with_http_info(body, authorization, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_custom_object_bulk_job_with_http_info(body, authorization, **kwargs)  # noqa: E501
            return data

    def p_ost_custom_object_bulk_job_with_http_info(self, body, authorization, **kwargs):  # noqa: E501
        """Submit a custom object bulk job  # noqa: E501

        Submits a bulk job request for a bulk operation on the specified custom object records. A succcessful call returns a newly created bulk job. The job ID can be used to poll the job status or upload the CSV file if it is a `create` job.  ## Limits This custom object bulk jobs have the following limits: * The concurrent bulk job limit per tenant is 5. Bulk jobs in `accepted`, `pending`, or `in_progress` status are counted towards the concurrent bulk job limit. * The bulk job execuation order is not guaranteed, which means the bulk job that you submit ealier may be executed later.   * Only the users that have the \"Delete Custom Objects\" permission can create a `delete` bulk job. Only the users that have the \"Edit Custom Objects\" permission can create a `create` bulk job. See [Platform Permissions](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/h_Platform_Roles#Platform_Permissions) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_custom_object_bulk_job_with_http_info(body, authorization, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'authorization', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_custom_object_bulk_job" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_custom_object_bulk_job`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `p_ost_custom_object_bulk_job`")  # noqa: E501
    ...
    def p_ost_upload_file_for_custom_object_bulk_job(self, body, authorization, content_type, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_upload_file_for_custom_object_bulk_job(body, authorization, content_type, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str body: (required)
        :param str authorization: `Bearer {token}` for a valid OAuth token.  (required)
        :param str content_type: The `Content-Type` of the request must be `text/csv`. (required)
        :param str id: The ID of the custom object bulk job that the file is uploaded to. (required)
        :param str zuora_track_id: A custom identifier for tracing the API call. If you set a value for this header, Zuora returns the same value in the response headers. This header enables you to associate your system process identifiers with Zuora API calls, to assist with troubleshooting in the event of an issue.  The value of this field must use the US-ASCII character set and must not include any of the following characters: colon (`:`), semicolon (`;`), double quote (`\"`), and quote (`'`). 
        :param str zuora_entity_ids: An entity ID. If you have [Zuora Multi-entity](https://knowledgecenter.zuora.com/BB_Introducing_Z_Business/Multi-entity) enabled and the OAuth token is valid for more than one entity, you must use this header to specify which entity to perform the operation in. If the OAuth token is only valid for a single entity, or you do not have Zuora Multi-entity enabled, you do not need to set this header. 
        :param date zuora_version: API version that determines the response schema. The default version is used if this parameter is not included. Specify `Zuora-Version` in the request header if you expect a specific response schema.
        :return: CustomObjectBulkJobResponse
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.p_ost_upload_file_for_custom_object_bulk_job_with_http_info(body, authorization, content_type, id, **kwargs)  # noqa: E501
        else:
            (data) = self.p_ost_upload_file_for_custom_object_bulk_job_with_http_info(body, authorization, content_type, id, **kwargs)  # noqa: E501
            return data

    def p_ost_upload_file_for_custom_object_bulk_job_with_http_info(self, body, authorization, content_type, id, **kwargs):  # noqa: E501
        """Upload a file for a custom object bulk job  # noqa: E501

        Uploads a file to a create custom object bulk job. Only one file is allowed per job. The job must be in `pending` status when you upload the file to it. The job will start creating records once the upload is finished.  Only the users that have the \"Edit Custom Objects\" permission can upload files to custom object bulk jobs. See [Platform Permissions](https://knowledgecenter.zuora.com/Billing/Tenant_Management/A_Administrator_Settings/User_Roles/h_Platform_Roles#Platform_Permissions) for more information.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.p_ost_upload_file_for_custom_object_bulk_job_with_http_info(body, authorization, content_type, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'authorization', 'content_type', 'id', 'zuora_track_id', 'zuora_entity_ids', 'zuora_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method p_ost_upload_file_for_custom_object_bulk_job" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `p_ost_upload_file_for_custom_object_bulk_job`")  # noqa: E501
        # verify the required parameter 'authorization' is set
        if ('authorization' not in params or
                params['authorization'] is None):
            raise ValueError("Missing the required parameter `authorization` when calling `p_ost_upload_file_for_custom_object_bulk_job`")  # noqa: E501
        # verify the required parameter 'content_type' is set
        if ('content_type' not in params or
                params['content_type'] is None):
            raise ValueError("Missing the required parameter `content_type` when calling `p_ost_upload_file_for_custom_object_bulk_job`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `p_ost_upload_file_for_custom_object_bulk_job`")  # noqa: E501
