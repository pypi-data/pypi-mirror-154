...
class CodeInjector:
    ...
    def evaluate(self, expression: str) -> Any:
        ...
        If expression not valid, return unique object to force application miscompare.

        """
        # pylint: disable=eval-used
        try:
            result = eval(expression, self.f_globals)
        except KeyboardInterrupt:  # pragma: no cover pylint: disable=try-except-raise
            raise
