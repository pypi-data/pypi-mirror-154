...
dist.Distribution().fetch_build_eggs(['cython>=0.x', 'numpy>=1.22.2', 'wheel'])
...
SOURCE_URL = 'https://github.com/aiacovella/matrixprofile.git'
...
setuptools.setup(
    name="peritus-test-matrixprofile",
    ...
    install_requires=['numpy>=1.22.2', matplot, 'protobuf>=3.11.2,<4.0.0', scipy],
