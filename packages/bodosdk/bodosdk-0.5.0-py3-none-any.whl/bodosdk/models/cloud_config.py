...
x = [{'cloudProvider': 'AWS', 'uuid': '9bed36ca-ce6f-4842-83b4-0a5b14689d0f', 'name': 'AWS', 'status': 'ACTIVE',
      'organizationUUID': '769a7a8b-06e0-4aba-8b29-fab0998f547e', 'id': 6,
      'awsProviderData': {'roleArn': 'arn:aws:iam::481633624848:role/BodoPlatformUser-9bed36ca-c',
                          'tfBucketName': 'bodo-bucket-9bed36ca-c', 'tfDynamoDbTableName': 'bodo-table-9bed36ca-c',
                          'tfBackendRegion': 'us-west-1', 'externalId': '4d1d9cd4-67d2-4a0d-9d06-72796e1ea10e',
                          'accountId': '481633624848'}},
     {'cloudProvider': 'AZURE', 'uuid': '6d74f513-e464-48d2-b2c0-0a180a9a9bb2', 'name': 'AZURE', 'status': 'ACTIVE',
      'organizationUUID': '769a7a8b-06e0-4aba-8b29-fab0998f547e', 'id': 93,
      'azureProviderData': {'resourceGroup': 'Bodo-Platform-Testing-InitAcc-RG',
