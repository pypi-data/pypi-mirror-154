...
setup(
  ...
  version = '0.1.13.1a',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WasinUddy/CorgiDB/archive/refs/tags/v0.1.13.1a-alpha.tar.gz',    # I explain this later on
