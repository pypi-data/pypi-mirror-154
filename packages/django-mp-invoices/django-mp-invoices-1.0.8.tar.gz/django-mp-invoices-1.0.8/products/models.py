...
from tecdoc.models import AdditionalCodesField
...
class Product(MultiCurrencyPrice, Stock, UnitType):
    ...
    tecdoc_description = models.TextField(
        max_length=10000, blank=True, editable=False)
