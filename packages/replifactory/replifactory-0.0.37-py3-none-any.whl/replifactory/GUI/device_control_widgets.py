...
class StirrerWidgets:
    def __init__(self, device):
        ...
        self.control_all = HBox([self.set_button, self.stop_all, self.low_all, self.high_all, self.max_all])
...
class PumpWidget:
    ...
    pump1level = widgets.IntProgress(2000, 0, 2000, 1)
    pump1level.orientation = "vertical"
    pump1level.style.bar_color = "#FFC938"
    pump1level.tooltip = "Fresh medium"
    pump1level.description = "Pump 1 stock"

    pump2level = widgets.IntProgress(2000, 0, 2000, 1)
    pump2level.orientation = "vertical"
    pump2level.style.bar_color = "#FFC938"
    pump2level.tooltip = "Fresh medium"
    pump2level.description = "Pump 1 stock"

    pump3level = widgets.IntProgress(0, 0, 5000, 1)
    pump3level.orientation = "vertical"
    pump3level.style.bar_color = "#FFC938"
    pump3level.tooltip = "Fresh medium"
    pump3level.description = "Pump 1 stock"
...
class TopWidget:
    def __init__(self, device, main_device_gui):
        ...
        self.temp = VBox([temp_button, self.temp_output], layout=Layout(height="80px"))
...
class DeviceControl:
    def __init__(self, device, main_gui):
        ...
        if self.device is None:
            ...
            self.box_concentrations = PumpConfigWidget(device, self.main_gui)
            self.box_pumps = PumpWidget(device, self.main_gui)
            ...
            self.widget = VBox([self.box_concentrations.widget,
