...
class Testing:
    ...
    def background_visual_test_pump(self, main_gui=None, pump_number=1):
        def queued_function():
            try:
                main_gui.calibration_tab.testing.pump_test_button.icon = "fa-spinner"
                main_gui.calibration_tab.testing.pump_test_button.disabled = True
                self.visual_test_pump(pump_number=pump_number)
            finally:
                main_gui.calibration_tab.testing.pump_test_button.icon = "fa-tint"
                main_gui.calibration_tab.testing.pump_test_button.disabled = False
