...
from replifactory.GUI.hardware_testing_widgets import HarwareTestGUI
...
class CalibrationTab:
    def __init__(self, main_gui):
        ...
        self.testing = HarwareTestGUI(self.main_gui)
        self.widget = VBox([self.testing.widget, HBox([self.dev_config_dir, self.load_calibration]), self.fit_functions, self.button, self.output])
        self.update()
