...
if TYPE_CHECKING:
    ...
    from nawah.classes import L10N, Attr, ClientApp, Job, Module, SysDoc, UserAttr
    from nawah.types import AnalyticsEvents, AppPackage, IPQuota, NawahDoc, NawahEnv
...
class ConfigAttrSys:
    ...
    sessions: MutableMapping[str, "NawahEnv"] = {}
    session_counter = 0
