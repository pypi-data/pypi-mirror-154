...
class FileStreamer(Streamer):
    ...
    def setFramerate(self, framerate: "int") -> "void":
        return _fast.FileStreamer_setFramerate(self, framerate)
...
class ImageFileStreamer(FileStreamer):
    ...
    @staticmethod
    def create(filenameFormat: "std::string", loop: "bool"=False, useTimestamps: "bool"=True, framerate: "int"=-1) -> "std::shared_ptr< fast::ImageFileStreamer >":
        r"""
        ...
        :return: instance
        """
        return _fast.ImageFileStreamer_create(filenameFormat, loop, useTimestamps, framerate)
...
def ImageFileStreamer_create(filenameFormat: "std::string", loop: "bool"=False, useTimestamps: "bool"=True, framerate: "int"=-1) -> "std::shared_ptr< fast::ImageFileStreamer >":
    r"""
    Create a ImageFileStreamer instance
...
class UFFStreamer(RandomAccessStreamer):
    ...
    @staticmethod
    def create(filename: "std::string", loop: "bool"=False, framerate: "uint"=30, gain: "float"=10, dynamicRange: "float"=60, scanConversionWidth: "int"=1024, scanConversionHeight: "int"=1024, doScanConversion: "bool"=True) -> "std::shared_ptr< fast::UFFStreamer >":
        r"""
        Create instance
        :type filename: string
        ...
        :return: instance
        """
        return _fast.UFFStreamer_create(filename, loop, framerate, gain, dynamicRange, scanConversionWidth, scanConversionHeight, doScanConversion)
...
def UFFStreamer_create(filename: "std::string", loop: "bool"=False, framerate: "uint"=30, gain: "float"=10, dynamicRange: "float"=60, scanConversionWidth: "int"=1024, scanConversionHeight: "int"=1024, doScanConversion: "bool"=True) -> "std::shared_ptr< fast::UFFStreamer >":
    r"""
    Create instance
    :type filename: string
    :param filename: UFF file to stream from
...
class InferenceEngine(Object):
    ...
    def getOutputNodes(self) -> "std::map< std::string,fast::InferenceEngine::NetworkNode,std::less< std::string >,std::allocator< std::pair< std::string const,fast::InferenceEngine::NetworkNode > > >":
        return _fast.InferenceEngine_getOutputNodes(self)

    def getInputNodes(self) -> "std::map< std::string,fast::InferenceEngine::NetworkNode,std::less< std::string >,std::allocator< std::pair< std::string const,fast::InferenceEngine::NetworkNode > > >":
...
class NeuralNetworkNode(object):
    r"""A struct representing a neural network input/output node"""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _fast.NeuralNetworkNode_swiginit(self, _fast.new_NeuralNetworkNode(*args))
...
class EnvelopeAndLogCompressor(ProcessObject):
    ...
    @staticmethod
    def create() -> "std::shared_ptr< fast::EnvelopeAndLogCompressor >":
        return _fast.EnvelopeAndLogCompressor_create()
...
def EnvelopeAndLogCompressor_create() -> "std::shared_ptr< fast::EnvelopeAndLogCompressor >":
    return _fast.EnvelopeAndLogCompressor_create()
...
class ScanConverter(ProcessObject):
    ...
    @staticmethod
    def create(width: "int"=1024, height: "int"=1024, gain: "float"=10.0, dynamicRange: "float"=60.0) -> "std::shared_ptr< fast::ScanConverter >":
        return _fast.ScanConverter_create(width, height, gain, dynamicRange)
...
def ScanConverter_create(width: "int"=1024, height: "int"=1024, gain: "float"=10.0, dynamicRange: "float"=60.0) -> "std::shared_ptr< fast::ScanConverter >":
    return _fast.ScanConverter_create(width, height, gain, dynamicRange)
...
class ImagePyramidAccess(object):
    ...
    def __init__(self, levels: "std::vector< fast::ImagePyramidLevel,std::allocator< fast::ImagePyramidLevel > >", fileHandle: "openslide_t *", tiffHandle: "TIFF *", stream: "std::ifstream *", vsiTiles: "std::vector< fast::vsi_tile_header,std::allocator< fast::vsi_tile_header > > &", imagePyramid: "std::shared_ptr< fast::ImagePyramid >", writeAccess: "bool", initializedPatchList: "std::unordered_set< std::string > &", readMutex: "std::mutex &"):
        _fast.ImagePyramidAccess_swiginit(self, _fast.new_ImagePyramidAccess(levels, fileHandle, tiffHandle, stream, vsiTiles, imagePyramid, writeAccess, initializedPatchList, readMutex))
