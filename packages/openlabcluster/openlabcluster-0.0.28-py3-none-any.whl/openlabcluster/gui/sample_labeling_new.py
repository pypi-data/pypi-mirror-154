...
class Sample_labeling(wx.lib.scrolledpanel.ScrolledPanel):
    ...
    def __init__(self, parent, gui_size, cfg, statusBar):
        ...
        self.sizer.Add(text,0, flag=wx.TOP | wx.LEFT | wx.BOTTOM, border=10)

        line1 = wx.StaticLine(self)
        self.sizer.Add(
            line1,0, flag=wx.EXPAND | wx.BOTTOM, border=10
        )
        ...
        self.gauge = wx.Gauge(self, wx.ID_ANY, self.config_file['su_epoch']) # width height
...
if __name__ == '__main__':
    class MainFrame(wx.Frame):
        def __init__(self):
            ...
            cfg = '/home/ws2/Documents/jingyuan/OpenLabCluster/openlabcluster/gui/asd-2022-05-10/config.yaml'
            if self.parent.GetPageCount() < 4:
                page5 = Sample_labeling(self.nb, None, cfg, self.statusBar)
