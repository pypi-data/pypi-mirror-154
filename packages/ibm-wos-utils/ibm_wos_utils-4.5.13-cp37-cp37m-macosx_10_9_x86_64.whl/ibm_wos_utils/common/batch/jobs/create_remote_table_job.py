...
class CreateRemoteTableJob(AIOSBaseJob):
                    ...
                    if auto_create:
                        if self.storage_type == StorageType.HIVE.value:
                            ...
                            if table_name in sql_context.tableNames(database_name):
                                msg = "Autocreate is set to True. However, \
                                    a table with the name {} already exists in the database {}.".format(
                        ...
                        self.validate_table(database_name, table_name, schema_name, table)
    ...
    def validate_table(self, database_name, table_name, schema_name, table):
