...
RiscvCPU = ['rv32emc', 'rv32ec', 'rv32i', 'rv32iac', 'rv32im', 'rv32imac', 'rv32imafc', 'rv64imac', 'rv64imacxcki', 'rv64imafdc', 'e902', 'e902m', 'e902t', 'e902mt', 'e906', 'e906f', 'e906fd', 'c906', 'c906fd', 'c906fdv', 'c906v', 'e907fp', 'e907fd', 'e907fdp', 'c910', 'c910v', 'c906d']
...
class Builder(object):
    ...
    def set_cpu(self, cpu):
        ...
        if self.CPU in CkcoreCPU:
            ...
            if self.CPU == 'e907fp':
                set_rv_cpu_flag(flags, 'rv32imafcpzpsfoperand_xtheade', 'ilp32f', 'medlow', 'e907')
            if self.CPU == 'e907fd':
                set_rv_cpu_flag(flags, 'rv32imafdcxtheade', 'ilp32d', 'medlow', 'e907')
            if self.CPU == 'e907fdp':
                set_rv_cpu_flag(flags, 'rv32imafdcpzpsfoperand_xtheade', 'ilp32d', 'medlow', 'e907')
            if self.CPU == 'c910':
    ...
    def build_component(self, component):
        ...
        def run_postbuild_script(target, source, env):
            run_external_script(component.build_config.postbuild_script)
