...
if __name__ == '__main__':
    key = '122D9FC926BF4996'
    cbc_iv = '91BB2E92B13D4398'

    # 加密

    plain_data = 'person_code=123456&price=100'

    assert 'KmZBtSaXV0GJjVlNH08c3DtrMUhzF8ubpuZHMQ9KXI4=' == encrypt_cbc(plain_data, key, cbc_iv)

    plain_data = '{"code": 0, "data": {"money": 8200, "card_no": "666666", "person_code": "666666"}}'

    assert 'KTNaPPphoH3f4RAMzj7UWTMIEhnG/l9Wjlz7xZGLex1Ol6XZzWsQfecYrfWIaGlanyG5lyyLz/tre+MS54kg9TMD4hKvyiorLp7La/XyozZUWspgw9KT8Sf9e8p0t/cj' == encrypt_cbc(plain_data, key, cbc_iv)

    # 解密
    cipher_data = 'KTNaPPphoH3f4RAMzj7UWRPiHHU3yGjXc3zClONiwxjuPMfvWJRnC7g9BSX91UvWZojgJN2e3fPUBUxanBfasdQ2RO+jvcLH2iLF65tGLgCgsPIxR9MMiixMTnsDFbh5d+dujhGjqPrWcc6JKzfJZg=='
    print(decrypt_cbc(cipher_data, key, cbc_iv))

    cipher_data = 'KTNaPPphoH3f4RAMzj7UWTMIEhnG/l9Wjlz7xZGLex1Ol6XZzWsQfecYrfWIaGlapDxzPZJw9f0gw9PzBjFyaRM+uPmqF3EvD1EYUfXiVE2YqK2LQPkscEsXqBCAmE+0'

    assert '{"code": 0, "data": {"money": 8200, "card_no": "会员卡号", "person_code": "123456"}}' == decrypt_cbc(cipher_data, key, cbc_iv)

    # 加密等于解密

    assert plain_data == decrypt_cbc(encrypt_cbc(plain_data, key, cbc_iv), key, cbc_iv)
