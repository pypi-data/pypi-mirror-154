...
class LoggedData(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_time",b"created_time","data",b"data","epoched_data",b"epoched_data","text",b"text","type",b"type","unique_tag",b"unique_tag","updated_time",b"updated_time","url",b"url"]) -> None: ...
