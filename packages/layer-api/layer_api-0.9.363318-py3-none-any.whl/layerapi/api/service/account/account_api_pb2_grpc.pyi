...
class AccountAPIStub:
    ...
    FillInAccountData: grpc.UnaryUnaryMultiCallable[
        api.service.account.account_api_pb2.FillInAccountDataRequest,
        api.service.account.account_api_pb2.FillInAccountDataResponse]
...
class AccountAPIServicer(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def FillInAccountData(self,
        request: api.service.account.account_api_pb2.FillInAccountDataRequest,
        context: grpc.ServicerContext,
    ) -> api.service.account.account_api_pb2.FillInAccountDataResponse: ...
