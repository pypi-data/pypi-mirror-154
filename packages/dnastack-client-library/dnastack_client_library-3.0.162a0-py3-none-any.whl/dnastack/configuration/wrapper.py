...
from dnastack.configuration.models import Configuration, ServiceEndpoint, Context, DEFAULT_CONTEXT
...
class ConfigurationWrapper:
    ...
    def __init__(self, configuration: Configuration, context_name: Optional[str] = None):
        self.__config = self.migrate(configuration)
    ...
    def migrate_endpoint(cls, endpoint: ServiceEndpoint) -> ServiceEndpoint:
        ...
        """
        if endpoint.model_version is None or endpoint.model_version == 1.0:
