...
from dnastack.cli.utils import command, echo_header, ArgumentSpec
...
from dnastack.configuration.models import OAuth2Authentication, ServiceEndpoint, Context
...
class EndpointCommandHandler:
    ...
    def set_endpoint_property(self, id: str, config_property: str, config_value: Optional[str]):
        ...
        # Migrate to the newer data structure on the fly.
        ConfigurationWrapper.migrate_endpoint(endpoint)
