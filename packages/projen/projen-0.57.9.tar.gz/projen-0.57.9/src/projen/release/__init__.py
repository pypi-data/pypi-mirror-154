...
class GoPublishOptions(CommonPublishOptions):
    def __init__(
        ...
        *,
        ...
        :param github_deploy_key_secret: (deprecated) The name of the secret that includes a GitHub deploy key used to push to the GitHub repository. Ignored if ``githubUseSsh`` is ``false``. Default: "GO_GITHUB_DEPLOY_KEY"
        :param github_repo: (deprecated) GitHub repository to push to. Default: - derived from ``moduleName``
        :param github_token_secret: (deprecated) The name of the secret that includes a personal GitHub access token used to push to the GitHub repository. Ignored if ``githubUseSsh`` is ``true``. Default: "GO_GITHUB_TOKEN"
        :param github_use_ssh: (deprecated) Use SSH to push to GitHub instead of a personal accses token. Default: false
    ...
    def github_deploy_key_secret(self) -> typing.Optional[builtins.str]:
        '''(deprecated) The name of the secret that includes a GitHub deploy key used to push to the GitHub repository.
    ...
    def github_use_ssh(self) -> typing.Optional[builtins.bool]:
        '''(deprecated) Use SSH to push to GitHub instead of a personal accses token.
