...
class ModelZooResponseMetadata(object):
    ...
    def __init__(self, update_time=None, creation_time=None, model_id=None, name=None, benchmark=None, primary_hardware=None, primary_batch_size=1, accuracy_metrics=[], dl_task=None, quantization_level=None, architecture_family=None, model_size=0, optimization_state=None, version=None, optimization_start_date=None, benchmark_start_date=None, owner=None, local_vars_configuration=None):  # noqa: E501
