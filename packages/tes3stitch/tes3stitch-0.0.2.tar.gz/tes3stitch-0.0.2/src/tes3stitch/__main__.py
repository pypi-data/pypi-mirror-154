...
Created by Kaarel Mänd for Tamriel Rebuilt. Inspired by the prior work of Seneca37,
Atrayonis and mort.
"""
...
the `CreateMaps <plugin>.esm` console command. Requires Pillow library for Python 3.",
        epilog="Created by Kaarel Mänd for Tamriel Rebuilt. Inspired by the prior \
