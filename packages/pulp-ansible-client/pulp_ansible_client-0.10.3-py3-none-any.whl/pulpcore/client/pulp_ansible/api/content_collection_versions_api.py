...
class ContentCollectionVersionsApi(object):
    ...
    def create(self, name, namespace, version, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create(name, namespace, version, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str name: The name of the collection. (required)
        :param str namespace: The namespace of the collection. (required)
        :param str version: The version of the collection. (required)
        ...
        return self.create_with_http_info(name, namespace, version, **kwargs)  # noqa: E501

    def create_with_http_info(self, name, namespace, version, **kwargs):  # noqa: E501
        """Create a collection version  # noqa: E501

        Trigger an asynchronous task to create content,optionally create new repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(name, namespace, version, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('namespace' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `namespace` when calling `create`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('namespace' in local_var_params and  # noqa: E501
                                                        len(local_var_params['namespace']) > 64):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `namespace` when calling `create`, length must be less than or equal to `64`")  # noqa: E501
        if self.api_client.client_side_validation and ('version' in local_var_params and  # noqa: E501
                                                        len(local_var_params['version']) > 128):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `version` when calling `create`, length must be less than or equal to `128`")  # noqa: E501
        collection_formats = {}
        ...
        if 'namespace' in local_var_params:
            form_params.append(('namespace', local_var_params['namespace']))  # noqa: E501
