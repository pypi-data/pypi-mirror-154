...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, sock_connect_timeout=None, client_cert=None, rate_limit=None, url=None, proxy_url=None, connect_timeout=None, total_timeout=None, pulp_last_updated=None, max_retries=None, ca_cert=None, pulp_labels=None, sock_read_timeout=None, pulp_href=None, pulp_created=None, download_concurrency=None, headers=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
