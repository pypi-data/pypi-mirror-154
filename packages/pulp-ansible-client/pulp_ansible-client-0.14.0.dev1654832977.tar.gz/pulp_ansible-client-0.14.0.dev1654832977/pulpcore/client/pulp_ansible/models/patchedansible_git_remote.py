...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, name=None, sock_connect_timeout=None, client_cert=None, rate_limit=None, url=None, client_key=None, proxy_url=None, connect_timeout=None, total_timeout=None, max_retries=None, ca_cert=None, pulp_labels=None, proxy_password=None, sock_read_timeout=None, password=None, username=None, download_concurrency=None, proxy_username=None, headers=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
