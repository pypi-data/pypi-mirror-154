...
from client.model.user_detail_dto import UserDetailDto
...
class UserControllerApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.change_password_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/user/{id}/_changePassword',
        ...
        self.reset_password_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/user/{id}/_resetpassword',
    ...
    def change_password(
        ...
        **kwargs
        ...
        >>> thread = api.change_password(id, user_detail_dto, async_req=True)
        >>> result = thread.get()

        Args:
            id (str):
            user_detail_dto (UserDetailDto):
    ...
    def create_user(
        ...
        **kwargs
        ...
        >>> thread = api.create_user(user_detail_dto, async_req=True)
        >>> result = thread.get()
    ...
    def update_customer(
        ...
        **kwargs
        ...
        >>> thread = api.update_customer(id, body, async_req=True)
        >>> result = thread.get()
    ...
    def update_user(
        ...
        **kwargs
        ...
        >>> thread = api.update_user(id, user_detail_dto, async_req=True)
        >>> result = thread.get()
