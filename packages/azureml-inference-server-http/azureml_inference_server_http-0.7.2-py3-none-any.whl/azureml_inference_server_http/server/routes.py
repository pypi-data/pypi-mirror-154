...
from input_parsers import BadInput, JsonStringInput, RawRequestInput, UnsupportedInput, UnsupportedHTTPMethod
...
def _init_headers() -> None:
    ...
    g.client_request_id = request.headers.get("x-client-request-id", "")
...
def handle_score():
    ...
    try:
        ...
        return AMLResponse(f"Scoring timeout after {ex.timeout_ms} ms", 500, json_str=False, run_function_failed=True)
