...
class AMLLogger:
    def __init__(self):
        ...
        # NOTE: This doesn't get the actual root logger. Instead, it creates a new logger called "root" in Python < 3.9.
        ...
        #   2) We will see duplicated logs in Python >= 3.9 because the root logger will end up with two StreamHandlers.
