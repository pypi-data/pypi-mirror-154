...
class KwParameter(Parameter):
    ...
    def __init__(self, name, default, annotation=Parameter.empty, _type='str', _optional=False, _description=None):
        super().__init__(name, Parameter.KEYWORD_ONLY, default=default, annotation=annotation)
        self._type = _type
        self._optional = _optional
        self._description = _description if _description else _type
