...
class mylog(object):
    ...
    def __init__(self, log_name='log', log_path=None, log_level=None,
        ...
        # 设置formatter
        format_str = 'time:%(asctime)s -log_name:%(name)s -level:%(levelname)-s -file_name:%(filename)-8s ' \
                     '-fun_name:%(funcName)s -chain:%(chain)s - %(lineno)d line -message: %(message)s'
        self.__formatter = logging.Formatter(format_str)
    ...
    def set_log_file_name(self):
        ...
        self.__info_log_name = os.path.join(path_dir, rq + '-' + str(logging.getLevelName(logging.INFO)) + '.log')
        self.__error_log_name = os.path.join(path_dir, rq + '-' + str(logging.getLevelName(logging.ERROR)) + '.log')
        self.__debug_log_name = os.path.join(path_dir, rq + '-' + str(logging.getLevelName(logging.DEBUG)) + '.log')
        self.__warn_log_name = os.path.join(path_dir, rq + '-' + str(logging.getLevelName(logging.WARNING)) + '.log')
    ...
    def set_file_handler(self):
        ...
        self.__info_file_handler.setLevel(logging.INFO)
        ...
        self.__debug_file_handler.setLevel(logging.DEBUG)
        ...
        self.__warn_file_handler.setLevel(logging.WARNING)
