...
class AutotuneExecutionPlanResultDefaultTypeInternal;
extern AutotuneExecutionPlanResultDefaultTypeInternal _AutotuneExecutionPlanResult_default_instance_;
class AutotuneExecutionPlanResult_ConvKey;
class AutotuneExecutionPlanResult_ConvKeyDefaultTypeInternal;
extern AutotuneExecutionPlanResult_ConvKeyDefaultTypeInternal _AutotuneExecutionPlanResult_ConvKey_default_instance_;
class AutotuneExecutionPlanResult_FailureResult;
class AutotuneExecutionPlanResult_FailureResultDefaultTypeInternal;
extern AutotuneExecutionPlanResult_FailureResultDefaultTypeInternal _AutotuneExecutionPlanResult_FailureResult_default_instance_;
...
class AutotuningExecutionPlanLog;
class AutotuningExecutionPlanLogDefaultTypeInternal;
extern AutotuningExecutionPlanLogDefaultTypeInternal _AutotuningExecutionPlanLog_default_instance_;
class AutotuningLog;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::tensorflow::AutotuneExecutionPlanResult* Arena::CreateMaybeMessage<::tensorflow::AutotuneExecutionPlanResult>(Arena*);
template<> ::tensorflow::AutotuneExecutionPlanResult_ConvKey* Arena::CreateMaybeMessage<::tensorflow::AutotuneExecutionPlanResult_ConvKey>(Arena*);
template<> ::tensorflow::AutotuneExecutionPlanResult_FailureResult* Arena::CreateMaybeMessage<::tensorflow::AutotuneExecutionPlanResult_FailureResult>(Arena*);
...
template<> ::tensorflow::AutotuningExecutionPlanLog* Arena::CreateMaybeMessage<::tensorflow::AutotuningExecutionPlanLog>(Arena*);
...
enum AutotuneExecutionPlanResult_FailureKind : int {
  AutotuneExecutionPlanResult_FailureKind_UNKNOWN = 0,
  AutotuneExecutionPlanResult_FailureKind_REDZONE_MODIFIED = 1,
  AutotuneExecutionPlanResult_FailureKind_WRONG_RESULT = 2,
  AutotuneExecutionPlanResult_FailureKind_AutotuneExecutionPlanResult_FailureKind_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  AutotuneExecutionPlanResult_FailureKind_AutotuneExecutionPlanResult_FailureKind_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool AutotuneExecutionPlanResult_FailureKind_IsValid(int value);
constexpr AutotuneExecutionPlanResult_FailureKind AutotuneExecutionPlanResult_FailureKind_FailureKind_MIN = AutotuneExecutionPlanResult_FailureKind_UNKNOWN;
constexpr AutotuneExecutionPlanResult_FailureKind AutotuneExecutionPlanResult_FailureKind_FailureKind_MAX = AutotuneExecutionPlanResult_FailureKind_WRONG_RESULT;
constexpr int AutotuneExecutionPlanResult_FailureKind_FailureKind_ARRAYSIZE = AutotuneExecutionPlanResult_FailureKind_FailureKind_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* AutotuneExecutionPlanResult_FailureKind_descriptor();
template<typename T>
inline const std::string& AutotuneExecutionPlanResult_FailureKind_Name(T enum_t_value) {
  static_assert(::std::is_same<T, AutotuneExecutionPlanResult_FailureKind>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function AutotuneExecutionPlanResult_FailureKind_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    AutotuneExecutionPlanResult_FailureKind_descriptor(), enum_t_value);
}
inline bool AutotuneExecutionPlanResult_FailureKind_Parse(
    const std::string& name, AutotuneExecutionPlanResult_FailureKind* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<AutotuneExecutionPlanResult_FailureKind>(
    AutotuneExecutionPlanResult_FailureKind_descriptor(), name, value);
}
// ===================================================================
...
class AutotuneExecutionPlanResult_FailureResult :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.AutotuneExecutionPlanResult.FailureResult) */ {
 public:
  AutotuneExecutionPlanResult_FailureResult();
  virtual ~AutotuneExecutionPlanResult_FailureResult();

  AutotuneExecutionPlanResult_FailureResult(const AutotuneExecutionPlanResult_FailureResult& from);
  AutotuneExecutionPlanResult_FailureResult(AutotuneExecutionPlanResult_FailureResult&& from) noexcept
    : AutotuneExecutionPlanResult_FailureResult() {
    *this = ::std::move(from);
  }

  inline AutotuneExecutionPlanResult_FailureResult& operator=(const AutotuneExecutionPlanResult_FailureResult& from) {
    CopyFrom(from);
    return *this;
  }
  inline AutotuneExecutionPlanResult_FailureResult& operator=(AutotuneExecutionPlanResult_FailureResult&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const AutotuneExecutionPlanResult_FailureResult& default_instance();
  ...
  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const AutotuneExecutionPlanResult_FailureResult* internal_default_instance() {
    return reinterpret_cast<const AutotuneExecutionPlanResult_FailureResult*>(
               &_AutotuneExecutionPlanResult_FailureResult_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(AutotuneExecutionPlanResult_FailureResult& a, AutotuneExecutionPlanResult_FailureResult& b) {
    a.Swap(&b);
  }
  inline void Swap(AutotuneExecutionPlanResult_FailureResult* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline AutotuneExecutionPlanResult_FailureResult* New() const final {
    return CreateMaybeMessage<AutotuneExecutionPlanResult_FailureResult>(nullptr);
  }

  AutotuneExecutionPlanResult_FailureResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AutotuneExecutionPlanResult_FailureResult>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AutotuneExecutionPlanResult_FailureResult& from);
  void MergeFrom(const AutotuneExecutionPlanResult_FailureResult& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AutotuneExecutionPlanResult_FailureResult* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.AutotuneExecutionPlanResult.FailureResult";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // .tensorflow.AutotuneExecutionPlanResult.FailureKind kind = 1;
  void clear_kind();
  ::tensorflow::AutotuneExecutionPlanResult_FailureKind kind() const;
  void set_kind(::tensorflow::AutotuneExecutionPlanResult_FailureKind value);
  ...
  // .tensorflow.AutotuneExecutionPlanResult.ConvKey reference_conv = 11;
  bool has_reference_conv() const;
  void clear_reference_conv();
  const ::tensorflow::AutotuneExecutionPlanResult_ConvKey& reference_conv() const;
  ::tensorflow::AutotuneExecutionPlanResult_ConvKey* release_reference_conv();
  ::tensorflow::AutotuneExecutionPlanResult_ConvKey* mutable_reference_conv();
  void set_allocated_reference_conv(::tensorflow::AutotuneExecutionPlanResult_ConvKey* reference_conv);

  void clear_key();
  KeyCase key_case() const;
  // @@protoc_insertion_point(class_scope:tensorflow.AutotuneExecutionPlanResult.FailureResult)
 private:
  class _Internal;
  void set_has_reference_conv();
  ...
  union KeyUnion {
    KeyUnion() {}
    ::tensorflow::AutotuneExecutionPlanResult_ConvKey* reference_conv_;
  } key_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class AutotuneExecutionPlanResult_ConvKey :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.AutotuneExecutionPlanResult.ConvKey) */ {
 public:
  AutotuneExecutionPlanResult_ConvKey();
  virtual ~AutotuneExecutionPlanResult_ConvKey();

  AutotuneExecutionPlanResult_ConvKey(const AutotuneExecutionPlanResult_ConvKey& from);
  AutotuneExecutionPlanResult_ConvKey(AutotuneExecutionPlanResult_ConvKey&& from) noexcept
    : AutotuneExecutionPlanResult_ConvKey() {
    *this = ::std::move(from);
  }

  inline AutotuneExecutionPlanResult_ConvKey& operator=(const AutotuneExecutionPlanResult_ConvKey& from) {
    CopyFrom(from);
    return *this;
  }
  inline AutotuneExecutionPlanResult_ConvKey& operator=(AutotuneExecutionPlanResult_ConvKey&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const AutotuneExecutionPlanResult_ConvKey& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const AutotuneExecutionPlanResult_ConvKey* internal_default_instance() {
    return reinterpret_cast<const AutotuneExecutionPlanResult_ConvKey*>(
               &_AutotuneExecutionPlanResult_ConvKey_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    7;

  friend void swap(AutotuneExecutionPlanResult_ConvKey& a, AutotuneExecutionPlanResult_ConvKey& b) {
    a.Swap(&b);
  }
  inline void Swap(AutotuneExecutionPlanResult_ConvKey* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline AutotuneExecutionPlanResult_ConvKey* New() const final {
    return CreateMaybeMessage<AutotuneExecutionPlanResult_ConvKey>(nullptr);
  }

  AutotuneExecutionPlanResult_ConvKey* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AutotuneExecutionPlanResult_ConvKey>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AutotuneExecutionPlanResult_ConvKey& from);
  void MergeFrom(const AutotuneExecutionPlanResult_ConvKey& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AutotuneExecutionPlanResult_ConvKey* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.AutotuneExecutionPlanResult.ConvKey";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:tensorflow.AutotuneExecutionPlanResult.ConvKey)
 private:
  class _Internal;
...
class AutotuneExecutionPlanResult :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.AutotuneExecutionPlanResult) */ {
 public:
  AutotuneExecutionPlanResult();
  virtual ~AutotuneExecutionPlanResult();

  AutotuneExecutionPlanResult(const AutotuneExecutionPlanResult& from);
  AutotuneExecutionPlanResult(AutotuneExecutionPlanResult&& from) noexcept
    : AutotuneExecutionPlanResult() {
    *this = ::std::move(from);
  }

  inline AutotuneExecutionPlanResult& operator=(const AutotuneExecutionPlanResult& from) {
    CopyFrom(from);
    return *this;
  }
  inline AutotuneExecutionPlanResult& operator=(AutotuneExecutionPlanResult&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const AutotuneExecutionPlanResult& default_instance();
  ...
  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const AutotuneExecutionPlanResult* internal_default_instance() {
    return reinterpret_cast<const AutotuneExecutionPlanResult*>(
               &_AutotuneExecutionPlanResult_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    8;

  friend void swap(AutotuneExecutionPlanResult& a, AutotuneExecutionPlanResult& b) {
    a.Swap(&b);
  }
  inline void Swap(AutotuneExecutionPlanResult* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline AutotuneExecutionPlanResult* New() const final {
    return CreateMaybeMessage<AutotuneExecutionPlanResult>(nullptr);
  }

  AutotuneExecutionPlanResult* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AutotuneExecutionPlanResult>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AutotuneExecutionPlanResult& from);
  void MergeFrom(const AutotuneExecutionPlanResult& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AutotuneExecutionPlanResult* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.AutotuneExecutionPlanResult";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  typedef AutotuneExecutionPlanResult_FailureResult FailureResult;
  typedef AutotuneExecutionPlanResult_ConvKey ConvKey;

  typedef AutotuneExecutionPlanResult_FailureKind FailureKind;
  static constexpr FailureKind UNKNOWN =
    AutotuneExecutionPlanResult_FailureKind_UNKNOWN;
  static constexpr FailureKind REDZONE_MODIFIED =
    AutotuneExecutionPlanResult_FailureKind_REDZONE_MODIFIED;
  static constexpr FailureKind WRONG_RESULT =
    AutotuneExecutionPlanResult_FailureKind_WRONG_RESULT;
  static inline bool FailureKind_IsValid(int value) {
    return AutotuneExecutionPlanResult_FailureKind_IsValid(value);
  }
  static constexpr FailureKind FailureKind_MIN =
    AutotuneExecutionPlanResult_FailureKind_FailureKind_MIN;
  static constexpr FailureKind FailureKind_MAX =
    AutotuneExecutionPlanResult_FailureKind_FailureKind_MAX;
  static constexpr int FailureKind_ARRAYSIZE =
    AutotuneExecutionPlanResult_FailureKind_FailureKind_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  FailureKind_descriptor() {
    return AutotuneExecutionPlanResult_FailureKind_descriptor();
  }
  template<typename T>
  static inline const std::string& FailureKind_Name(T enum_t_value) {
    static_assert(::std::is_same<T, FailureKind>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function FailureKind_Name.");
    return AutotuneExecutionPlanResult_FailureKind_Name(enum_t_value);
  }
  static inline bool FailureKind_Parse(const std::string& name,
      FailureKind* value) {
    return AutotuneExecutionPlanResult_FailureKind_Parse(name, value);
  }
  ...
  // .tensorflow.AutotuneExecutionPlanResult.FailureResult failure = 7;
  bool has_failure() const;
  void clear_failure();
  const ::tensorflow::AutotuneExecutionPlanResult_FailureResult& failure() const;
  ::tensorflow::AutotuneExecutionPlanResult_FailureResult* release_failure();
  ::tensorflow::AutotuneExecutionPlanResult_FailureResult* mutable_failure();
  void set_allocated_failure(::tensorflow::AutotuneExecutionPlanResult_FailureResult* failure);
  ...
  // .tensorflow.AutotuneExecutionPlanResult.ConvKey conv = 5;
  bool has_conv() const;
  void clear_conv();
  const ::tensorflow::AutotuneExecutionPlanResult_ConvKey& conv() const;
  ::tensorflow::AutotuneExecutionPlanResult_ConvKey* release_conv();
  ::tensorflow::AutotuneExecutionPlanResult_ConvKey* mutable_conv();
  void set_allocated_conv(::tensorflow::AutotuneExecutionPlanResult_ConvKey* conv);

  void clear_key();
  KeyCase key_case() const;
  // @@protoc_insertion_point(class_scope:tensorflow.AutotuneExecutionPlanResult)
 private:
  class _Internal;
  void set_has_conv();
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::tensorflow::AutotuneExecutionPlanResult_FailureResult* failure_;
  PROTOBUF_NAMESPACE_ID::Duration* run_time_;
  ::PROTOBUF_NAMESPACE_ID::int64 scratch_bytes_;
  union KeyUnion {
    KeyUnion() {}
    ::tensorflow::AutotuneExecutionPlanResult_ConvKey* conv_;
  } key_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::uint32 _oneof_case_[1];
...
class AutotuningExecutionPlanLog :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.AutotuningExecutionPlanLog) */ {
 public:
  AutotuningExecutionPlanLog();
  virtual ~AutotuningExecutionPlanLog();

  AutotuningExecutionPlanLog(const AutotuningExecutionPlanLog& from);
  AutotuningExecutionPlanLog(AutotuningExecutionPlanLog&& from) noexcept
    : AutotuningExecutionPlanLog() {
    *this = ::std::move(from);
  }

  inline AutotuningExecutionPlanLog& operator=(const AutotuningExecutionPlanLog& from) {
    CopyFrom(from);
    return *this;
  }
  inline AutotuningExecutionPlanLog& operator=(AutotuningExecutionPlanLog&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const AutotuningExecutionPlanLog& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const AutotuningExecutionPlanLog* internal_default_instance() {
    return reinterpret_cast<const AutotuningExecutionPlanLog*>(
               &_AutotuningExecutionPlanLog_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(AutotuningExecutionPlanLog& a, AutotuningExecutionPlanLog& b) {
    a.Swap(&b);
  }
  inline void Swap(AutotuningExecutionPlanLog* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline AutotuningExecutionPlanLog* New() const final {
    return CreateMaybeMessage<AutotuningExecutionPlanLog>(nullptr);
  }

  AutotuningExecutionPlanLog* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AutotuningExecutionPlanLog>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AutotuningExecutionPlanLog& from);
  void MergeFrom(const AutotuningExecutionPlanLog& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AutotuningExecutionPlanLog* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.AutotuningExecutionPlanLog";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // repeated .tensorflow.AutotuneExecutionPlanResult results = 2;
  int results_size() const;
  void clear_results();
  ::tensorflow::AutotuneExecutionPlanResult* mutable_results(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::AutotuneExecutionPlanResult >*
      mutable_results();
  const ::tensorflow::AutotuneExecutionPlanResult& results(int index) const;
  ::tensorflow::AutotuneExecutionPlanResult* add_results();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::AutotuneExecutionPlanResult >&
      results() const;
  ...
  // @@protoc_insertion_point(class_scope:tensorflow.AutotuningExecutionPlanLog)
 private:
  class _Internal;

  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::AutotuneExecutionPlanResult > results_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr device_pci_bus_id_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr blas_version_;
  PROTOBUF_NAMESPACE_ID::Any* instr_;
  ::tensorflow::CudnnVersion* cudnn_version_;
...
// .tensorflow.AutotuneExecutionPlanResult.FailureKind kind = 1;
inline void AutotuneExecutionPlanResult_FailureResult::clear_kind() {
  kind_ = 0;
}
inline ::tensorflow::AutotuneExecutionPlanResult_FailureKind AutotuneExecutionPlanResult_FailureResult::kind() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.FailureResult.kind)
  return static_cast< ::tensorflow::AutotuneExecutionPlanResult_FailureKind >(kind_);
}
inline void AutotuneExecutionPlanResult_FailureResult::set_kind(::tensorflow::AutotuneExecutionPlanResult_FailureKind value) {
  
  kind_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.AutotuneExecutionPlanResult.FailureResult.kind)
}

// string msg = 2;
inline void AutotuneExecutionPlanResult_FailureResult::clear_msg() {
  msg_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& AutotuneExecutionPlanResult_FailureResult::msg() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
  return msg_.GetNoArena();
}
inline void AutotuneExecutionPlanResult_FailureResult::set_msg(const std::string& value) {
  
  msg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
}
inline void AutotuneExecutionPlanResult_FailureResult::set_msg(std::string&& value) {
  
  msg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
}
inline void AutotuneExecutionPlanResult_FailureResult::set_msg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  msg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
}
inline void AutotuneExecutionPlanResult_FailureResult::set_msg(const char* value, size_t size) {
  
  msg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
}
inline std::string* AutotuneExecutionPlanResult_FailureResult::mutable_msg() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
  return msg_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* AutotuneExecutionPlanResult_FailureResult::release_msg() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
  
  return msg_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void AutotuneExecutionPlanResult_FailureResult::set_allocated_msg(std::string* msg) {
  if (msg != nullptr) {
  ...
  msg_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), msg);
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuneExecutionPlanResult.FailureResult.msg)
}

// .tensorflow.AutotuneExecutionPlanResult.ConvKey reference_conv = 11;
inline bool AutotuneExecutionPlanResult_FailureResult::has_reference_conv() const {
  return key_case() == kReferenceConv;
}
inline void AutotuneExecutionPlanResult_FailureResult::set_has_reference_conv() {
  _oneof_case_[0] = kReferenceConv;
}
inline void AutotuneExecutionPlanResult_FailureResult::clear_reference_conv() {
  if (has_reference_conv()) {
    delete key_.reference_conv_;
    clear_has_key();
  }
}
inline ::tensorflow::AutotuneExecutionPlanResult_ConvKey* AutotuneExecutionPlanResult_FailureResult::release_reference_conv() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuneExecutionPlanResult.FailureResult.reference_conv)
  if (has_reference_conv()) {
    clear_has_key();
      ::tensorflow::AutotuneExecutionPlanResult_ConvKey* temp = key_.reference_conv_;
    key_.reference_conv_ = nullptr;
    return temp;
  } else {
    return nullptr;
...
inline const ::tensorflow::AutotuneExecutionPlanResult_ConvKey& AutotuneExecutionPlanResult_FailureResult::reference_conv() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.FailureResult.reference_conv)
  return has_reference_conv()
      ? *key_.reference_conv_
      : *reinterpret_cast< ::tensorflow::AutotuneExecutionPlanResult_ConvKey*>(&::tensorflow::_AutotuneExecutionPlanResult_ConvKey_default_instance_);
}
inline ::tensorflow::AutotuneExecutionPlanResult_ConvKey* AutotuneExecutionPlanResult_FailureResult::mutable_reference_conv() {
  if (!has_reference_conv()) {
    clear_key();
    set_has_reference_conv();
    key_.reference_conv_ = CreateMaybeMessage< ::tensorflow::AutotuneExecutionPlanResult_ConvKey >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuneExecutionPlanResult.FailureResult.reference_conv)
  return key_.reference_conv_;
}

// int64 buffer_address = 13;
inline void AutotuneExecutionPlanResult_FailureResult::clear_buffer_address() {
  buffer_address_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AutotuneExecutionPlanResult_FailureResult::buffer_address() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.FailureResult.buffer_address)
  return buffer_address_;
}
inline void AutotuneExecutionPlanResult_FailureResult::set_buffer_address(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  buffer_address_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.AutotuneExecutionPlanResult.FailureResult.buffer_address)
}

inline bool AutotuneExecutionPlanResult_FailureResult::has_key() const {
  return key_case() != KEY_NOT_SET;
}
inline void AutotuneExecutionPlanResult_FailureResult::clear_has_key() {
  _oneof_case_[0] = KEY_NOT_SET;
}
inline AutotuneExecutionPlanResult_FailureResult::KeyCase AutotuneExecutionPlanResult_FailureResult::key_case() const {
  return AutotuneExecutionPlanResult_FailureResult::KeyCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// string exec_plan_id = 1;
inline void AutotuneExecutionPlanResult_ConvKey::clear_exec_plan_id() {
  exec_plan_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& AutotuneExecutionPlanResult_ConvKey::exec_plan_id() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
  return exec_plan_id_.GetNoArena();
}
inline void AutotuneExecutionPlanResult_ConvKey::set_exec_plan_id(const std::string& value) {
  
  exec_plan_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
}
inline void AutotuneExecutionPlanResult_ConvKey::set_exec_plan_id(std::string&& value) {
  
  exec_plan_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
}
inline void AutotuneExecutionPlanResult_ConvKey::set_exec_plan_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  exec_plan_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
}
inline void AutotuneExecutionPlanResult_ConvKey::set_exec_plan_id(const char* value, size_t size) {
  
  exec_plan_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
}
inline std::string* AutotuneExecutionPlanResult_ConvKey::mutable_exec_plan_id() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
  return exec_plan_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* AutotuneExecutionPlanResult_ConvKey::release_exec_plan_id() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
  
  return exec_plan_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void AutotuneExecutionPlanResult_ConvKey::set_allocated_exec_plan_id(std::string* exec_plan_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuneExecutionPlanResult.ConvKey.exec_plan_id)
}
...
// int64 scratch_bytes = 8;
inline void AutotuneExecutionPlanResult::clear_scratch_bytes() {
  scratch_bytes_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 AutotuneExecutionPlanResult::scratch_bytes() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.scratch_bytes)
  return scratch_bytes_;
}
inline void AutotuneExecutionPlanResult::set_scratch_bytes(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  scratch_bytes_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.AutotuneExecutionPlanResult.scratch_bytes)
}

// .google.protobuf.Duration run_time = 9;
inline bool AutotuneExecutionPlanResult::has_run_time() const {
  return this != internal_default_instance() && run_time_ != nullptr;
}
inline const PROTOBUF_NAMESPACE_ID::Duration& AutotuneExecutionPlanResult::run_time() const {
  const PROTOBUF_NAMESPACE_ID::Duration* p = run_time_;
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.run_time)
  return p != nullptr ? *p : *reinterpret_cast<const PROTOBUF_NAMESPACE_ID::Duration*>(
      &PROTOBUF_NAMESPACE_ID::_Duration_default_instance_);
}
inline PROTOBUF_NAMESPACE_ID::Duration* AutotuneExecutionPlanResult::release_run_time() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuneExecutionPlanResult.run_time)
  
  PROTOBUF_NAMESPACE_ID::Duration* temp = run_time_;
  run_time_ = nullptr;
  return temp;
}
inline PROTOBUF_NAMESPACE_ID::Duration* AutotuneExecutionPlanResult::mutable_run_time() {
  
  if (run_time_ == nullptr) {
    auto* p = CreateMaybeMessage<PROTOBUF_NAMESPACE_ID::Duration>(GetArenaNoVirtual());
    run_time_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuneExecutionPlanResult.run_time)
  return run_time_;
}
inline void AutotuneExecutionPlanResult::set_allocated_run_time(PROTOBUF_NAMESPACE_ID::Duration* run_time) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(run_time_);
  }
  ...
  run_time_ = run_time;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuneExecutionPlanResult.run_time)
}

// .tensorflow.AutotuneExecutionPlanResult.FailureResult failure = 7;
inline bool AutotuneExecutionPlanResult::has_failure() const {
  return this != internal_default_instance() && failure_ != nullptr;
}
inline void AutotuneExecutionPlanResult::clear_failure() {
  if (GetArenaNoVirtual() == nullptr && failure_ != nullptr) {
    delete failure_;
  }
  failure_ = nullptr;
}
inline const ::tensorflow::AutotuneExecutionPlanResult_FailureResult& AutotuneExecutionPlanResult::failure() const {
  const ::tensorflow::AutotuneExecutionPlanResult_FailureResult* p = failure_;
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.failure)
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::AutotuneExecutionPlanResult_FailureResult*>(
      &::tensorflow::_AutotuneExecutionPlanResult_FailureResult_default_instance_);
}
inline ::tensorflow::AutotuneExecutionPlanResult_FailureResult* AutotuneExecutionPlanResult::release_failure() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuneExecutionPlanResult.failure)
  
  ::tensorflow::AutotuneExecutionPlanResult_FailureResult* temp = failure_;
  failure_ = nullptr;
  return temp;
}
inline ::tensorflow::AutotuneExecutionPlanResult_FailureResult* AutotuneExecutionPlanResult::mutable_failure() {
  
  if (failure_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::AutotuneExecutionPlanResult_FailureResult>(GetArenaNoVirtual());
    failure_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuneExecutionPlanResult.failure)
  return failure_;
}
inline void AutotuneExecutionPlanResult::set_allocated_failure(::tensorflow::AutotuneExecutionPlanResult_FailureResult* failure) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete failure_;
  }
  ...
  failure_ = failure;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuneExecutionPlanResult.failure)
}

// .tensorflow.AutotuneExecutionPlanResult.ConvKey conv = 5;
inline bool AutotuneExecutionPlanResult::has_conv() const {
  return key_case() == kConv;
}
inline void AutotuneExecutionPlanResult::set_has_conv() {
  _oneof_case_[0] = kConv;
}
inline void AutotuneExecutionPlanResult::clear_conv() {
  if (has_conv()) {
    delete key_.conv_;
    clear_has_key();
  }
}
inline ::tensorflow::AutotuneExecutionPlanResult_ConvKey* AutotuneExecutionPlanResult::release_conv() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuneExecutionPlanResult.conv)
  if (has_conv()) {
    clear_has_key();
      ::tensorflow::AutotuneExecutionPlanResult_ConvKey* temp = key_.conv_;
    key_.conv_ = nullptr;
    return temp;
  } else {
    return nullptr;
...
inline const ::tensorflow::AutotuneExecutionPlanResult_ConvKey& AutotuneExecutionPlanResult::conv() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuneExecutionPlanResult.conv)
  return has_conv()
      ? *key_.conv_
      : *reinterpret_cast< ::tensorflow::AutotuneExecutionPlanResult_ConvKey*>(&::tensorflow::_AutotuneExecutionPlanResult_ConvKey_default_instance_);
}
inline ::tensorflow::AutotuneExecutionPlanResult_ConvKey* AutotuneExecutionPlanResult::mutable_conv() {
  if (!has_conv()) {
    clear_key();
    set_has_conv();
    key_.conv_ = CreateMaybeMessage< ::tensorflow::AutotuneExecutionPlanResult_ConvKey >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuneExecutionPlanResult.conv)
  return key_.conv_;
}

inline bool AutotuneExecutionPlanResult::has_key() const {
  return key_case() != KEY_NOT_SET;
}
inline void AutotuneExecutionPlanResult::clear_has_key() {
  _oneof_case_[0] = KEY_NOT_SET;
}
inline AutotuneExecutionPlanResult::KeyCase AutotuneExecutionPlanResult::key_case() const {
  return AutotuneExecutionPlanResult::KeyCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
// .google.protobuf.Any instr = 1;
inline bool AutotuningExecutionPlanLog::has_instr() const {
  return this != internal_default_instance() && instr_ != nullptr;
}
inline const PROTOBUF_NAMESPACE_ID::Any& AutotuningExecutionPlanLog::instr() const {
  const PROTOBUF_NAMESPACE_ID::Any* p = instr_;
  // @@protoc_insertion_point(field_get:tensorflow.AutotuningExecutionPlanLog.instr)
  return p != nullptr ? *p : *reinterpret_cast<const PROTOBUF_NAMESPACE_ID::Any*>(
      &PROTOBUF_NAMESPACE_ID::_Any_default_instance_);
}
inline PROTOBUF_NAMESPACE_ID::Any* AutotuningExecutionPlanLog::release_instr() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuningExecutionPlanLog.instr)
  
  PROTOBUF_NAMESPACE_ID::Any* temp = instr_;
  instr_ = nullptr;
  return temp;
}
inline PROTOBUF_NAMESPACE_ID::Any* AutotuningExecutionPlanLog::mutable_instr() {
  
  if (instr_ == nullptr) {
    auto* p = CreateMaybeMessage<PROTOBUF_NAMESPACE_ID::Any>(GetArenaNoVirtual());
    instr_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuningExecutionPlanLog.instr)
  return instr_;
}
inline void AutotuningExecutionPlanLog::set_allocated_instr(PROTOBUF_NAMESPACE_ID::Any* instr) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(instr_);
  }
  ...
  instr_ = instr;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuningExecutionPlanLog.instr)
}

// repeated .tensorflow.AutotuneExecutionPlanResult results = 2;
inline int AutotuningExecutionPlanLog::results_size() const {
  return results_.size();
}
inline void AutotuningExecutionPlanLog::clear_results() {
  results_.Clear();
}
inline ::tensorflow::AutotuneExecutionPlanResult* AutotuningExecutionPlanLog::mutable_results(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuningExecutionPlanLog.results)
  return results_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::AutotuneExecutionPlanResult >*
AutotuningExecutionPlanLog::mutable_results() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.AutotuningExecutionPlanLog.results)
  return &results_;
}
inline const ::tensorflow::AutotuneExecutionPlanResult& AutotuningExecutionPlanLog::results(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuningExecutionPlanLog.results)
  return results_.Get(index);
}
inline ::tensorflow::AutotuneExecutionPlanResult* AutotuningExecutionPlanLog::add_results() {
  // @@protoc_insertion_point(field_add:tensorflow.AutotuningExecutionPlanLog.results)
  return results_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::AutotuneExecutionPlanResult >&
AutotuningExecutionPlanLog::results() const {
  // @@protoc_insertion_point(field_list:tensorflow.AutotuningExecutionPlanLog.results)
  return results_;
}

// .tensorflow.CudnnVersion cudnn_version = 3;
inline bool AutotuningExecutionPlanLog::has_cudnn_version() const {
  return this != internal_default_instance() && cudnn_version_ != nullptr;
}
inline void AutotuningExecutionPlanLog::clear_cudnn_version() {
  if (GetArenaNoVirtual() == nullptr && cudnn_version_ != nullptr) {
    delete cudnn_version_;
  }
  cudnn_version_ = nullptr;
}
inline const ::tensorflow::CudnnVersion& AutotuningExecutionPlanLog::cudnn_version() const {
  const ::tensorflow::CudnnVersion* p = cudnn_version_;
  // @@protoc_insertion_point(field_get:tensorflow.AutotuningExecutionPlanLog.cudnn_version)
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::CudnnVersion*>(
      &::tensorflow::_CudnnVersion_default_instance_);
}
inline ::tensorflow::CudnnVersion* AutotuningExecutionPlanLog::release_cudnn_version() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuningExecutionPlanLog.cudnn_version)
  
  ::tensorflow::CudnnVersion* temp = cudnn_version_;
  cudnn_version_ = nullptr;
  return temp;
}
inline ::tensorflow::CudnnVersion* AutotuningExecutionPlanLog::mutable_cudnn_version() {
  
  if (cudnn_version_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::CudnnVersion>(GetArenaNoVirtual());
    cudnn_version_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuningExecutionPlanLog.cudnn_version)
  return cudnn_version_;
}
inline void AutotuningExecutionPlanLog::set_allocated_cudnn_version(::tensorflow::CudnnVersion* cudnn_version) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete cudnn_version_;
  }
  ...
  cudnn_version_ = cudnn_version;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuningExecutionPlanLog.cudnn_version)
}

// .tensorflow.ComputeCapability compute_capability = 4;
inline bool AutotuningExecutionPlanLog::has_compute_capability() const {
  return this != internal_default_instance() && compute_capability_ != nullptr;
}
inline void AutotuningExecutionPlanLog::clear_compute_capability() {
  if (GetArenaNoVirtual() == nullptr && compute_capability_ != nullptr) {
    delete compute_capability_;
  }
  compute_capability_ = nullptr;
}
inline const ::tensorflow::ComputeCapability& AutotuningExecutionPlanLog::compute_capability() const {
  const ::tensorflow::ComputeCapability* p = compute_capability_;
  // @@protoc_insertion_point(field_get:tensorflow.AutotuningExecutionPlanLog.compute_capability)
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::ComputeCapability*>(
      &::tensorflow::_ComputeCapability_default_instance_);
}
inline ::tensorflow::ComputeCapability* AutotuningExecutionPlanLog::release_compute_capability() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuningExecutionPlanLog.compute_capability)
  
  ::tensorflow::ComputeCapability* temp = compute_capability_;
  compute_capability_ = nullptr;
  return temp;
}
inline ::tensorflow::ComputeCapability* AutotuningExecutionPlanLog::mutable_compute_capability() {
  
  if (compute_capability_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::ComputeCapability>(GetArenaNoVirtual());
    compute_capability_ = p;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuningExecutionPlanLog.compute_capability)
  return compute_capability_;
}
inline void AutotuningExecutionPlanLog::set_allocated_compute_capability(::tensorflow::ComputeCapability* compute_capability) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete compute_capability_;
  }
  ...
  compute_capability_ = compute_capability;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuningExecutionPlanLog.compute_capability)
}

// string device_pci_bus_id = 5;
inline void AutotuningExecutionPlanLog::clear_device_pci_bus_id() {
  device_pci_bus_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& AutotuningExecutionPlanLog::device_pci_bus_id() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
  return device_pci_bus_id_.GetNoArena();
}
inline void AutotuningExecutionPlanLog::set_device_pci_bus_id(const std::string& value) {
  
  device_pci_bus_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
}
inline void AutotuningExecutionPlanLog::set_device_pci_bus_id(std::string&& value) {
  
  device_pci_bus_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
}
inline void AutotuningExecutionPlanLog::set_device_pci_bus_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  device_pci_bus_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
}
inline void AutotuningExecutionPlanLog::set_device_pci_bus_id(const char* value, size_t size) {
  
  device_pci_bus_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
}
inline std::string* AutotuningExecutionPlanLog::mutable_device_pci_bus_id() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
  return device_pci_bus_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* AutotuningExecutionPlanLog::release_device_pci_bus_id() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
  
  return device_pci_bus_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void AutotuningExecutionPlanLog::set_allocated_device_pci_bus_id(std::string* device_pci_bus_id) {
  if (device_pci_bus_id != nullptr) {
  ...
  device_pci_bus_id_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), device_pci_bus_id);
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuningExecutionPlanLog.device_pci_bus_id)
}

// string blas_version = 6;
inline void AutotuningExecutionPlanLog::clear_blas_version() {
  blas_version_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& AutotuningExecutionPlanLog::blas_version() const {
  // @@protoc_insertion_point(field_get:tensorflow.AutotuningExecutionPlanLog.blas_version)
  return blas_version_.GetNoArena();
}
inline void AutotuningExecutionPlanLog::set_blas_version(const std::string& value) {
  
  blas_version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:tensorflow.AutotuningExecutionPlanLog.blas_version)
}
inline void AutotuningExecutionPlanLog::set_blas_version(std::string&& value) {
  
  blas_version_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:tensorflow.AutotuningExecutionPlanLog.blas_version)
}
inline void AutotuningExecutionPlanLog::set_blas_version(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  blas_version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:tensorflow.AutotuningExecutionPlanLog.blas_version)
}
inline void AutotuningExecutionPlanLog::set_blas_version(const char* value, size_t size) {
  
  blas_version_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:tensorflow.AutotuningExecutionPlanLog.blas_version)
}
inline std::string* AutotuningExecutionPlanLog::mutable_blas_version() {
  
  // @@protoc_insertion_point(field_mutable:tensorflow.AutotuningExecutionPlanLog.blas_version)
  return blas_version_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* AutotuningExecutionPlanLog::release_blas_version() {
  // @@protoc_insertion_point(field_release:tensorflow.AutotuningExecutionPlanLog.blas_version)
  
  return blas_version_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void AutotuningExecutionPlanLog::set_allocated_blas_version(std::string* blas_version) {
  if (blas_version != nullptr) {
  ...
  blas_version_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), blas_version);
  // @@protoc_insertion_point(field_set_allocated:tensorflow.AutotuningExecutionPlanLog.blas_version)
}
...
template <> struct is_proto_enum< ::tensorflow::AutotuneExecutionPlanResult_FailureKind> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorflow::AutotuneExecutionPlanResult_FailureKind>() {
  return ::tensorflow::AutotuneExecutionPlanResult_FailureKind_descriptor();
}
