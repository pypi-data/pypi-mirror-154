...
class ExecutionPlanProto;
class ExecutionPlanProtoDefaultTypeInternal;
extern ExecutionPlanProtoDefaultTypeInternal _ExecutionPlanProto_default_instance_;
...
template<> ::stream_executor::dnn::ExecutionPlanProto* Arena::CreateMaybeMessage<::stream_executor::dnn::ExecutionPlanProto>(Arena*);
...
class ExecutionPlanProto :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:stream_executor.dnn.ExecutionPlanProto) */ {
 public:
  ExecutionPlanProto();
  virtual ~ExecutionPlanProto();

  ExecutionPlanProto(const ExecutionPlanProto& from);
  ExecutionPlanProto(ExecutionPlanProto&& from) noexcept
    : ExecutionPlanProto() {
    *this = ::std::move(from);
  }

  inline ExecutionPlanProto& operator=(const ExecutionPlanProto& from) {
    CopyFrom(from);
    return *this;
  }
  inline ExecutionPlanProto& operator=(ExecutionPlanProto&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ExecutionPlanProto& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ExecutionPlanProto* internal_default_instance() {
    return reinterpret_cast<const ExecutionPlanProto*>(
               &_ExecutionPlanProto_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(ExecutionPlanProto& a, ExecutionPlanProto& b) {
    a.Swap(&b);
  }
  inline void Swap(ExecutionPlanProto* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline ExecutionPlanProto* New() const final {
    return CreateMaybeMessage<ExecutionPlanProto>(nullptr);
  }

  ExecutionPlanProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ExecutionPlanProto>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ExecutionPlanProto& from);
  void MergeFrom(const ExecutionPlanProto& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ExecutionPlanProto* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "stream_executor.dnn.ExecutionPlanProto";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:stream_executor.dnn.ExecutionPlanProto)
 private:
  class _Internal;
...
// string exec_plan_id = 1;
inline void ExecutionPlanProto::clear_exec_plan_id() {
  exec_plan_id_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& ExecutionPlanProto::exec_plan_id() const {
  // @@protoc_insertion_point(field_get:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
  return exec_plan_id_.GetNoArena();
}
inline void ExecutionPlanProto::set_exec_plan_id(const std::string& value) {
  
  exec_plan_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
}
inline void ExecutionPlanProto::set_exec_plan_id(std::string&& value) {
  
  exec_plan_id_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
}
inline void ExecutionPlanProto::set_exec_plan_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  exec_plan_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
}
inline void ExecutionPlanProto::set_exec_plan_id(const char* value, size_t size) {
  
  exec_plan_id_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
}
inline std::string* ExecutionPlanProto::mutable_exec_plan_id() {
  
  // @@protoc_insertion_point(field_mutable:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
  return exec_plan_id_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* ExecutionPlanProto::release_exec_plan_id() {
  // @@protoc_insertion_point(field_release:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
  
  return exec_plan_id_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void ExecutionPlanProto::set_allocated_exec_plan_id(std::string* exec_plan_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:stream_executor.dnn.ExecutionPlanProto.exec_plan_id)
}
