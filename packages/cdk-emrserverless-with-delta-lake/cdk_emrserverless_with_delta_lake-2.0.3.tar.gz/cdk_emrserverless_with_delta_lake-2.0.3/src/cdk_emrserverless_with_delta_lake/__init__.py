...
class EmrStudioTaggingExpert(
    ...
    def function_entity(self) -> aws_cdk.aws_lambda.Function:
        ...
        return typing.cast(aws_cdk.aws_lambda.Function, jsii.get(self, "functionEntity"))
