...
class EmrServerless(
    ...
    def __init__(
        ...
        *,
        ...
        service_catalog_props: typing.Optional["EmrStudioDeveloperStackProps"] = None,
    ) -> None:
        '''
        :param scope: -
        :param name: -
        ...
        props = EmrServerlessProps(
            subnet_ids=subnet_ids, service_catalog_props=service_catalog_props
        )
...
class EmrStudioDeveloperStack(
    ...
    def __init__(
        ...
        name: builtins.str,
        *,
        group: typing.Optional[aws_cdk.aws_iam.IGroup] = None,
...
class EmrStudioDeveloperStackProps:
    ...
    @builtins.property
    def group(self) -> typing.Optional[aws_cdk.aws_iam.IGroup]:
        '''an IAM group you wish to associate with the Portfolio for EMR cluster template.'''
        result = self._values.get("group")
        return typing.cast(typing.Optional[aws_cdk.aws_iam.IGroup], result)
