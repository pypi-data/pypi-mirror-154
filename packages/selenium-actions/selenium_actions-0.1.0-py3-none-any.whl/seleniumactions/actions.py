...
class Actions:
    ...
    @time_it
    def click(self, locator_tuple: tuple, timeout: int = None, sleep_after: bool = True) -> None:
        """
        ...
        Examples:
          ...
          actions.click(home_button, timeout=20)  # custom timeout finding el to click
          actions.click(home_button, sleep_after=False)  # no delay after clicking
        """
        logger.info(f'click {locator_tuple}')
        self.finder.find_element(locator_tuple, timeout).click()
        if sleep_after: self.sleep()

    @time_it
    def type_text(self, locator_tuple: tuple, text: str, timeout: int = None,
        ...
        Examples:
          ...
          actions.type_text(email_input, text="jimmy@choo.io", timeout=20)  # custom timeout finding el to click
        ...
        self.finder.find_element(locator_tuple, timeout).send_keys(text)
        if sleep_after: self.sleep()

    @time_it
    def clear(self, locator_tuple: tuple, timeout: int = None, sleep_after: bool = True) -> None:
        """
        ...
        Examples:
          ...
          actions.clear(email_input, timeout=20)  # custom timeout finding el to click
          actions.clear(email_input, sleep_after=False)  # no delay after clicking
        """
        logger.info(f'clear field {locator_tuple}')
        self.finder.find_element(locator_tuple, timeout).clear()
        if sleep_after: self.sleep()

    @time_it
    def submit(self, locator_tuple: tuple = None, timeout: int = None, sleep_after: bool = True) -> None:
        """
        Submit form.
        ...
        Examples:
          ...
          actions.submit(account_form, timeout=20)  # custom timeout finding el to click
        ...
        self.finder.find_element(lt, timeout).submit()
        if sleep_after: self.sleep()
    ...
    @time_it
    def get_attribute(self, locator_tuple: tuple, attr: str, timeout: int = None) -> str:
        logger.info(f'get attribute {locator_tuple} [{attr}]')
        return self.finder.find_element(locator_tuple, timeout)\
            .get_attribute(attr)

    @time_it
    def get_text(self, locator_tuple: tuple, timeout: int = None) -> str:
        return self.get_attribute(locator_tuple, 'innerText', timeout)
    ...
    @time_it
    def hover(self, locator_tuple: tuple, timeout: int = None, sleep_after: bool = True) -> None:
        logger.info(f'hover element {locator_tuple}')
        element = self.finder.find_element(locator_tuple, timeout)
