...
class Manager(object):
    ...
    def createTable(self, table, column_name, column_type,
        primary_key_name=None, schema=None, if_exists='skip', commit=True):
        ...
        if primary_key_name:
            sql_cmd = 'CREATE TABLE {s}.{t} ({cd}, PRIMARY KEY({pk}))'
        else:
            sql_cmd = 'CREATE TABLE {s}.{t} ({cd})'
