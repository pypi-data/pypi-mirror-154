...
class LzyEnv(gym.Env):
    ...
    def _get_obs(self):
        return {"pos":np.array([self._get_pos()]),
                "pred":np.array(self._get_pred()),
                "normal":np.array(self._get_normal())}
    ...
    def _get_pos(self):
        return np.array(torch.tensor([self._position]))
    ...
    def step(self, action):
        ...
        self._pr = np.array(self._get_pred())
        self._normal = np.array(self._get_normal())
        self._price = np.array(self._get_price())
