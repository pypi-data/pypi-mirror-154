...
class Simulation(metaclass=IterSimulation):
    ...
    def current_setpoints(self):
        ...
        if self.setpoints.WOBAutoDriller is not None:
            toSet["WOBAutoDriller"] = self.setpoints.WOBAutoDriller
        if self.setpoints.DesiredWOB is not None:
            toSet["DesiredWOB"] = self.setpoints.DesiredWOB
        if self.setpoints.WOBProportionalGain is not None:
            toSet["WOBProportionalGain"] = self.setpoints.WOBProportionalGain
        if self.setpoints.WOBIntegralGain is not None:
            toSet["WOBIntegralGain"] = self.setpoints.WOBIntegralGain    
