...
class MysqlPool(BaseConnectionPool):
    ...
    def sync_create_pool(self):
        pool = PersistentDB(creator=pymysql, ping=2, closeable=True, maxusage=self.conn_info.max_size,
                            ...
                            minsize=self.conn_info.min_size, maxsize=self.conn_info.max_size,
                            autocommit=True)
        return pool
