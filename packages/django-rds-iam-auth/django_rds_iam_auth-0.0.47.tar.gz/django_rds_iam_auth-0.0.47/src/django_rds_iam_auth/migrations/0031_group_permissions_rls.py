...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL("""alter function privileged_get_user_permissions(text) owner to postgres;"""),
        ...
        migrations.RunSQL("""alter function is_group_default(integer) owner to postgres;"""),
