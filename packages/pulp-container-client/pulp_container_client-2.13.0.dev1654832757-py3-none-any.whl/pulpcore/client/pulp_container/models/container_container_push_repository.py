...
class ContainerContainerPushRepository(object):
    ...
    def __init__(self, name=None, retain_repo_versions=None, pulp_labels=None, description=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
