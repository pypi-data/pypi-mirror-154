...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, pulp_href=None, retain_repo_versions=None, pulp_labels=None, latest_version_href=None, description=None, manifest_signing_service=None, pulp_created=None, versions_href=None, local_vars_configuration=None):  # noqa: E501
