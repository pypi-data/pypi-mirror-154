...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, manifest_signing_service=None, retain_repo_versions=None, versions_href=None, pulp_created=None, name=None, pulp_labels=None, pulp_href=None, description=None, local_vars_configuration=None):  # noqa: E501
