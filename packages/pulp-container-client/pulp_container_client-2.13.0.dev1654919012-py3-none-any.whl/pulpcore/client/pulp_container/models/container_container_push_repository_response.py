...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, pulp_href=None, pulp_labels=None, pulp_created=None, manifest_signing_service=None, retain_repo_versions=None, versions_href=None, latest_version_href=None, description=None, local_vars_configuration=None):  # noqa: E501
