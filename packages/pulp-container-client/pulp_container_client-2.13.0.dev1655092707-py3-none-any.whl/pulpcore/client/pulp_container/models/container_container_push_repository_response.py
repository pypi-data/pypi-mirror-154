...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, latest_version_href=None, retain_repo_versions=None, pulp_created=None, pulp_href=None, pulp_labels=None, versions_href=None, manifest_signing_service=None, description=None, name=None, local_vars_configuration=None):  # noqa: E501
