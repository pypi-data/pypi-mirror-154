...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, pulp_labels=None, pulp_href=None, versions_href=None, name=None, pulp_created=None, description=None, manifest_signing_service=None, retain_repo_versions=None, latest_version_href=None, local_vars_configuration=None):  # noqa: E501
