...
setup(
    ...
    install_requires=[
        ...
        'scikit-learn', 'ipywidgets', 'stumpy', 'matrixprofile'
    ],
    dependency_links=[
        'git+https://github.com/mitchellpkt/matrixprofile.git@1eff5249a23d66ea7e0555ff053db56bbb998808#egg=matrixprofile'
    ],
    extras_require={
        # eg:
        #   'rst': ['docutils>=0.11'],
