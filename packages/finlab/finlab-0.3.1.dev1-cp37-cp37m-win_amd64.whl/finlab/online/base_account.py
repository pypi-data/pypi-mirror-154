...
class Stock():
  ...
  def from_fugle(cls, json_response):
    ...
    return cls(
      ...
      bid_price=r['data']['quote']['order']['bids'][0]['price'],
      ask_price=r['data']['quote']['order']['asks'][0]['price'],
      bid_volume=r['data']['quote']['order']['bids'][0]['volume'],
      ask_volume=r['data']['quote']['order']['asks'][0]['volume'],
    )
