...
class PeriodParameters(TypedDict, total=False):
    ...
    """
    Get data from filings published by Calcbench on this date
    """
    allHistory: bool
    filingID: Optional[int]
    """
    Get data from this filing.
    """
    accessionID: Optional[int]
    """
    Get data from this accession. Where possible use filingID
    """
    useFiscalPeriod: Optional[bool]
    endYear: Optional[int]
    """
    Last year for which to get data
    """
    endPeriod: Optional[PeriodArgument]
    """
    Last period for which to get data
    """
