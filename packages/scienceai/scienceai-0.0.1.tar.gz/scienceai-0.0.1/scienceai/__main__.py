...
from scienceai.version import __version__
...
__git__ = '👍    https://github.com/daiyizheng/scienceai'
...
def arg_parse():
    ...
    :return:
    """
    parser = argparse.ArgumentParser(prog="scienceai")
