...
try:
    from lauetoolsnn.NNmodels import read_hdf5, model_arch_general, LoggingCallback, predict_DNN    
except:
    from NNmodels import read_hdf5, model_arch_general, LoggingCallback, predict_DNN
...
class AnotherWindowLivePrediction(QWidget):#QWidget QScrollArea
    ...
    def reinitialize(self):
        ...
        if tail.split(".")[-1] == "tif":
            ...
            print("Add the extension in Line 3893 of lauetoolsneuralnetwork.py file (reinitialize function)")
            return
