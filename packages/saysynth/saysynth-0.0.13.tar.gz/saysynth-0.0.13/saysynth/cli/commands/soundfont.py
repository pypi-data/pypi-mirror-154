...
from saysynth.cli.options import group_options, velocity_opts, phoneme_opts, segment_opts, voice_opt, rate_opt, duration_opts
...
@group_options(voice_opt, rate_opt)
@click.option(
    "-o",
    "--output-dir",
    default="./",
