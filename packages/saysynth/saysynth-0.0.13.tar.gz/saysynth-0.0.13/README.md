...
## todo
- [x] refactor to class-based model: Phoneme, Note, Part
- [ ] sequence command via yaml configuration
- [ ] multitrack midifile execution (similar to chord)
- [ ] custom note list for a chord
- [ ] arpeggiation via `midi-utils` ?
- [ ] controls for intra-phoneme pitch modulation ?
- [ ] glide or portamento?
- [ ] more unit tests
- [ ] what to log?
