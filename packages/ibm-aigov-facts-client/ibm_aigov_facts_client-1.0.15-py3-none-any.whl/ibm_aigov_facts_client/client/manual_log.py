...
class ManualLog:
    ...
    def log_metric(self, key: str, value: float, step: Optional[int] = None) -> None:
        ...
        try:
            ...
            return ("logged metric {} successfully under run {}".format(key,self.run_id))
        except:
    ...
    def log_metrics(self, metrics: Dict[str, float], step: Optional[int] = None) -> None:
        ...
        try:
            ...
            return ("logged metrics {} successfully under run {}".format(metrics.keys(),self.run_id))
        except:
    ...
    def log_param(self, key: str, value: Any) -> None:
        ...
        try:
            ...
            return ("logged param {} successfully under run {}".format(key,self.run_id))
        except:
    ...
    def log_params(self, params: Dict[str, Any]) -> None:
        ...
        try:
            ...
            return ("logged params {} successfully under run {}".format(params.keys(),self.run_id))
        except:
    ...
    def set_tag(self, key: str, value: Any) -> None:
        ...
        try:
            ...
            return ("logged tag {} successfully under run {}".format(key,self.run_id))
        except:
    ...
    def set_tags(self, tags: Dict[str, Any]) -> None:
        ...
        try:
            log_tags_data(tags)
            return ("logged tags {} successfully under run {}".format(tags.keys(),self.run_id))
        except:
