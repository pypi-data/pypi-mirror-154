...
class DynamicSpell:
    ...
    def initialize_driver(self):
        ...
        if self.driver_path == None:
            ...
            # Set options for undetected Chrome
            elif self.browser == 'undetected_chrome':
    ...
    def selectAll(self, css_selector):
        return DynamicRuneArr([*[DynamicRune(i, self.driver)for i in self.driver.find_elements_by_css_selector(css_selector)]])
