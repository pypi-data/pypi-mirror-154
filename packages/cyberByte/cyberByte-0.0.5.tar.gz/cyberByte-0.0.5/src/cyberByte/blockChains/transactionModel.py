...
class Transaction:
    ...
    def __init__(self, tx_to_address: str, tx_from_address: str, amount: float, fee: float, from_public_key: str,
    ...
    def _get_hash(self) -> str:
        ...
        """
        output = {**self.__dict__}
        for i in ['transaction_hash', '_signature']:
            try:
                del output[i]
    ...
    def is_verified(self) -> bool:
        ...
        if self.transaction_hash != self._get_hash():
            return False
        return True
