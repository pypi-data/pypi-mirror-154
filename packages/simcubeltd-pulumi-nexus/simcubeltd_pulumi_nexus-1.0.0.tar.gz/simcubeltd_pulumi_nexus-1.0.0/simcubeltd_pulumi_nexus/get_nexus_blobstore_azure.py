...
__all__ = [
    'GetNexusBlobstoreAzureResult',
    'AwaitableGetNexusBlobstoreAzureResult',
    'get_nexus_blobstore_azure',
    'get_nexus_blobstore_azure_output',
]

@pulumi.output_type
class GetNexusBlobstoreAzureResult:
    """
    ...
    def bucket_configurations(self) -> Sequence['outputs.GetNexusBlobstoreAzureBucketConfigurationResult']:
    ...
    def soft_quotas(self) -> Sequence['outputs.GetNexusBlobstoreAzureSoftQuotaResult']:
...
class AwaitableGetNexusBlobstoreAzureResult(GetNexusBlobstoreAzureResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetNexusBlobstoreAzureResult(
...
def get_nexus_blobstore_azure(name: Optional[str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNexusBlobstoreAzureResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('nexus:index/getNexusBlobstoreAzure:GetNexusBlobstoreAzure', __args__, opts=opts, typ=GetNexusBlobstoreAzureResult).value

    return AwaitableGetNexusBlobstoreAzureResult(
...
@_utilities.lift_output_func(get_nexus_blobstore_azure)
def get_nexus_blobstore_azure_output(name: Optional[pulumi.Input[str]] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetNexusBlobstoreAzureResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
