...
_ACKSERVERIMPRESSIONSREQUEST_ALTEREDPRODUCT_EXTRAENTRY = _descriptor.Descriptor(
  name='ExtraEntry',
  full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.AlteredProduct.ExtraEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.AlteredProduct.ExtraEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.AlteredProduct.ExtraEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACKSERVERIMPRESSIONSREQUEST_ALTEREDPRODUCT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='product_id_hash', full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.AlteredProduct.product_id_hash', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='extra', full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.AlteredProduct.extra', index=4,
...
_ACKSERVERIMPRESSIONSREQUEST_EXTRAENTRY = _descriptor.Descriptor(
  name='ExtraEntry',
  full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.ExtraEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.ExtraEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.ExtraEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACKSERVERIMPRESSIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='extra', full_name='bytedance.byteplus.retailv2.AckServerImpressionsRequest.extra', index=5,
      number=100, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
AckServerImpressionsRequest = _reflection.GeneratedProtocolMessageType('AckServerImpressionsRequest', (_message.Message,), {
  ...
  'AlteredProduct' : _reflection.GeneratedProtocolMessageType('AlteredProduct', (_message.Message,), {
    ...
    'ExtraEntry' : _reflection.GeneratedProtocolMessageType('ExtraEntry', (_message.Message,), {
      ...
      '__module__' : 'byteplus_retailv2_pb2'
      # @@protoc_insertion_point(class_scope:bytedance.byteplus.retailv2.AckServerImpressionsRequest.AlteredProduct.ExtraEntry)
      })
    ,
  ...
  'ExtraEntry' : _reflection.GeneratedProtocolMessageType('ExtraEntry', (_message.Message,), {
    ...
    '__module__' : 'byteplus_retailv2_pb2'
    # @@protoc_insertion_point(class_scope:bytedance.byteplus.retailv2.AckServerImpressionsRequest.ExtraEntry)
    })
  ,
