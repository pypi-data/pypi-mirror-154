...
setup(
    ...
    package_data={'qt_sass_theme.sass': ['theme.scss',
                  ...
                  'qt_sass_theme.var.dark': ['_variables.scss'],
                  'qt_sass_theme.var.dark_blue': ['_variables.scss'],
                  'qt_sass_theme.var.light': ['_variables.scss'],
                  'qt_sass_theme.var.light_blue': ['_variables.scss'],
                  'qt_sass_theme.ico': ['_icons.scss', 'check.svg', 'close.svg'],
