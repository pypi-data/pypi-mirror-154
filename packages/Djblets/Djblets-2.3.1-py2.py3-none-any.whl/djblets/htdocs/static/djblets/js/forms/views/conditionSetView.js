...
(function () {
  ...
  var ConditionRowView = BaseConditionRowView.extend({
    ...
    render: function render() {
      ...
      this._$choice = $('<select/>').attr('name', "".concat(fieldName, "_choice[").concat(rowNum, "]"));
      ...
      this._$operator = $('<select/>').attr('name', "".concat(fieldName, "_operator[").concat(rowNum, "]")).appendTo($rowOptions.children('.conditions-field-operator'));
    ...
    _onChoiceChanged: function _onChoiceChanged() {
      ...
      this._defaultValueField = choice.createValueField("".concat(fieldName, "_value[").concat(rowNum, "]"));
    ...
    _onOperatorChanged: function _onOperatorChanged() {
      ...
      if (operator.get('valueField') !== null) {
        var fieldName = this.conditionSet.get('fieldName');
        var rowNum = this.model.get('id');
        newValueField = operator.createValueField("".concat(fieldName, "_value[").concat(rowNum, "]"));
      } else {
  ...
  Djblets.Forms.ConditionSetView = Backbone.View.extend({
    ...
    render: function render() {
      ...
      this._$lastID = this.$el.children("input[name=".concat(fieldName, "_last_id]")).bindProperty('value', this.model, 'lastID');
