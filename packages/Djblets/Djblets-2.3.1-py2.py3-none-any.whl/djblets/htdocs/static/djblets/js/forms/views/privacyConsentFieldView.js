...
Djblets.Forms.PrivacyConsentFieldView = Backbone.View.extend({
  ...
  initialize: function initialize(options) {
    ...
    var $choices = this.$('.privacy-consent-field-choices');
    var $allowChoice = $choices.find('.privacy-consent-field-choice-allow');
    var $blockChoice = $choices.find('.privacy-consent-field-choice-block');
   ...
   */
  _onConsentChanged: function _onConsentChanged() {
    var allowed = this._$allowInput.is(':checked');

    var blocked = this._$blockInput.is(':checked');
