...
suite('djblets/forms/views/ConditionValueFormFieldView', function () {
  ...
  describe('Rendering', function () {
    it('Loaded rows', function () {
      var conditionSetView = setupConditionSetView([{
      ...
      var $rows = conditionSetView.$('.conditions-field-row');
      expect($rows.length).toBe(2);
      var $lastID = conditionSetView.$('input[name=my_conditions_last_id]');
      expect($lastID.val()).toBe('1');
      /* Check the first row. */

      var $row = $rows.eq(0);
      var $choice = $row.find('.conditions-field-choice');
      ...
      var $operator = $row.find('.conditions-field-operator');
      ...
      var $value = $row.find('.conditions-field-value');
    ...
    it('Loaded rows with errors', function () {
      ...
      var $row = $rows.eq(0);
      var $error = $row.find('.error-list li');
  ...
  describe('Actions', function () {
    ...
    it('Delete a condition', function () {
      ...
      var $lastID = conditionSetView.$('input[name=my_conditions_last_id]');
      expect($lastID.val()).toBe('0');
      var condition = conditionSetView.model.conditions.at(0);
  ...
  describe('Model events', function () {
    var conditionSetView, conditionSet, condition, $row, $choice, $operator, $valueWrapper;
    beforeEach(function () {
    ...
    describe('Operator changed', function () {
      it('Updates UI state', function () {
        var choice = conditionSet.choices.get('my-choice-1');
      ...
      it('Retains value if valueField remains', function () {
        var choice = conditionSet.choices.get('my-choice-2');
