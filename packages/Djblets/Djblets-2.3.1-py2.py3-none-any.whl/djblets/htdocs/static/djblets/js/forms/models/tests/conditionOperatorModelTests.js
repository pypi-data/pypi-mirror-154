...
suite('djblets/forms/models/ConditionOperator', function () {
  describe('Initialization', function () {
    it('With parse and data', function () {
      var op = new Djblets.Forms.ConditionOperator({
        id: 'my-op',
        name: 'My Operator',
        useValue: true,
        valueField: {
  ...
  describe('createValueField', function () {
    it('With custom valueField', function () {
      ...
      var valueField = op.createValueField('my-field');
    ...
    it('Without custom valueField', function () {
      ...
      expect(function () {
        return op.createValueField('my-field');
      }).toThrowError('This operator does not have a custom valueField.');
    });
  });
});
