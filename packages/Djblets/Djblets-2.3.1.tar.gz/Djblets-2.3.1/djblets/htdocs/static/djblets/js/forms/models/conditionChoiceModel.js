...
Djblets.Forms.ConditionChoice = Backbone.Model.extend({
   ...
   */
  createValueField: function createValueField(fieldName) {
   ...
   */
  parseValueFieldData: function parseValueFieldData(data) {
    var valueField = null;

    if (data !== undefined) {
      var fieldModelInfo = data.model;
      var fieldViewInfo = data.view;
      valueField = {
