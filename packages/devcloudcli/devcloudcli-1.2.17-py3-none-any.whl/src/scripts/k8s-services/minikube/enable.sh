...
echo -e "\e[1;32mminkube dashboard can be accessed using:\e[0m"
echo -e "\e[1;35mhttp://$HOST_IP:8001/api/v1/namespaces/kubernetes-dashboard/services/http:kubernetes-dashboard:/proxy/#/workloads?namespace=default\e[0m"
#enabling proxy
