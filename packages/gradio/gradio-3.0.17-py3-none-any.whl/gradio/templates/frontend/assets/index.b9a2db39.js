...
import { W as Webcam } from './Webcam.bd1077e0.js';
...
function create_else_block(ctx) {
	...
	video = new Video_1$2({
			props: {
				...
				source: /*source*/ ctx[3],
				drop_text: /*$_*/ ctx[10]("interface.drop_video"),
				or_text: /*$_*/ ctx[10]("or"),
				upload_text: /*$_*/ ctx[10]("interface.click_to_upload")
			}
		});

	video.$on("change", /*change_handler_1*/ ctx[12]);
	video.$on("drag", /*drag_handler*/ ctx[13]);
	video.$on("change", /*change_handler*/ ctx[14]);
	video.$on("clear", /*clear_handler*/ ctx[15]);
	video.$on("play", /*play_handler*/ ctx[16]);
	video.$on("pause", /*pause_handler*/ ctx[17]);
	...
	return {
		...
		p(ctx, dirty) {
			const video_changes = {};
			if (dirty & /*_value*/ 256) video_changes.value = /*_value*/ ctx[8];
			...
			if (dirty & /*$_*/ 1024) video_changes.drop_text = /*$_*/ ctx[10]("interface.drop_video");
			if (dirty & /*$_*/ 1024) video_changes.or_text = /*$_*/ ctx[10]("or");
			if (dirty & /*$_*/ 1024) video_changes.upload_text = /*$_*/ ctx[10]("interface.click_to_upload");
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*_value*/ 256) staticvideo_changes.value = /*_value*/ ctx[8];
...
// (20:0) <Block  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  style={{ rounded: style.rounded, height: style.height, width: style.width }} >
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				variant: /*mode*/ ctx[7] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[3] === "upload"
				? "dashed"
				: "solid",
				...
				style: {
					rounded: /*style*/ ctx[6].rounded,
					height: /*style*/ ctx[6].height,
					width: /*style*/ ctx[6].width
				},
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*mode, value, source*/ 137) block_changes.variant = /*mode*/ ctx[7] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[3] === "upload"
			? "dashed"
			: "solid";
			...
			if (dirty & /*style*/ 64) block_changes.style = {
				rounded: /*style*/ ctx[6].rounded,
				height: /*style*/ ctx[6].height,
				width: /*style*/ ctx[6].width
			};

			if (dirty & /*$$scope, _value, label, show_label, mode, source, $_, value, dragging, loading_status*/ 264125) {
