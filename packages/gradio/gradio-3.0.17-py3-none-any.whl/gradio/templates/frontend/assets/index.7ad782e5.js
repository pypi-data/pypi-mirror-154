import { S as SvelteComponent, i as init, s as safe_not_equal, U as create_slot, f as element, b as attr, c as insert, l as listen, P as update_slot_base, Q as get_all_dirty_from_scope, R as get_slot_changes, v as transition_in, w as transition_out, e as detach, F as bubble, q as create_component, u as mount_component, x as destroy_component, K as component_subscribe, X, h as text, j as set_data } from './index.7302fc9e.js';
import { g as get_styles } from './styles.db46e346.js';

/* Users/aliabid/projects/gradio/ui/packages/button/src/Button.svelte generated by Svelte v3.47.0 */
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(button, "class", button_class_value = "gr-button gr-button-" + /*size*/ ctx[2] + " gr-button-" + /*variant*/ ctx[1] + " self-start " + /*classes*/ ctx[3]);
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*size, variant, classes*/ 14 && button_class_value !== (button_class_value = "gr-button gr-button-" + /*size*/ ctx[2] + " gr-button-" + /*variant*/ ctx[1] + " self-start " + /*classes*/ ctx[3])) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*style*/ 16) {
			$$invalidate(3, { classes } = get_styles(style, ["border", "full_width", "rounded", "margin"]), classes);
		}
	};

	return [elem_id, variant, size, classes, style, $$scope, slots, click_handler];
}
...
function create_default_slot(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*$_, value*/ 20 && t_value !== (t_value = /*$_*/ ctx[4](/*value*/ ctx[2]) + "")) set_data(t, t_value);
		},
		d(detaching) {
