...
function create_fragment(ctx) {
	...
	table.$on("change", /*handle_change*/ ctx[10]);
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			const table_changes = {};
			if (dirty & /*label*/ 256) table_changes.label = /*label*/ ctx[8];
			...
			if (dirty & /*style*/ 128) table_changes.style = /*style*/ ctx[7];
