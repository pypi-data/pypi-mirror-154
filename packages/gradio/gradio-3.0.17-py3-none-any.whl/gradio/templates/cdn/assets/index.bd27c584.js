...
/* Users/aliabid/projects/gradio/ui/packages/icons/src/Undo.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/packages/image/src/Cropper.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/packages/image/src/Sketch.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/packages/image/src/ModifySketch.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/packages/image/src/Image.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/packages/image/src/StaticImage.svelte generated by Svelte v3.47.0 */
...
function create_else_block(ctx) {
	...
	function image_value_binding(value) {
		/*image_value_binding*/ ctx[13](value);
	}
	...
	let image_props = {
		...
		pending: /*pending*/ ctx[7],
		streaming: /*streaming*/ ctx[6],
		drop_text: /*$_*/ ctx[12]("interface.drop_image"),
		or_text: /*$_*/ ctx[12]("or"),
	...
	image.$on("edit", /*edit_handler*/ ctx[14]);
	image.$on("clear", /*clear_handler*/ ctx[15]);
	image.$on("change", /*change_handler*/ ctx[16]);
	image.$on("stream", /*stream_handler*/ ctx[17]);
	image.$on("drag", /*drag_handler*/ ctx[18]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*pending*/ 128) image_changes.pending = /*pending*/ ctx[7];
			if (dirty & /*streaming*/ 64) image_changes.streaming = /*streaming*/ ctx[6];
			if (dirty & /*$_*/ 4096) image_changes.drop_text = /*$_*/ ctx[12]("interface.drop_image");
			if (dirty & /*$_*/ 4096) image_changes.or_text = /*$_*/ ctx[12]("or");
			if (dirty & /*$_*/ 4096) image_changes.upload_text = /*$_*/ ctx[12]("interface.click_to_upload");
...
// (22:0) <Block  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  style={{ rounded: style.rounded, height: style.height, width: style.width }} >
function create_default_slot(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*mode*/ ctx[10] === "static") return 0;
		return 1;
	}
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				variant: /*mode*/ ctx[10] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[2] === "upload"
				? "dashed"
				: "solid",
				...
				style: {
					rounded: /*style*/ ctx[8].rounded,
					height: /*style*/ ctx[8].height,
					width: /*style*/ ctx[8].width
				},
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*mode, value, source*/ 1029) block_changes.variant = /*mode*/ ctx[10] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[2] === "upload"
			? "dashed"
			: "solid";
			...
			if (dirty & /*style*/ 256) block_changes.style = {
				rounded: /*style*/ ctx[8].rounded,
				height: /*style*/ ctx[8].height,
				width: /*style*/ ctx[8].width
			};

			if (dirty & /*$$scope, value, label, show_label, mode, source, tool, pending, streaming, $_, dragging, loading_status*/ 1056509) {
