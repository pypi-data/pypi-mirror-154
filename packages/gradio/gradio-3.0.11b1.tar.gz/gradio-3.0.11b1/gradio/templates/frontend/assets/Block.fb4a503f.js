...
function create_dynamic_element(ctx) {
	...
	return {
		c() {
			...
			attr(svelte_element, "class", svelte_element_class_value = "w-full overflow-hidden " + /*styles*/ ctx[11][/*variant*/ ctx[1]] + " " + (/*rounded*/ ctx[6]
			? /*styles*/ ctx[11][/*color*/ ctx[2]]
			: '') + " " + /*form_class*/ ctx[10] + " " + /*classes*/ ctx[9] + " " + /*rounded_style*/ ctx[8] + " " + /*visible_style*/ ctx[7]);
		...
		p(ctx, dirty) {
			...
			if (!current || dirty & /*variant, rounded, color, form_class, classes, rounded_style, visible_style*/ 1990 && svelte_element_class_value !== (svelte_element_class_value = "w-full overflow-hidden " + /*styles*/ ctx[11][/*variant*/ ctx[1]] + " " + (/*rounded*/ ctx[6]
			? /*styles*/ ctx[11][/*color*/ ctx[2]]
			: '') + " " + /*form_class*/ ctx[10] + " " + /*classes*/ ctx[9] + " " + /*rounded_style*/ ctx[8] + " " + /*visible_style*/ ctx[7])) {
				attr(svelte_element, "class", svelte_element_class_value);
			}

			if (dirty & /*variant, rounded, color, form_class, classes, rounded_style, visible_style, padding*/ 1998) {
				toggle_class(svelte_element, "gr-panel", /*padding*/ ctx[3]);
			}

			if (dirty & /*variant, rounded, color, form_class, classes, rounded_style, visible_style, form_position*/ 2006) {
				toggle_class(svelte_element, "form", /*form_position*/ ctx[4]);
			}

			if (dirty & /*variant, rounded, color, form_class, classes, rounded_style, visible_style, rounded, form_position*/ 2006) {
				toggle_class(svelte_element, "gr-box-unrounded", !/*rounded*/ ctx[6] && /*form_position*/ ctx[4]);
			}
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*explicit_call, style, disable*/ 204800) {
			$$invalidate(
				9,
		...
		if ($$self.$$.dirty & /*rounded*/ 64) {
			$$invalidate(8, rounded_style = get_styles({ rounded }, ["rounded"]).classes);
		}

		if ($$self.$$.dirty & /*visible*/ 16384) {
			$$invalidate(7, visible_style = get_styles({ visible }, ["visible"]).classes);
		}
	};
