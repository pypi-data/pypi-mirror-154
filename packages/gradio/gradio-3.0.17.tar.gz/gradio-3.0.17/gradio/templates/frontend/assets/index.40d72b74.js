...
import { g as get_next_color } from './color.912ab808.js';
import { B as Block } from './Block.b91a7a26.js';
import { B as BlockLabel } from './BlockLabel.6ad44292.js';
import './styles.db46e346.js';

/* Users/aliabid/projects/gradio/ui/packages/icons/src/TextHighlight.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/packages/highlighted-text/src/HighlightedText.svelte generated by Svelte v3.47.0 */
...
function create_if_block_1$1(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*value*/ 1 && t_value !== (t_value = /*category*/ ctx[16] + "")) set_data(t, t_value);
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*value*/ 4) highlightedtext_changes.value = /*value*/ ctx[2];
			if (dirty & /*show_legend*/ 8) highlightedtext_changes.show_legend = /*show_legend*/ ctx[3];
...
// (20:0) <Block  {elem_id}  disable={typeof style.container === "boolean" && !style.container}  style={{ rounded: style.rounded }} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, value, show_legend, style, label, loading_status*/ 317) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('show_legend' in $$props) $$invalidate(3, show_legend = $$props.show_legend);
		if ('color_map' in $$props) $$invalidate(6, color_map = $$props.color_map);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*style, color_map*/ 65) {
	...
	return [style, elem_id, value, show_legend, label, loading_status, color_map];
}
