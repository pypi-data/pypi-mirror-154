...
function create_else_block(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", div0_class_value = "grid gap-2 " + /*classes*/ ctx[11] + " svelte-1g9btlg");
		...
		p(ctx, dirty) {
			...
			if (dirty & /*selected_image, can_zoom, value*/ 4176) {
			...
			if (!current || dirty & /*classes*/ 2048 && div0_class_value !== (div0_class_value = "grid gap-2 " + /*classes*/ ctx[11] + " svelte-1g9btlg")) {
				attr(div0, "class", div0_class_value);
			}

			if (dirty & /*classes, show_label*/ 2050) {
				toggle_class(div0, "pt-6", /*show_label*/ ctx[1]);
			}
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			if (!src_url_equal(img.src, img_src_value = /*value*/ ctx[4][/*selected_image*/ ctx[6]])) attr(img, "src", img_src_value);
			attr(img, "alt", "");
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(img, "click", /*click_handler*/ ctx[17]),
					listen(div1, "keydown", /*on_keydown*/ ctx[14])
				];
...
function create_each_block_1(ctx) {
	...
	function click_handler_1() {
		return /*click_handler_1*/ ctx[19](/*i*/ ctx[27]);
	}
	...
	return {
		c() {
			...
			if (!src_url_equal(img.src, img_src_value = /*image*/ ctx[25])) attr(img, "src", img_src_value);

			attr(button, "class", button_class_value = "gallery-item !flex-none !h-9 !w-9 transition-all duration-75 " + (/*selected_image*/ ctx[6] === /*i*/ ctx[27]
		...
		p(new_ctx, dirty) {
			...
			if (dirty & /*value*/ 16 && !src_url_equal(img.src, img_src_value = /*image*/ ctx[25])) {
				attr(img, "src", img_src_value);
			}

			if (dirty & /*selected_image*/ 64 && button_class_value !== (button_class_value = "gallery-item !flex-none !h-9 !w-9 transition-all duration-75 " + (/*selected_image*/ ctx[6] === /*i*/ ctx[27]
			? '!ring-2 !ring-orange-500 hover:!ring-orange-500'
			: 'scale-90 transform') + " svelte-1g9btlg")) {
...
function create_each_block(ctx) {
	...
	function click_handler_2() {
		return /*click_handler_2*/ ctx[21](/*i*/ ctx[27]);
	}
...
// (60:0) <Block  variant="solid"  color="grey"  padding={false}  {elem_id}  disable={typeof style.container === "boolean" && !style.container} >
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, value, height, style, classes, show_label, selected_image, can_zoom, container, el, next, label, loading_status*/ 536887031) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty & /*window_height, height*/ 384) {
			$$invalidate(12, can_zoom = window_height >= height);
		}

		if ($$self.$$.dirty & /*style*/ 32) {
			$$invalidate(11, { classes } = get_styles(style, ["grid"]), classes);
		}
	};
