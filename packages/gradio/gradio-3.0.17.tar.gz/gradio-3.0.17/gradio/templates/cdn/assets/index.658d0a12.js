...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*label*/ 8) blocklabel_changes.label = /*label*/ ctx[3] || "Chatbot";
...
// (17:0) <Block padding={false} {elem_id} style={{ rounded: style.rounded }}>
function create_default_slot(ctx) {
	...
	let if_block = /*show_label*/ ctx[4] && create_if_block(ctx);
	...
	chatbot.$on("change", /*change_handler*/ ctx[7]);
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*value*/ 4) chatbot_changes.value = /*value*/ ctx[2];
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, style, value, show_label, label, loading_status*/ 317) {
