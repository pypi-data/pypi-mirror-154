...
/* Users/aliabid/projects/gradio/ui/packages/icons/src/Music.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/node_modules/.pnpm/svelte-range-slider-pips@2.0.2/node_modules/svelte-range-slider-pips/src/RangePips.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/node_modules/.pnpm/svelte-range-slider-pips@2.0.2/node_modules/svelte-range-slider-pips/src/RangeSlider.svelte generated by Svelte v3.47.0 */
...
/* Users/aliabid/projects/gradio/ui/packages/audio/src/Audio.svelte generated by Svelte v3.47.0 */
...
// (182:1) {#if mode === "edit" && player?.duration}
...
// (154:2) <Upload filetype="audio/*" on:load={handle_load} bind:dragging>
...
/* Users/aliabid/projects/gradio/ui/packages/audio/src/StaticAudio.svelte generated by Svelte v3.47.0 */
...
function create_if_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*name*/ 16) audio_changes.name = /*name*/ ctx[4];
			if (dirty & /*source*/ 32) audio_changes.source = /*source*/ ctx[5];
			if (dirty & /*type*/ 64) audio_changes.type = /*type*/ ctx[6];
...
// (26:0) <Block  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  style={{ rounded: style.rounded }} >
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				variant: /*mode*/ ctx[3] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[5] === "upload"
				? "dashed"
				: "solid",
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*mode, value, source*/ 41) block_changes.variant = /*mode*/ ctx[3] === "dynamic" && /*value*/ ctx[0] === null && /*source*/ ctx[5] === "upload"
			? "dashed"
			: "solid";
			...
			if (dirty & /*$$scope, label, show_label, _value, name, source, type, pending, streaming, $_, value, dragging, mode, loading_status*/ 16809977) {
