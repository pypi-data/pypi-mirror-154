...
import { I as Image } from './Image.e48ad54f.js';
import { C as Cropper, i as index, W as Webcam } from './Webcam.e70e4732.js';
import { f as fade } from './index.d1d2774f.js';
import { I as IconButton, C as Clear, M as ModifyUpload } from './ModifyUpload.b7a0f94b.js';
import { U as Upload } from './Upload.8700bbb0.js';
import { B as Block } from './Block.6ad151f5.js';
export { E as ExampleComponent } from './Image.113af89b.js';
...
// (23:0) <Block  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  style={{ rounded: style.rounded }}  {visible} >
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				...
				style: { rounded: /*style*/ ctx[9].rounded },
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*style*/ 512) block_changes.style = { rounded: /*style*/ ctx[9].rounded };
