...
import { W as Webcam } from './Webcam.e70e4732.js';
import './styles.db46e346.js';

/* mnt/c/Users/islam/dev/gradio-repos/gradio/ui/packages/icons/src/Video.svelte generated by Svelte v3.47.0 */
...
/* mnt/c/Users/islam/dev/gradio-repos/gradio/ui/packages/video/src/Video.svelte generated by Svelte v3.47.0 */
...
/* mnt/c/Users/islam/dev/gradio-repos/gradio/ui/packages/video/src/StaticVideo.svelte generated by Svelte v3.47.0 */
...
// (21:0) <Block  variant={mode === "dynamic" && value === null && source === "upload"   ? "dashed"   : "solid"}  color={dragging ? "green" : "grey"}  padding={false}  {elem_id}  style={{ rounded: style.rounded }}  {visible} >
...
function create_fragment(ctx) {
	...
	block = new Block({
			props: {
				...
				style: { rounded: /*style*/ ctx[7].rounded },
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*style*/ 128) block_changes.style = { rounded: /*style*/ ctx[7].rounded };
