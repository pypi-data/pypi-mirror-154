...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			attr(input, "class", input_class_value = "gr-check-radio gr-checkbox " + /*rounded*/ ctx[3] + " " + /*border*/ ctx[2]);
			...
			toggle_class(label_1, "!cursor-not-allowed", /*disabled*/ ctx[0]);
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*rounded, border*/ 12 && input_class_value !== (input_class_value = "gr-check-radio gr-checkbox " + /*rounded*/ ctx[3] + " " + /*border*/ ctx[2])) {
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function handle_change(evt) {
		$$invalidate(5, value = evt.target?.checked);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*style*/ 64) {
			$$invalidate(3, { rounded, border } = get_styles(style, ["rounded", "border"]), rounded, ($$invalidate(2, border), $$invalidate(6, style)));
		}
	};
