import { S as SvelteComponent, i as init, s as safe_not_equal, k as empty, c as insert, e as detach, U as create_slot, f as element, m as space, b as attr, t as toggle_class, d as append, P as update_slot_base, Q as get_all_dirty_from_scope, R as get_slot_changes, v as transition_in, w as transition_out, o as destroy_each, K as component_subscribe, A as createEventDispatcher, Y as setContext, _ as writable, Z as set_store_value, h as text, l as listen, n as noop } from './index.47840ebb.js';

/* mnt/c/Users/islam/dev/gradio-repos/gradio/ui/packages/tabs/src/Tabs.svelte generated by Svelte v3.47.0 */
...
// (36:2) {#each tabs as t, i}
function create_each_block(ctx) {
	let if_block_anchor;

	function select_block_type(ctx, dirty) {
		if (/*t*/ ctx[10].id === /*$selected_tab*/ ctx[2]) return create_if_block;
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			toggle_class(div1, "hidden", /*visible*/ ctx[1] === false);
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*tabs, $selected_tab, handle_click*/ 44) {
