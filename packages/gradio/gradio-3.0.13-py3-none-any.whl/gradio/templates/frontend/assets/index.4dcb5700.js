...
/* mnt/c/Users/islam/dev/gradio-repos/gradio/ui/packages/table/src/EditableCell.svelte generated by Svelte v3.47.0 */
...
/* mnt/c/Users/islam/dev/gradio-repos/gradio/ui/packages/table/src/Table.svelte generated by Svelte v3.47.0 */
...
// (409:6) {#each _headers as { value, id }
function create_each_block_2(key_1, ctx) {
	...
	function editablecell_el_binding(value) {
		/*editablecell_el_binding*/ ctx[30](value, /*id*/ ctx[55]);
	}

	function dblclick_handler() {
		return /*dblclick_handler*/ ctx[31](/*id*/ ctx[55]);
	}

	let editablecell_props = {
		value: /*value*/ ctx[54],
		edit: /*header_edit*/ ctx[11] === /*id*/ ctx[55],
		header: true
	};

	if (/*els*/ ctx[8][/*id*/ ctx[55]].input !== void 0) {
		editablecell_props.el = /*els*/ ctx[8][/*id*/ ctx[55]].input;
	}
	...
	editablecell.$on("keydown", /*end_header_edit*/ ctx[20]);
	editablecell.$on("dblclick", dblclick_handler);

	function click_handler() {
		return /*click_handler*/ ctx[32](/*i*/ ctx[53]);
	}
	...
	return {
		...
		c() {
			...
			attr(div0, "class", div0_class_value = "flex flex-none items-center justify-center p-2 cursor-pointer leading-snug transform transition-all " + (/*sort_by*/ ctx[10] !== /*i*/ ctx[53]
			? 'text-gray-200 hover:text-gray-500'
			: 'text-orange-500') + " " + (/*sort_by*/ ctx[10] === /*i*/ ctx[53] && /*sort_direction*/ ctx[9] === 'des'
			? '-scale-y-[1]'
			: ''));

			toggle_class(div0, "text-gray-200", /*sort_by*/ ctx[10] !== /*i*/ ctx[53]);
			attr(div1, "class", "min-h-[2.3rem] flex outline-none");
			attr(th, "class", th_class_value = "p-0 relative focus-within:ring-1 ring-orange-500 ring-inset outline-none " + /*classes*/ ctx[13]);
			attr(th, "aria-sort", th_aria_sort_value = /*get_sort_status*/ ctx[14](/*value*/ ctx[54], /*sort_by*/ ctx[10], /*sort_direction*/ ctx[9]));
			toggle_class(th, "bg-orange-50", /*header_edit*/ ctx[11] === /*id*/ ctx[55]);
			toggle_class(th, "dark:bg-transparent", /*header_edit*/ ctx[11] === /*id*/ ctx[55]);
			toggle_class(th, "rounded-tl-lg", /*i*/ ctx[53] === 0);
			toggle_class(th, "rounded-tr-lg", /*i*/ ctx[53] === /*_headers*/ ctx[6].length - 1);
			this.first = th;
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*_headers*/ 64) editablecell_changes.value = /*value*/ ctx[54];
			if (dirty[0] & /*header_edit, _headers*/ 2112) editablecell_changes.edit = /*header_edit*/ ctx[11] === /*id*/ ctx[55];

			if (!updating_el && dirty[0] & /*els, _headers*/ 320) {
				updating_el = true;
				editablecell_changes.el = /*els*/ ctx[8][/*id*/ ctx[55]].input;
				add_flush_callback(() => updating_el = false);
			}

			editablecell.$set(editablecell_changes);

			if (!current || dirty[0] & /*sort_by, _headers, sort_direction*/ 1600 && div0_class_value !== (div0_class_value = "flex flex-none items-center justify-center p-2 cursor-pointer leading-snug transform transition-all " + (/*sort_by*/ ctx[10] !== /*i*/ ctx[53]
			? 'text-gray-200 hover:text-gray-500'
			: 'text-orange-500') + " " + (/*sort_by*/ ctx[10] === /*i*/ ctx[53] && /*sort_direction*/ ctx[9] === 'des'
			? '-scale-y-[1]'
			: ''))) {
			...
			if (dirty[0] & /*sort_by, _headers, sort_direction, sort_by, _headers*/ 1600) {
				toggle_class(div0, "text-gray-200", /*sort_by*/ ctx[10] !== /*i*/ ctx[53]);
			}

			if (!current || dirty[0] & /*classes*/ 8192 && th_class_value !== (th_class_value = "p-0 relative focus-within:ring-1 ring-orange-500 ring-inset outline-none " + /*classes*/ ctx[13])) {
				attr(th, "class", th_class_value);
			}

			if (!current || dirty[0] & /*_headers, sort_by, sort_direction*/ 1600 && th_aria_sort_value !== (th_aria_sort_value = /*get_sort_status*/ ctx[14](/*value*/ ctx[54], /*sort_by*/ ctx[10], /*sort_direction*/ ctx[9]))) {
			...
			if (dirty[0] & /*classes, header_edit, _headers*/ 10304) {
				toggle_class(th, "bg-orange-50", /*header_edit*/ ctx[11] === /*id*/ ctx[55]);
			}
			...
			if (dirty[0] & /*classes, _headers*/ 8256) {
				toggle_class(th, "rounded-tl-lg", /*i*/ ctx[53] === 0);
			}
...
function create_each_block_1(key_1, ctx) {
	...
	function editablecell_value_binding(value) {
		/*editablecell_value_binding*/ ctx[34](value, /*value*/ ctx[54], /*each_value_1*/ ctx[56], /*j*/ ctx[57]);
	}

	function editablecell_el_binding_1(value) {
		/*editablecell_el_binding_1*/ ctx[35](value, /*id*/ ctx[55]);
	}

	let editablecell_props = {
		edit: /*editing*/ ctx[4] === /*id*/ ctx[55]
	};

	if (/*value*/ ctx[54] !== void 0) {
		editablecell_props.value = /*value*/ ctx[54];
	}
	...
	function touchstart_handler() {
		return /*touchstart_handler*/ ctx[37](/*id*/ ctx[55]);
	}

	function click_handler_1() {
		return /*click_handler_1*/ ctx[38](/*id*/ ctx[55]);
	}

	function dblclick_handler_1() {
		return /*dblclick_handler_1*/ ctx[39](/*id*/ ctx[55]);
	}

	function keydown_handler(...args) {
		return /*keydown_handler*/ ctx[40](/*i*/ ctx[53], /*j*/ ctx[57], /*id*/ ctx[55], ...args);
	}
	...
	return {
		...
		c() {
			...
			toggle_class(div, "border-transparent", /*selected*/ ctx[5] !== /*id*/ ctx[55]);
			attr(td, "tabindex", "0");
			attr(td, "class", td_class_value = "outline-none focus-within:ring-1 ring-orange-500 ring-inset focus-within:bg-orange-50 dark:focus-within:bg-gray-800 group-last:first:rounded-bl-lg group-last:last:rounded-br-lg relative " + /*classes*/ ctx[13]);
			this.first = td;
		},
		m(target, anchor) {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			const editablecell_changes = {};
			if (dirty[0] & /*editing, data*/ 144) editablecell_changes.edit = /*editing*/ ctx[4] === /*id*/ ctx[55];

			if (!updating_value && dirty[0] & /*data*/ 128) {
				updating_value = true;
				editablecell_changes.value = /*value*/ ctx[54];
				add_flush_callback(() => updating_value = false);
			}

			if (!updating_el && dirty[0] & /*els, data*/ 384) {
				updating_el = true;
				editablecell_changes.el = /*els*/ ctx[8][/*id*/ ctx[55]].input;
				add_flush_callback(() => updating_el = false);
			}
			...
			if (dirty[0] & /*selected, data*/ 160) {
				toggle_class(div, "border-transparent", /*selected*/ ctx[5] !== /*id*/ ctx[55]);
			}

			if (!current || dirty[0] & /*classes*/ 8192 && td_class_value !== (td_class_value = "outline-none focus-within:ring-1 ring-orange-500 ring-inset focus-within:bg-orange-50 dark:focus-within:bg-gray-800 group-last:first:rounded-bl-lg group-last:last:rounded-br-lg relative " + /*classes*/ ctx[13])) {
...
function create_each_block(key_1, ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			...
			if (dirty[0] & /*classes, els, data, start_edit, handle_cell_click, handle_keydown, selected, editing*/ 238000) {
				each_value_1 = /*row*/ ctx[51];
				group_outros();
...
// (390:2) <Upload    flex={false}    center={false}    boundedheight={false}    click={false}    on:load={(e) => blob_to_string(data_uri_to_blob(e.detail.data))}    bind:dragging   >
function create_default_slot(ctx) {
	...
	let each_value_2 = /*_headers*/ ctx[6];
	const get_key = ctx => /*id*/ ctx[55];
	...
	const get_key_1 = ctx => /*row*/ ctx[51];
	...
	return {
		c() {
			...
			toggle_class(table, "opacity-40", /*dragging*/ ctx[12]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*classes, get_sort_status, _headers, sort_by, sort_direction, els, header_edit, handle_sort, end_header_edit, edit_header*/ 1863488) {
				each_value_2 = /*_headers*/ ctx[6];
				group_outros();
			...
			if (dirty[0] & /*data, classes, els, start_edit, handle_cell_click, handle_keydown, selected, editing*/ 238000) {
...
function create_if_block_1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", /*add_col*/ ctx[22]);
				mounted = true;
			}
		},
		p: noop,
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			...
			t1 = space();
			if (if_block1) if_block1.c();
			attr(div0, "class", div0_class_value = "scroll-hide whitespace-nowrap overflow-hidden rounded-lg relative border transition-colors overflow-x-scroll " + /*classes*/ ctx[13]);
			toggle_class(div0, "border-green-400", /*dragging*/ ctx[12]);
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(window, "click", /*handle_click_outside*/ ctx[23]),
					listen(window, "touchstart", /*handle_click_outside*/ ctx[23])
				];
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*dragging, data, classes, els, selected, editing, _headers, sort_by, sort_direction, header_edit, label*/ 16369 | dirty[1] & /*$$scope*/ 268435456) {
				upload_changes.$$scope = { dirty, ctx };
			}

			if (!updating_dragging && dirty[0] & /*dragging*/ 4096) {
			...
			if (!current || dirty[0] & /*classes*/ 8192 && div0_class_value !== (div0_class_value = "scroll-hide whitespace-nowrap overflow-hidden rounded-lg relative border transition-colors overflow-x-scroll " + /*classes*/ ctx[13])) {
				attr(div0, "class", div0_class_value);
			}

			if (dirty[0] & /*classes, dragging*/ 12288) {
				toggle_class(div0, "border-green-400", /*dragging*/ ctx[12]);
			}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function make_headers(_head) {
		...
		if (!_h || _h.length === 0) {
			return Array(col_count[0]).fill(0).map((_, i) => {
				const _id = `h-${i}`;
				$$invalidate(8, els[_id] = { cell: null, input: null }, els);
	...
	function process_data(_values) {
		...
		: _values[0].length).fill(0).map((n, j) => {
			const id = `${i}-${j}`;
			$$invalidate(8, els[id] = { input: null, cell: null }, els);
	...
	async function start_edit(id, clear) {
		...
		if (clear) {
			...
			$$invalidate(7, data[i][j].value = "", data);
		}

		$$invalidate(4, editing = id);
		await tick();
		const { input } = els[id];
		input?.focus();
	}
	...
	async function handle_keydown(event, i, j, id) {
		...
		switch (event.key) {
			case "ArrowRight":
				...
				is_data = data[i][j + 1];
				$$invalidate(5, selected = is_data ? is_data.id : selected);
				break;
			case "ArrowLeft":
				if (editing) break;
				event.preventDefault();
			...
			case "ArrowDown":
				...
				event.preventDefault();
				is_data = data[i + 1];
				$$invalidate(5, selected = is_data ? is_data[j].id : selected);
				break;
			case "ArrowUp":
				if (editing) break;
				event.preventDefault();
			...
			case "Enter":
				...
				if (event.shiftKey) {
					...
					$$invalidate(5, selected = data[pos + 1][j].id);
				} else {
					if (editing === id) {
						$$invalidate(4, editing = false);
					} else {
			...
			case "Tab":
				...
				if (_selected) {
					event.preventDefault();
					$$invalidate(5, selected = _selected ? _selected.id : selected);
				}
				$$invalidate(4, editing = false);
				break;
			default:
	...
	function sort(col, dir) {
		if (dir === "asc") {
			$$invalidate(7, data = data.sort((a, b) => a[col].value < b[col].value ? -1 : 1));
		} else if (dir === "des") {
			$$invalidate(7, data = data.sort((a, b) => a[col].value > b[col].value ? -1 : 1));
		}
	}
	...
	function handle_sort(col) {
		if (typeof sort_by !== "number" || sort_by !== col) {
			$$invalidate(9, sort_direction = "asc");
			$$invalidate(10, sort_by = col);
		} else {
			if (sort_direction === "asc") {
				$$invalidate(9, sort_direction = "des");
	...
	function end_header_edit(event) {
		...
		switch (event.key) {
			case "Escape":
				event.preventDefault();
				$$invalidate(5, selected = header_edit);
				$$invalidate(11, header_edit = false);
				break;
			case "Enter":
				event.preventDefault();
				$$invalidate(5, selected = header_edit);
	...
	function add_row(index) {
		...
		(($$invalidate(7, data), $$invalidate(25, values)), $$invalidate(29, old_val));
	}
	...
	async function add_col() {
		...
		(($$invalidate(7, data), $$invalidate(25, values)), $$invalidate(29, old_val));
		(($$invalidate(6, _headers), $$invalidate(26, headers)), $$invalidate(28, old_headers));
		await tick();
	...
	function blob_to_string(blob) {
		...
		function handle_read(e) {
			...
			$$invalidate(6, _headers = make_headers(col_count[1] === "fixed"
			? head.slice(0, col_count[0])
			: head));

			$$invalidate(25, values = rest);
	...
	$$self.$$set = $$props => {
		...
		if ('style' in $$props) $$invalidate(27, style = $$props.style);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*headers, old_headers*/ 335544320) {
			{
				if (!dequal(headers, old_headers)) {
					$$invalidate(6, _headers = make_headers(headers));
		...
		if ($$self.$$.dirty[0] & /*values, old_val*/ 570425344) {
			if (!dequal(values, old_val)) {
				$$invalidate(7, data = process_data(values));
				$$invalidate(29, old_val = values);
				refresh_focus();
			}
		}

		if ($$self.$$.dirty[0] & /*_headers, data*/ 192) {
			_headers && dispatch("change", data.map(r => r.map(({ value }) => value)));
		}

		if ($$self.$$.dirty[0] & /*editing*/ 16) {
			set_focus(editing, "edit");
		}

		if ($$self.$$.dirty[0] & /*selected*/ 32) {
			set_focus(selected, "select");
		}

		if ($$self.$$.dirty[0] & /*style*/ 134217728) {
			$$invalidate(13, { classes } = get_styles(style, ["rounded"]), classes);
		}
	};
...
function create_fragment(ctx) {
	...
	table.$on("change", /*handle_change*/ ctx[11]);
	...
	return {
		c() {
			...
			toggle_class(div, "hidden", /*visible*/ ctx[3] === false);
