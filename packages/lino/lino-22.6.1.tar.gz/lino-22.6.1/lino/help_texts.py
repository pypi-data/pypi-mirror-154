...
two rows should be considered similar."""),
    ...
    'lino.mixins.dupable.DupableChecker.model' : _("""alias of lino.mixins.dupable.Dupable"""),
...
tzinfo which contains the time zone info object."""),
    'lino.modlib.blogs.Blog' : _("""The Django model to represent a blog."""),
    'lino.modlib.blogs.Entry' : _("""The Django model to represent a blog entry."""),
    'lino.modlib.blogs.Entry.pub_date' : _("""The publication date."""),
    'lino.modlib.blogs.Entry.user' : _("""The author."""),
    'lino.modlib.blogs.Entry.blog' : _("""The blog to which this entry belongs."""),
