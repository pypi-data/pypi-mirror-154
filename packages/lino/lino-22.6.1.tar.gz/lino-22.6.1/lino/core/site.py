...
# except ImportError:
#     print("Failed to import social_django")
#     UserSocialAuth = None
...
class Site(object):
    ...
    A production site specific value to keep track of updates. Site operator
    should increase a value here so that the frontend can take action for
    changes in the site (reload site cache and storage).
