...
class TrackListModel(QtCore.QAbstractListModel):
    ...
    EndFrameRole = QtCore.Qt.UserRole + 4  # Integer end frame (e.g. 67890). This is derived, so cannot be set directly.
    BoxesRole = QtCore.Qt.UserRole + 5  # List of track's boxes (None indicates no box at that frame)
