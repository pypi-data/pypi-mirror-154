...
def decodePlayerFlags(player_flags) -> dict:
    """Decode player flags"""
...
def decodeVehicleFlags(vehicle_flags) -> dict:
...
def decodeGameFlags(game_flags) -> dict:
    """Decode player flags"""
...
def queryServer(ip: str, port=2302) -> dict:
