from typing import Type, Dict, List, Any, TypeVar, Generic
...
class DBInterface(Generic[T], ILogger):
    ...
    def update(self, element: T) -> T:
        ...
        """
        with self._db_connector as db:
            updated_element = db._update_document(search_filter={"id": element.id}, updated_document=element.dict())
        return self._element_type(**updated_element.raw_result)

    def delete(self, id: UUID, force: bool = False) -> bool:
        """
        ...
        with self._db_connector as db:
            ...
            updated_element = db._update_document(search_filter={"id": id}, updated_document={"deleted": True})
            return updated_element.raw_result["deleted"]
