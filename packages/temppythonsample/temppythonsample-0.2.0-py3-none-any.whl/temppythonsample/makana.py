...
from models import PipelineShape, PipelineConnection, Pipeline, PipelineShapeAttribute
import json
import uuid
import string
import random
...
class Makana():
    global pipelineId
    global baseUrl
    global pipelineShapes
    global pipelineShapeConnections
    global  pipelineShapesId
    global pythonScriptShape
    pipelineShapes = []
