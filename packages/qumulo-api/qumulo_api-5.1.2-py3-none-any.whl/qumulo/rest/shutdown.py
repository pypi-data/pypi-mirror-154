...
@request.request
def halt(conninfo: request.Connection, credentials: Optional[Credentials]) -> request.RestResponse:
    method = 'POST'
    uri = '/v1/node/halt'
...
@request.request
def reboot_start(
    conninfo: request.Connection, credentials: Optional[Credentials], is_rolling: bool = False
) -> request.RestResponse:
    method = 'POST'
