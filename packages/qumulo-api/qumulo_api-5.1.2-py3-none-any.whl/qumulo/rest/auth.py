...
@request.request
def auth_id_to_all_related_identities(
    conninfo: request.Connection, credentials: Optional[Credentials], auth_id: object
) -> request.RestResponse:
    method = 'GET'
...
@request.request
def posix_uid_to_all_related_identities(
    conninfo: request.Connection, credentials: Optional[Credentials], posix_uid: object
) -> request.RestResponse:
    method = 'GET'
...
@request.request
def posix_gid_to_all_related_identities(
    conninfo: request.Connection, credentials: Optional[Credentials], posix_gid: object
) -> request.RestResponse:
    method = 'GET'
...
@request.request
def sid_to_all_related_identities(
    conninfo: request.Connection, credentials: Optional[Credentials], sid: object
) -> request.RestResponse:
    method = 'GET'
...
@request.request
def local_username_to_all_related_identities(
    conninfo: request.Connection, credentials: Optional[Credentials], username: object
) -> request.RestResponse:
    method = 'GET'
...
def user_defined_mappings_set(
    conninfo: request.Connection, credentials: Optional[Credentials], mappings: Mapping[str, object]
) -> request.RestResponse:
    method = 'PUT'
...
def clear_cache(
    ...
    return request.rest_request(conninfo, credentials, 'POST', '/v1/auth/clear-cache')


@request.request
def find_identity(
    conninfo: request.Connection, credentials: Optional[Credentials], **attrs: object
) -> request.RestResponse:
    """
