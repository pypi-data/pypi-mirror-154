...
def uid_number_to_login_name_get(
    conninfo: request.Connection, credentials: Optional[Credentials], uid_number: object
) -> request.RestResponse:
    method = 'GET'
...
def login_name_to_gid_numbers_get(
    conninfo: request.Connection, credentials: Optional[Credentials], login_name: object
) -> request.RestResponse:
    method = 'GET'
