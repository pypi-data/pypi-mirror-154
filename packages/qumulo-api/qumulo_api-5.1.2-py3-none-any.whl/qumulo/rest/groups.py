...
@request.request
def add_group(
    conninfo: request.Connection, credentials: Optional[Credentials], name: object, gid: object
) -> request.RestResponse:
    method = 'POST'
    uri = '/v1/groups/'
...
@request.request
def list_group(
    conninfo: request.Connection, credentials: Optional[Credentials], group_id: Union[int, str]
) -> request.RestResponse:
