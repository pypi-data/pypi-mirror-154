...
@request.request
def time_series_get(
    conninfo: request.Connection, credentials: Optional[Credentials], begin_time: int = 0
...
def capacity_history_files_get(
    conninfo: request.Connection, credentials: Optional[Credentials], timestamp: object
) -> request.RestResponse:
    method = 'GET'
