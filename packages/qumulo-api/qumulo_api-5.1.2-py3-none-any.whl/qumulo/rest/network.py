...
def modify_cluster_network_config(
    conninfo: request.Connection, credentials: Optional[Credentials], **kwargs: Optional[object]
) -> request.RestResponse:
    method = 'PATCH'
    uri = '/v1/network/settings'
...
@request.request
def get_interface(
    conninfo: request.Connection, credentials: Optional[Credentials], interface_id: str
) -> request.RestResponse:
    method = 'GET'
...
def list_network_status_v2(
    conninfo: request.Connection, credentials: Optional[Credentials], interface_id: int = 1
) -> request.RestResponse:
    method = 'GET'
