...
@request.request
def uid_to_sid_get(
    conninfo: request.Connection, credentials: Optional[Credentials], uid: object
) -> request.RestResponse:
    method = 'GET'
...
def username_to_sid_get(
    conninfo: request.Connection, credentials: Optional[Credentials], name: object
) -> request.RestResponse:
...
@request.request
def sid_to_uid_get(
    conninfo: request.Connection, credentials: Optional[Credentials], sid: str
) -> request.RestResponse:
    method = 'GET'
...
@request.request
def gid_to_sid_get(
    conninfo: request.Connection, credentials: Optional[Credentials], gid: object
) -> request.RestResponse:
    method = 'GET'
...
def distinguished_name_to_ad_account(
    conninfo: request.Connection, credentials: Optional[Credentials], distinguished_name: object
) -> request.RestResponse:
