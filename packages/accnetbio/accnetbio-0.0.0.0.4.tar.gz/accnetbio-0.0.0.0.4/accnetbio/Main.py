...
def main():
    ...
    if args.ws == None:
        ...
        raise ValueError
    # cmd = 'python ' + fpnf + ' -h'
    cmd = 'python ' + fpnf + ' -m ' + args.m + ' -mol_f ' + args.mol_f + ' -net_f ' + str(args.net_f) + ' -ws ' + args.ws + ' -ssinf ' + args.ssinf + ' -sssup ' + args.sssup + ' -pmode ' + str(args.pmode) + ' -amode ' + str(args.amode) + ' -ikind ' + str(args.ikind) + ' -cr ' + args.cr + ' -issv ' + str(args.issv) + ' -o ' + str(args.o)
    # print(cmd)
