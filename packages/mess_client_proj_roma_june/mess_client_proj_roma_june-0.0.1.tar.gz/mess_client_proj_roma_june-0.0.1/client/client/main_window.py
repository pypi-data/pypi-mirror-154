...
sys.path.append('../../../')
from pack_client.client import Ui_MainClientWindow
from pack_client.client.client.add_contact import AddContactDialog
from pack_client.client import DelContactDialog
