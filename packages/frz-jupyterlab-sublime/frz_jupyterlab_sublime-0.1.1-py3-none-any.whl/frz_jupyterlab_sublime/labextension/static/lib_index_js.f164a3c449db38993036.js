...
class JupyterLabSublime {
    ...
    addCommands() {
        ...
        commands.addCommand('sublime:indent-less-slash-tooltip', {
            execute: () => {
                if (tracker.activeCell !== null && tracker.activeCell.editor.host.classList.contains('jp-mod-completer-enabled')) {
...
//# sourceMappingURL=lib_index_js.f164a3c449db38993036.js.map