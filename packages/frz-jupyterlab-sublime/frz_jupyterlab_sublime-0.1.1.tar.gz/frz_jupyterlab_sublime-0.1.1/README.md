...
To make some conflicted keys work, and allow further customize some keybindings, copy the content of [example.keybindings.json](example.keybindings.json) to the "Keyboard Shortcuts" settings.
