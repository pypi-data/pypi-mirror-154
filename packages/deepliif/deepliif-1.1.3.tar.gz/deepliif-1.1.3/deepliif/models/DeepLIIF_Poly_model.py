...
class DeepLIIFPolyModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            self.criterionGAN_poly = networks.GANLoss('poly_ce').to(self.device)
    ...
    def backward_D(self):
        ...
        self.loss_D_fake_1 = self.criterionGAN_poly(pred_fake_1, False)
        self.loss_D_fake_2 = self.criterionGAN_poly(pred_fake_2, False)
        self.loss_D_fake_3 = self.criterionGAN_poly(pred_fake_3, False)
        self.loss_D_fake_4 = self.criterionGAN_poly(pred_fake_4, False)
        self.loss_D_fake_5 = self.criterionGAN_poly(pred_fake_5, False)
        ...
        self.loss_D_real_1 = self.criterionGAN_poly(pred_real_1, True)
        self.loss_D_real_2 = self.criterionGAN_poly(pred_real_2, True)
        self.loss_D_real_3 = self.criterionGAN_poly(pred_real_3, True)
        self.loss_D_real_4 = self.criterionGAN_poly(pred_real_4, True)
        self.loss_D_real_5 = self.criterionGAN_poly(pred_real_5, True)
    ...
    def backward_G(self):
        ...
        self.loss_G_GAN_1 = self.criterionGAN_poly(pred_fake_1, True)
        self.loss_G_GAN_2 = self.criterionGAN_poly(pred_fake_2, True)
        self.loss_G_GAN_3 = self.criterionGAN_poly(pred_fake_3, True)
        self.loss_G_GAN_4 = self.criterionGAN_poly(pred_fake_4, True)
        self.loss_G_GAN_5 = self.criterionGAN_poly(pred_fake_5, True)
