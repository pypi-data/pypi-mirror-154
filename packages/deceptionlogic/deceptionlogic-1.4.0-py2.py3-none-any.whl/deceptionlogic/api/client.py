...
class Client():
    ...
    def get_alerts(self, params=dict()):
        ...
        Get all alerts
        """
        return self._make_request(endpoint=self.alerts_endpoint, options=params)

    def get_events(self, params=dict()):
        """
        Get all events
        """
        return self._make_request(endpoint=self.events_endpoint, options=params)
    ...
    def get_agentlogs(self, agent_id=""):
        """
        Get agent logs
        """
        return self._make_request(endpoint=self.agentlogs_endpoint,
                                  append_url=agent_id)
