...
class EmbedOperators(Node):
    r"""
    Embeds operators into a larger Hilbert space.
...
class KroneckerProductList(Node):
    r"""
    Calculates the Kronecker product between a list of operators.
...
class Min(Node):
    """
    Finds the minimum value in a tensor along one or multiple of its axes.
    ...
    See Also
    --------
    max : Finds the maximum value in a tensor along one or multiple of its axes.
    """
...
class Max(Node):
    """
    Finds the maximum value in a tensor along one or multiple of its axes.
    ...
    See Also
    --------
    min : Finds the minimum value in a tensor along one or multiple of its axes.
    """
