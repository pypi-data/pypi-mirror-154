...
RB.NotificationManager = Backbone.View.extend({
  ...
  setup: function setup() {
    var Notification = RB.NotificationManager.Notification;
   ...
   */
  _haveNotificationPermissions: function _haveNotificationPermissions() {
  ...
  notify: function notify(options) {
    ...
    var notification = new RB.NotificationManager.Notification(options.title, {
      body: options.body,
