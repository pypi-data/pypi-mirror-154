...
RB.ExtraDataMixin = {
   ...
   * model itself
   */
  _setupExtraData: function _setupExtraData() {
  ...
  set: function set(key, value, options) {
    ...
    var useExtraData = _.has(attrs, 'extraData') && _.has(this, 'extraData');
   ...
   */
  _onExtraDataChanged: function _onExtraDataChanged(extraData, options) {
   ...
   */
  getExtraData: function getExtraData(key) {
   ...
   *         The value to set.
   */
  setExtraData: function setExtraData(key, value) {
