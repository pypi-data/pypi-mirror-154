...
(function () {
  ...
  $(document).ready(function () {
    ...
    var $hostingPowerPackAdvert = $('<div class="powerpack-advert" />').html(powerPackTemplate).hide().appendTo($hostingType.closest('fieldset'));
    var $toolPowerPackAdvert = $('<div class="powerpack-advert" />').html(powerPackTemplate).hide().appendTo($tool.closest('fieldset'));
    ...
    $tool.change(function () {
      if ($hostingType.val() === 'custom') {
        var scmtoolID = $tool.val();
        var $authForm = $('#auth-form-scm-' + scmtoolID);
        var $repoForm = $('#repo-form-scm-' + scmtoolID);
        var toolInfo = TOOLS_INFO[scmtoolID];
        var isFake = toolInfo.fake === true;
