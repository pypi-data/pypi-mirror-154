...
suite('rb/views/ReviewDialogView', function () {
  ...
  var emptyDiffCommentsPayload = _.defaults({
    diff_comments: []
  }, baseEmptyCommentListPayload);

  var emptyFileAttachmentCommentsPayload = _.defaults({
    file_attachment_comments: []
  }, baseEmptyCommentListPayload);

  var emptyGeneralCommentsPayload = _.defaults({
    general_comments: []
  }, baseEmptyCommentListPayload);

  var emptyScreenshotCommentsPayload = _.defaults({
    screenshot_comments: []
  }, baseEmptyCommentListPayload);

  var baseCommentPayload = {
    id: 1,
    issue_opened: true,
    issue_status: 'opened',
    text: 'My comment'
  ...
  var diffCommentPayload = _.defaults({
    first_line: 10,
    num_lines: 5,
    filediff: {
      id: 1,
  ...
  var fileAttachmentCommentPayload = _.defaults({
    extra_data: {},
  ...
  var generalCommentPayload = baseCommentPayload;

  var screenshotCommentPayload = _.defaults({
    x: 10,
    y: 20,
    w: 30,
    h: 40,
  ...
  var origGeneralCommentsEnabled = RB.EnabledFeatures.generalComments;
  ...
  describe('Instances', function () {
    ...
    describe('Loading', function () {
      ...
      describe('With body and top text', function () {
        ...
        var bodyBottomText = 'My body bottom';
        beforeEach(function () {
          review.set({
            bodyTop: bodyTopText,
      ...
      describe('With existing review', function () {
        ...
        var generalCommentsPayload;
        var diffCommentsPayload;
        var screenshotCommentsPayload;
        var commentView;
        var ajaxData;
        beforeEach(function () {
          review.set({
        ...
        describe('General comments', function () {
          it('Disabled', function () {
            ...
            var $button = dlg._$buttons.find('input[value="Add General Comment"]');
        ...
        describe('Screenshot comments', function () {
          function testLoadScreenshotComments() {
            ...
            var $filenameA = commentView.$('.filename a');
    ...
    describe('Saving', function () {
      ...
      function testSaveCommentPreventsXSS(richText) {
        var newCommentText = '"><script>window.rbTestFoundXSS = true;</script>';
      ...
      beforeEach(function () {
        ...
        fileAttachmentCommentsPayload = _.clone(emptyFileAttachmentCommentsPayload);
        generalCommentsPayload = _.clone(emptyGeneralCommentsPayload);
        spyOn(review, 'save').and.callFake(function (options, context) {
      ...
      describe('Review properties', function () {
        function testSelfXSS(bodyView, attrName) {
          var text = '"><script>window.rbTestFoundXSS = true;' + '</script>';
          var editor = bodyView.textEditor;
          delete window.rbTestFoundXSS;
          bodyView.openEditor();
          editor.setText(text);
        ...
        describe('Body Top', function () {
          function runTest(richText) {
            ...
            var bodyTopEditor = dlg._bodyTopView.textEditor;
        ...
        describe('Body Bottom', function () {
          function runTest(richText) {
            var text = 'My new text';
            var bodyBottomEditor = dlg._bodyBottomView.textEditor;
