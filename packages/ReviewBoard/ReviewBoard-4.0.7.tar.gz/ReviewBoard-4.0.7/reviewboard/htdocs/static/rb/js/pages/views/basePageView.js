...
RB.PageView = Backbone.View.extend({
  ...
  render: function render() {
    ...
    this.$window.on('resize.rbPageView', _.throttle(function () {
      return _this._updateSize();
   ...
   *         The drawer to set.
   */
  setDrawer: function setDrawer(drawer) {
   ...
   */
  resizeElementForFullHeight: function resizeElementForFullHeight($el, $parent) {
    if ($parent === undefined) {
   ...
   */
  _reparentDrawer: function _reparentDrawer() {
    var $el = this.drawer.$el.detach();
   ...
   */
  _onMobileModeChanged: function _onMobileModeChanged(inMobileMode) {
