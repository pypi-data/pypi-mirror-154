...
RB.RegionCommentBlock = RB.FileAttachmentCommentBlock.extend({
   ...
   */
  canUpdateBounds: function canUpdateBounds() {
   ...
   */
  saveDraftCommentBounds: function saveDraftCommentBounds() {
    var _this = this;
    ...
    draftComment.ready({
      ready: function ready() {
        ...
        extraData.x = _this.get('x');
        extraData.y = _this.get('y');
        extraData.width = _this.get('width');
        extraData.height = _this.get('height');
        draftComment.save({
