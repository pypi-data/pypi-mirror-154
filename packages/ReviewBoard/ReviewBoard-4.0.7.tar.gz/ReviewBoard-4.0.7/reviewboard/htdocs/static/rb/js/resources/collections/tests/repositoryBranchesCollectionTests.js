  ...
  describe('Methods', function () {
    it('fetch', function () {
      spyOn($, 'ajax').and.callFake(function (request) {
        expect(request.url).toBe('/api/repositories/123/branches/');
      ...
      expect(collection.at(1).get('commit')).toBe('92463764015ef463b4b6d1a1825fee7aeec8cb15');
...
//# sourceMappingURL=repositoryBranchesCollectionTests.js.map