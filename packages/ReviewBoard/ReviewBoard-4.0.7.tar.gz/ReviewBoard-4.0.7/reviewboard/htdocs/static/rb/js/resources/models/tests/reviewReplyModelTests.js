...
suite('rb/resources/models/ReviewReply', function () {
  ...
  describe('destroy', function () {
    ...
    beforeEach(function () {
      ...
      spyOn(Backbone.Model.prototype, 'destroy').and.callFake(function (options) {
  ...
  describe('discardIfEmpty', function () {
    ...
    beforeEach(function () {
      ...
      spyOn(model, 'destroy').and.callFake(function (options) {
        if (options && _.isFunction(options.success)) {
          options.success();
        }
      });
    ...
    describe('With isNew=false', function () {
      ...
      beforeEach(function () {
        ...
        spyOn(RB, 'apiCall').and.callFake(function (options) {
          ...
          var key = _.find(RB.ReviewReply.prototype.COMMENT_LINK_NAMES, function (name) {
  ...
  describe('ready', function () {
    ...
    describe('With isNew=true', function () {
      beforeEach(function () {
        ...
        spyOn(model, '_retrieveDraft').and.callFake(function (options, context) {
          if (options && _.isFunction(options.ready)) {
            options.ready.call(context);
          }
        });
