    ...
    describe('Callback handling', function () {
      ...
      describe('With isNew=false and parentObject', function () {
        beforeEach(function () {
          ...
          spyOn(parentObject, 'ready').and.callFake(function (options, context) {
      ...
      describe('With isNew=false and parentObject with error', function () {
        beforeEach(function () {
          model.set({
            parentObject: parentObject,
            id: 123
  ...
  describe('save', function () {
    ...
    describe('Callback handling', function () {
      ...
      describe('With isNew=true and parentObject', function () {
        ...
        beforeEach(function () {
          spyOn(parentObject, 'ensureCreated').and.callFake(function (options) {
            if (options && _.isFunction(options.success)) {
              options.success();
            }
          });
        ...
        it('With callbacks', function () {
          ...
          expect(callbacks.success).toHaveBeenCalled();
          var args = callbacks.success.calls.argsFor(0);
      ...
      describe('With isNew=false and no parentObject', function () {
        beforeEach(function () {
          ...
          spyOn(Backbone.Model.prototype, 'save').and.callFake(function (attrs, options) {
            if (options && _.isFunction(options.success)) {
              options.success();
            }
          });
    ...
    describe('With file upload support', function () {
      ...
      it('With multiple files', function (done) {
        ...
        blob1.name = 'myfile1';
        var blob2 = new Blob(['Goodbye world!'], {
          type: 'text/plain'
        });
        blob2.name = 'myfile2';
    ...
    describe('With form upload support', function () {
      ...
      it('Overriding toJSON attributes', function () {
        var form = $('<form/>').append($('<input name="foo"/>'));
