...
(function () {
  ...
  var StoredItems = RB.BaseResource.extend({
    /**
     ...
     */
    addImmediately: function addImmediately(obj) {
     ...
     *         Context to use when calling the callbacks in ``options``.
     */
    removeImmediately: function removeImmediately(obj) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var url = this.url();
  ...
  RB.UserSession = Backbone.Model.extend({
     ...
     */
    getAvatarHTML: function getAvatarHTML(size) {
     ...
     *     an empty object.
     */
    getAvatarURLs: function getAvatarURLs(size) {
     ...
     */
    _bindCookie: function _bindCookie(options) {
      var deserialize = options.deserialize || _.identity;

      var serialize = options.serialize || function (value) {
        return value.toString();
      };

      this.set(options.attr, deserialize($.cookie(options.cookieName)));
      this.on("change:".concat(options.attr), function (model, value) {
