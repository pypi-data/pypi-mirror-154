...
RB.Admin.InlineFormView = Backbone.View.extend({
   ...
   */
  _onIndexChanged: function _onIndexChanged() {
    var index = this.model.get('index');
    var prefix = this.model.get('prefix');
    var idRegex = new RegExp("(".concat(prefix, "-(\\d+|__prefix__))"));
    var newPrefix = "".concat(prefix, "-").concat(index);
    ...
    this._$title.text("#".concat(index + 1));
...
//# sourceMappingURL=inlineFormView.js.map