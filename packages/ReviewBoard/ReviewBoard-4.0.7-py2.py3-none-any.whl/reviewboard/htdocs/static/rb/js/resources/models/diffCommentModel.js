...
RB.DiffComment = RB.BaseComment.extend({
   ...
   */
  getNumLines: function getNumLines() {
  ...
  parseResourceData: function parseResourceData(rsp) {
    var result = RB.BaseComment.prototype.parseResourceData.call(this, rsp);
