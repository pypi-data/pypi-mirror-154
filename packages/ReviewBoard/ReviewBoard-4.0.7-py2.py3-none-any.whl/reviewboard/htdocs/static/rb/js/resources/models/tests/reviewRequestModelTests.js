...
suite('rb/resources/models/ReviewRequest', function () {
  ...
  describe('createReview', function () {
    ...
    it('Without review ID', function () {
      ...
      var review2 = reviewRequest.createReview();
  ...
  describe('setStarred', function () {
    ...
    beforeEach(function () {
      ...
      spyOn(session.watchedReviewRequests, 'addImmediately').and.callThrough();
      spyOn(session.watchedReviewRequests, 'removeImmediately').and.callThrough();
      spyOn(RB, 'apiCall').and.callThrough();
    });
    it('true', function () {
      spyOn($, 'ajax').and.callFake(function (request) {
      ...
      expect(session.watchedReviewRequests.addImmediately).toHaveBeenCalled();
      expect(RB.apiCall).toHaveBeenCalled();
      expect($.ajax).toHaveBeenCalled();
      expect(callbacks.success).toHaveBeenCalled();
      expect(callbacks.error).not.toHaveBeenCalled();
    ...
    it('false', function () {
      ...
      expect(session.watchedReviewRequests.removeImmediately).toHaveBeenCalled();
      expect(RB.apiCall).toHaveBeenCalled();
      expect($.ajax).toHaveBeenCalled();
      expect(callbacks.success).toHaveBeenCalled();
      expect(callbacks.error).not.toHaveBeenCalled();
...
//# sourceMappingURL=reviewRequestModelTests.js.map