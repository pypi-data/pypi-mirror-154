...
(function () {
    ...
    _onGenerateClicked: function _onGenerateClicked() {
      ...
      apiToken.save({
        success: function success() {
          ...
          _this6._$generateTokenItem.detach().appendTo(_this6._listView.getBody());
        }
      });
      return false;
    }
  ...
  RB.APITokensView = Backbone.View.extend({
    ...
    render: function render() {
      ...
      for (var _i = 0, _Object$entries = Object.entries(this.apiTokens); _i < _Object$entries.length; _i++) {
        var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
            localSiteName = _Object$entries$_i[0],
