...
suite('rb/views/ReviewRequestEditorView', function () {
  ...
  var screenshotThumbnailTemplate = _.template("<div class=\"screenshot-container\" data-screenshot-id=\"<%= id %>\">\n <div class=\"screenshot-caption\">\n  <a class=\"edit\"></a>\n </div>\n <a class=\"delete\">X</a>\n'</div>");
  ...
  beforeEach(function () {
    ...
    spyOn(reviewRequest.draft, 'ready').and.callFake(function (options, context) {
    ...
    describe('Close', function () {
      ...
      it('Delete Permanently', function () {
        ...
        spyOn($.fn, 'modalBox').and.callFake(function (options) {
          ...
          return {
            modalBox: function modalBox(cmd) {
    ...
    describe('Draft banner', function () {
      describe('Visibility', function () {
        ...
        it('Show when saved', function () {
          ...
          var summaryEditor = summaryField.inlineEditorView;
          expect(view.banner).toBe(null);
          spyOn(reviewRequest.draft, 'ensureCreated').and.callFake(function (options, context) {
            return options.success.call(context);
          });
          spyOn(reviewRequest.draft, 'save').and.callFake(function (options, context) {
            return options.success.call(context);
          });
      ...
      describe('Buttons actions', function () {
        ...
        it('Discard Review Request', function () {
          ...
          view.showBanner();
          spyOn(reviewRequest, 'close').and.callFake(function (options) {
            return expect(options.type).toBe(RB.ReviewRequest.CLOSE_DISCARDED);
          });
        ...
        describe('Publish', function () {
          ...
          it('With Send E-Mail turned on', function () {
            ...
            expect(editor.publishDraft).toHaveBeenCalled();
            expect(reviewRequest.draft.publish).toHaveBeenCalled();
            expect(reviewRequest.draft.publish.calls.argsFor(0)[0].trivial).toBe(0);
          });
          it('With Send E-Mail turned off', function () {
            ...
            expect(editor.publishDraft).toHaveBeenCalled();
            expect(reviewRequest.draft.publish).toHaveBeenCalled();
            expect(reviewRequest.draft.publish.calls.argsFor(0)[0].trivial).toBe(1);
          });
        });
      });
      ...
      describe('Close description', function () {
        ...
        function testCloseDescription(testName, richText) {
          it(testName, function (done) {
            ...
            var textEditor = fieldEditor.textEditor;
  ...
  describe('Fields', function () {
    ...
    var fieldName;
    var jsonFieldName;
    var jsonTextTypeFieldName;
    var supportsRichText;
    var useExtraData;
    var fieldView;
    var fieldEditor;
    var $field;
    ...
    beforeEach(function () {
      if (!saveSpyFunc) {
        saveSpyFunc = function saveSpyFunc(options, context) {
    ...
    function runSavingTest(richText, textType, supportsRichTextEV) {
      ...
      it('', function () {
        var expectedData = {};
        var fieldPrefix = useExtraData ? 'extra_data.' : '';
      ...
      describe('endEdit', function () {
        describe('Decrement edit count', function () {
          ...
          it('On submit', function () {
            spyOn(fileAttachment, 'ready').and.callFake(function (options, context) {
              return options.ready.call(context);
            });
    ...
    describe('Events', function () {
      ...
      describe('endEdit', function () {
        describe('Decrement edit count', function () {
          ...
          it('On submit', function () {
            spyOn(screenshot, 'ready').and.callFake(function (options, context) {
              return options.ready.call(context);
            });
