...
RB.BaseComment = RB.BaseResource.extend({
  ...
  extraQueryArgs: function extraQueryArgs() {
    var textTypes = 'raw';
  ...
  serializers: {
    ...
    issueStatus: function issueStatus(value) {
      if (this.get('loaded')) {
   ...
   */
  requiresVerification: function requiresVerification() {
   ...
   */
  getAuthorUsername: function getAuthorUsername() {
    var review = this.get('parentObject');
   ...
   */
  isStateOpen: function isStateOpen(state) {
