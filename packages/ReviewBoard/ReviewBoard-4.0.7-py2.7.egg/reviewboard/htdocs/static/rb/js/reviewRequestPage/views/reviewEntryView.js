...
(function () {
  ...
  RB.ReviewRequestPage.ReviewEntryView = ParentView.extend({
    ...
    render: function render() {
      ...
      this.listenTo(this._reviewView, 'hasDraftChanged', function (hasDraft) {
        return _this.$el.toggleClass('has-draft', hasDraft);
      });
     ...
     */
    _updateLabel: function _updateLabel($label, visible, boxClassName) {
      if (visible) {
     ...
     */
    _revokeShipIt: function _revokeShipIt() {
      var _this2 = this;

      this._$boxStatus.addClass('revoking-ship-it');

      var confirmation = RB.ReviewRequestPage.ReviewEntryView.strings.revokeShipItConfirm;
        ...
        ready: function ready() {
          ...
          review.save({
            ...
            success: function success() {
              ...
              setTimeout(function () {
                return _this2._clearRevokingShipIt();
              }, 900);
            },
            error: function error(model, xhr) {
              review.set('shipIt', true);

              _this2._clearRevokingShipIt();
     ...
     */
    _clearRevokingShipIt: function _clearRevokingShipIt() {
