...
RB.WebhookFormView = Backbone.View.extend({
   ...
   */
  _onAllEventsToggled: function _onAllEventsToggled() {
   ...
   */
  _onApplyToChanged: function _onApplyToChanged() {
   ...
   */
  _onEncodingChanged: function _onEncodingChanged() {
   ...
   */
  _onUseCustomContentToggled: function _onUseCustomContentToggled() {
