...
suite('rb/reviewRequestPage/models/ReviewReplyEditor', function () {
  ...
  beforeEach(function () {
    ...
    spyOn(reviewReply, 'ensureCreated').and.callFake(function (options, context) {
  ...
  describe('Methods', function () {
    describe('save', function () {
      function testBodySave(options) {
        ...
        spyOn(reviewReply, 'save').and.callFake(function (options, context) {
          return options.success.call(context);
        });
        editor.save();
      ...
      function testCommentSave(options) {
        ...
        spyOn(editor, 'trigger');
        spyOn(options.model.prototype, 'ready').and.callFake(function (options, context) {
          return options.ready.call(context);
        });
        spyOn(options.model.prototype, 'save').and.callFake(function (options, context) {
          return options.success.call(context);
        });
        editor.save();
        var replyObject = editor.get('replyObject');
        expect(editor.get('hasDraft')).toBe(true);
        expect(editor.get('text')).toBe('My Text');
        expect(editor.get('richText')).toBe(true);
      ...
      it('With existing reply object', function () {
        ...
        spyOn(editor, 'trigger');
        spyOn(replyObject, 'ready').and.callFake(function (options, context) {
          return options.ready.call(context);
        });
        spyOn(replyObject, 'save').and.callFake(function (options, context) {
          return options.success.call(context);
        });
        editor.save();
        expect(editor.get('hasDraft')).toBe(true);
    ...
    describe('resetStateIfEmpty', function () {
      ...
      beforeEach(function () {
        ...
        spyOn(editor, 'trigger');
        spyOn(replyObject, 'destroy').and.callFake(function (options, context) {
          return options.success.call(context);
        });
      });
