  ...
  describe('parse', function () {
    ...
    it('Long commit message', function () {
      var model = new RB.DiffCommit({
        author_name: 'Author Name',
        commit_id: 'r123',
        commit_message: "This is a long commit message.\n\nIt spans several lines.\nIt has trailing newlines as well.\n\n",
        id: 2,
        parent_id: 'r122'
      }, {
        parse: true
      ...
      expect(model.attributes).toEqual({
        authorName: 'Author Name',
        commitID: 'r123',
        commitMessage: 'This is a long commit message.\n\n' + 'It spans several lines.\n' + 'It has trailing newlines as well.',
        id: 2,
        parentID: 'r122',
    ...
    it('Commit message with overlong first line', function () {
      var message = 'abcd'.repeat(100);
      var summary = message.substr(0, 77) + '...';
      var model = new RB.DiffCommit({
        author_name: 'Author Name',
        commit_id: 'r234',
...
//# sourceMappingURL=diffCommitModelTests.js.map