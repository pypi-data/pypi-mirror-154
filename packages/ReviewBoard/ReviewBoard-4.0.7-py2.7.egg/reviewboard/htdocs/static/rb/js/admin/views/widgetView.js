...
RB.Admin.WidgetView = Backbone.View.extend({
   ...
   */
  addHeaderAction: function addHeaderAction(options) {
   ...
   *     The resulting action element.
   */
  addFooterAction: function addFooterAction(options) {
   ...
   */
  setReloading: function setReloading(reloading) {
   ...
   *     The resulting action element.
   */
  _buildAction: function _buildAction(options) {
    console.assert(options.id, 'An "id" value must be provided');
    var $action = $('<li class="rb-c-admin-widget__action">').addClass("js-action-".concat(options.id));
