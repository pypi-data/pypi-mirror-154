...
suite('rb/pages/models/PageManager', function () {
    ...
    describe('Methods', function () {
      describe('beforeReady', function () {
        ...
        it('With page set, rendered', function () {
          ...
          expect(function () {
            return pageManager.beforeRender(callbacks.cb);
          }).toThrow();
          expect(callbacks.cb).not.toHaveBeenCalled();
        });
      });
  ...
  describe('Class methods', function () {
    ...
    it('beforeRender', function () {
      ...
      expect(RB.PageManager.instance.beforeRender).toHaveBeenCalledWith(1, 2);
    });
    it('ready', function () {
      spyOn(RB.PageManager.instance, 'ready');
      RB.PageManager.ready(1, 2);
      expect(RB.PageManager.instance.ready).toHaveBeenCalledWith(1, 2);
    });
    it('setPage', function () {
...
//# sourceMappingURL=pageManagerModelTests.js.map