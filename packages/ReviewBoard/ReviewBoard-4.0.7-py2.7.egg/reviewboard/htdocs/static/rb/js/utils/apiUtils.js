...
$.ajaxTransport('arraybuffer blob', function (options, origOptions, jqXHR) {
  ...
  var xhr;
  return {
    send: function send(headers, completeCB) {
      xhr = options.xhr();
...
RB.apiCall = function (options) {
  ...
  function showErrorPage(xhr, data) {
    ...
    var requestData = options.data ? $.param(options.data) : '(none)';
  ...
  function doCall() {
    ...
    var data = $.extend(true, {
      ...
      error: function error(xhr, textStatus, errorThrown) {
        ...
        $activityIndicator.addClass('error').text(gettext("A server error occurred.")).append($('<a href="#" />').text(gettext("Show Details")).click(function () {
          return showErrorPage(xhr, responseText);
        })).append($('<a href="#" />').text(gettext("Dismiss")).click(function () {
