  ...
  describe('States', function () {
    describe('dirty', function () {
      ...
      it('After saving', function () {
        ...
        editor.set('text', 'abc');
        expect(editor.get('dirty')).toBe(true);
        spyOn(comment, 'save').and.callFake(function (callbacks, context) {
          return callbacks.success.call(context);
        });
        editor.save();
        expect(editor.get('dirty')).toBe(false);
      });
      it('After deleting', function () {
        ...
        editor.set('text', 'abc');
        expect(editor.get('dirty')).toBe(true);
        spyOn(comment, 'destroy').and.callFake(function (callbacks, context) {
