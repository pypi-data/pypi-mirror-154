...
class BaseLogger:
    def __init__(self, config: Optional[dict] = None, level: Optional[str] = None,
                 ...
                 default_topic: Optional[str] = None, json_encoder: Optional[Type[JSONEncoder]] = None,
                 *args, **kwargs):
        """
    ...
    def _format_args(self, msg, trace_id='', topic=''):
        ...
        try:
            ...
            return json_str[1:-1]  # 去掉前后括号. todo 这里是为了兼容 之前的日志。把 msg 添加到本身的日志里面。
