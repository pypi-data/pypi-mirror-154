...
const KernelUsage = (props) => {
    ...
    const requestUsage = (kid) => (0,_handler__WEBPACK_IMPORTED_MODULE_3__.requestAPI)(`get_usage/${kid}`).then(data => {
...
//# sourceMappingURL=lib_index_js.4f58875f2aaf30a7bccd.js.map