"use strict";
(self["webpackChunkjupyterlab_kernel_usage"] = self["webpackChunkjupyterlab_kernel_usage"] || []).push([["style_index_js"],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".jp-kernelusage-view {\n  overflow: scroll !important;\n  padding: 10px;\n  background-color: white;\n  min-width: 250px !important;\n}\n\n.jp-kernelusage-separator {\n  margin-top: 20px;\n  margin-bottom: 20px;\n}\n\n.jp-kernelusage-button {\n  background-color: green;\n  border-radius: 12px;\n  border: none;\n  color: white;\n  padding: 5px 5px;\n  margin: 10px;\n  text-align: center;\n  text-decoration: none;\n  display: inline-block;\n  font-size: 12px;\n}\n", "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;EACE,2BAA2B;EAC3B,aAAa;EACb,uBAAuB;EACvB,2BAA2B;AAC7B;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,uBAAuB;EACvB,mBAAmB;EACnB,YAAY;EACZ,YAAY;EACZ,gBAAgB;EAChB,YAAY;EACZ,kBAAkB;EAClB,qBAAqB;EACrB,qBAAqB;EACrB,eAAe;AACjB","sourcesContent":[".jp-kernelusage-view {\n  overflow: scroll !important;\n  padding: 10px;\n  background-color: white;\n  min-width: 250px !important;\n}\n\n.jp-kernelusage-separator {\n  margin-top: 20px;\n  margin-bottom: 20px;\n}\n\n.jp-kernelusage-button {\n  background-color: green;\n  border-radius: 12px;\n  border: none;\n  color: white;\n  padding: 5px 5px;\n  margin: 10px;\n  text-align: center;\n  text-decoration: none;\n  display: inline-block;\n  font-size: 12px;\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.7c05f4bc30bbbfc411b8.js.map