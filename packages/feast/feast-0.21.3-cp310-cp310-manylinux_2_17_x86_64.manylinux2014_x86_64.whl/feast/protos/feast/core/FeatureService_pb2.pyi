...
class LoggingConfig(google.protobuf.message.Message):
    ...
    PARTITION_INTERVAL_FIELD_NUMBER: builtins.int
    ...
    @property
    def partition_interval(self) -> google.protobuf.duration_pb2.Duration: ...
    @property
    ...
    def __init__(self,
        *,
        sample_rate : builtins.float = ...,
        partition_interval : typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["bigquery_destination",b"bigquery_destination","custom_destination",b"custom_destination","destination",b"destination","file_destination",b"file_destination","partition_interval",b"partition_interval","redshift_destination",b"redshift_destination","snowflake_destination",b"snowflake_destination"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["bigquery_destination",b"bigquery_destination","custom_destination",b"custom_destination","destination",b"destination","file_destination",b"file_destination","partition_interval",b"partition_interval","redshift_destination",b"redshift_destination","sample_rate",b"sample_rate","snowflake_destination",b"snowflake_destination"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["destination",b"destination"]) -> typing.Optional[typing_extensions.Literal["file_destination","bigquery_destination","redshift_destination","snowflake_destination","custom_destination"]]: ...
