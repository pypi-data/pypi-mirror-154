    ...
    def run(self):
        ...
        try:
            ...
            if error.errno == errno.ENOENT:
                print(f"""
                There was an error installing the onepassword resource provider plugin.
                It looks like `pulumi` is not installed on your system.
                Please visit https://pulumi.com/ to install the Pulumi CLI.
                You may try manually installing the plugin by running
                `pulumi plugin install resource onepassword {PLUGIN_VERSION}`
                """)
            else:
                raise
...
setup(name='simcubeltd_pulumi_onepassword',
      version=VERSION,
      ...
      keywords='pulumi onepassword category/cloud',
