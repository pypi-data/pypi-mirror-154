...
[aiobotocore.ResourceGroups 2.3.3](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/resource-groups.html#ResourceGroups)
...
def get_structure() -> ResourceQueryTypeDef:
    return {
      ...
    }
```
