...
setup(
  ...
  description = 'Intuitive access to clustering datasets',   # Give a short description about your library
  ...
  download_url = '', 
  keywords = ['clustering'],   # Keywords that define your package best
  install_requires=[            
      ],
  classifiers=[
