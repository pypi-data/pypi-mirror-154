...
if not TYPE_CHECKING:
    streamtag = _load_me("func_adl_servicex_xaodr21.xAOD.EventInfo_v1.streamtag")
    subevent = _load_me("func_adl_servicex_xaodr21.xAOD.EventInfo_v1.subevent")
else:
    from . import streamtag
    from . import subevent
