  ...
  def laboro_method(func):
    def wrapper(self, *args, **kwargs):
      if len(args) > 1:
        ...
        self.context.store.memory[func.__name__] = func(*args[1:])
        return self.context.store.memory[func.__name__]
      else:
        try:
        ...
        self.context.store.memory[func.__name__] = func(self, **kwargs)
        return self.context.store.memory[func.__name__]
    return wrapper
