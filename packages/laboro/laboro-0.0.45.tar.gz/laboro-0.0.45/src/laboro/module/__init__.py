...
class Module:
  def __init__(self, filepath, store, args=None):
  ...
  def laboro_method(func):
    def wrapper(self, *args, **kwargs):
      if len(args) > 1:
        ...
        self.store[func.__name__] = func(*args[1:])
        return self.store[func.__name__]
      else:
        try:
        ...
        self.store[func.__name__] = func(self, **kwargs)
        return self.store[func.__name__]
    return wrapper
