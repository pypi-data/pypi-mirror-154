...
from ...models.rna_oligos_bulk_create_request_helm import RnaOligosBulkCreateRequestHelm
...
def _get_kwargs(
    *,
    client: Client,
    json_body: RnaOligosBulkCreateRequestHelm,
) -> Dict[str, Any]:
...
def sync(
    *,
    ...
    """ Bulk Create RNA Oligos with optional HELM """
