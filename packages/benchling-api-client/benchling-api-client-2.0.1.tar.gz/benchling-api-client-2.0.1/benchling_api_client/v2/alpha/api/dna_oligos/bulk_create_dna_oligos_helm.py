...
from ...models.dna_oligos_bulk_create_request_helm import DnaOligosBulkCreateRequestHelm
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DnaOligosBulkCreateRequestHelm,
) -> Dict[str, Any]:
...
def sync(
    *,
    ...
    """ Bulk Create DNA Oligos with optional HELM """
