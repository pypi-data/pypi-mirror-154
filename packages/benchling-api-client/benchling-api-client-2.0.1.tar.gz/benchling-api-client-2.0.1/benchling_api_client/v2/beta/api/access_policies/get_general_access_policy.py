...
def _get_kwargs(
    *,
    ...
    url = "{}/general-access-policies/{policy_id}".format(client.base_url, policy_id=policy_id)
...
def _parse_response(*, response: httpx.Response) -> Optional[Union[AccessPolicy, NotFoundError]]:
    if response.status_code == 200:
        response_200 = AccessPolicy.from_dict(response.json())
...
def sync(
    *,
    ...
    """ Returns a general (project/registry) policy by ID. """
