...
def _get_kwargs(
    *,
    client: Client,
    json_body: EntryCreateAttachments,
) -> Dict[str, Any]:
...
def sync(
    *,
    ...
    """Create a notebook entry with optional attachments. Attachments will be placed into the entry body in the order they are specified."""
