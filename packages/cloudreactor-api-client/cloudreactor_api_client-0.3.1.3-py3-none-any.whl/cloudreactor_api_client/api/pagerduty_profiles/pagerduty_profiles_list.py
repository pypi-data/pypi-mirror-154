...
from ...models.paginated_pager_duty_profile_list import PaginatedPagerDutyProfileList
...
def _parse_response(*, response: httpx.Response) -> Optional[PaginatedPagerDutyProfileList]:
    if response.status_code == 200:
        response_200 = PaginatedPagerDutyProfileList.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[PaginatedPagerDutyProfileList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    run_environment_uuid: Union[Unset, None, str] = UNSET,
    search: Union[Unset, None, str] = UNSET,
) -> Response[PaginatedPagerDutyProfileList]:
    """
    Args:
...
def sync(
    *,
    ...
    run_environment_uuid: Union[Unset, None, str] = UNSET,
    search: Union[Unset, None, str] = UNSET,
) -> Optional[PaginatedPagerDutyProfileList]:
    """
    Args:
        created_by_group_id (Union[Unset, None, int]):
        limit (Union[Unset, None, int]):
