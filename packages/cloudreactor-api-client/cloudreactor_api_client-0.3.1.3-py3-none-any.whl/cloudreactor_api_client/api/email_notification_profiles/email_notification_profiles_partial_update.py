...
from ...models.patched_email_notification_profile import PatchedEmailNotificationProfile
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: PatchedEmailNotificationProfile,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (str):
        json_body (PatchedEmailNotificationProfile): An EmailProfile contains settings for
