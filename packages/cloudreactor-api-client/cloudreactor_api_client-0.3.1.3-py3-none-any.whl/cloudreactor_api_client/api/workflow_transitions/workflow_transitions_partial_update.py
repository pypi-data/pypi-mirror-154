...
from ...models.patched_workflow_transition import PatchedWorkflowTransition
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: PatchedWorkflowTransition,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (str):
        json_body (PatchedWorkflowTransition): A WorkflowTransition is a directed edge in a
