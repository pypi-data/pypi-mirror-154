...
def _parse_response(*, response: httpx.Response) -> Optional[PaginatedEmailNotificationProfileList]:
    if response.status_code == 200:
        response_200 = PaginatedEmailNotificationProfileList.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[PaginatedEmailNotificationProfileList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    run_environment_uuid: Union[Unset, None, str] = UNSET,
    search: Union[Unset, None, str] = UNSET,
) -> Response[PaginatedEmailNotificationProfileList]:
    """
    Args:
...
def sync(
    *,
    ...
    run_environment_uuid: Union[Unset, None, str] = UNSET,
    search: Union[Unset, None, str] = UNSET,
) -> Optional[PaginatedEmailNotificationProfileList]:
    """
    Args:
        created_by_group_id (Union[Unset, None, int]):
        limit (Union[Unset, None, int]):
