...
from ...models.patched_alert_method import PatchedAlertMethod
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (str):
        json_body (PatchedAlertMethod): An AlertMethod specifies one or more configured methods of
            notifying
