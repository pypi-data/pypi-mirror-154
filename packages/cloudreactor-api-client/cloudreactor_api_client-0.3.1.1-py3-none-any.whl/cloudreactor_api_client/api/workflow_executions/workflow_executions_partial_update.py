...
from ...models.patched_workflow_execution import PatchedWorkflowExecution
...
def _get_kwargs(
    ...
    *,
    ...
    json_body: PatchedWorkflowExecution,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        uuid (str):
        json_body (PatchedWorkflowExecution): A WorkflowExecution holds data on a specific
