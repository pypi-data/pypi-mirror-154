...
from gendocker.check_and_create_folder import check_and_create_folder
from gendocker.get_project_config import get_project_config


def create_run_script(project_list, configs, tag):
    for project_name in project_list:
        ...
        with open(f'{docker_script_output_folder}/{project_name}.sh', "w+") as writer:
            ...
            writer.write(f'docker pull jaytrairat/{project_name}:{tag}\n')
            writer.write(f'docker run -dp {project_config["port"]} jaytrairat/{project_name}:{tag}\n')
