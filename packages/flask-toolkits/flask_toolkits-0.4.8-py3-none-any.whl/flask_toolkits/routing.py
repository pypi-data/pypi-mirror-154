...
class APIRouter(Blueprint):
    ...
    def check_each_params_for_create_model(self, annots, k, default_val):
        default_type = annots[k] if k in annots else str
    ...
    def extract_signature_params(self, func: Callable):
        ...
        res = {
            k: self.check_each_params_for_create_model(annots, k, d)
            for k, d in default_val.items()
        }
        return res
