...
def plot_curve(*curves, vertex_markings=True, savename=None, saveextension=None, return_fig=False):
...
def plot_clustering(clustering_result, curves, vertex_markings=True, savename=None, saveextension=None, return_fig=False):
