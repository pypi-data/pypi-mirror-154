...
_H = TypeVar("_H", bound="BaseWSGIHandler")
...
class BaseWSGIHandler(MutableMapping[str, Any]):
    ...
    def __or__(self: type[_H], obj: MutableMapping[str, Any], /) -> _H:
        if not isinstance(obj, MutableMapping):
            return NotImplemented

        handler: Final[_H] = self.__class__()
        handler.update(self)
        handler.update(obj)
        return handler

    def __ror__(self: type[_H], obj: MutableMapping[str, Any], /) -> _H:
        if not isinstance(obj, MutableMapping):
            return NotImplemented
    ...
    def __ior__(self: type[_H], obj: MutableMapping[str, Any], /) -> _H:
        if not isinstance(obj, MutableMapping):
            return NotImplemented
