...
AWSS3FolderTestCase = \
    get_test_case_cls_default(href='http://localhost:8080/volumes/666f6f2d6261722d71757578/buckets/arp-scale-2-cloud-bucket-with-tags11/awss3folders/',
                                                   ...
                                                   get_all_actions=[
                                                       expectedvalues.Action(
                                                           ...
                                                           url='/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{id}/opener',
                                                           rel=['hea-opener-choices']),
                                                       expectedvalues.Action(
                                                           name='heaserver-awss3folders-folder-duplicate',
                                                           url='/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{id}/duplicator',
                                                           rel=['hea-duplicator']),
                                                       expectedvalues.Action(
...
AWSS3ItemTestCase = \
    get_test_case_cls_default(href='http://localhost:8080/volumes/666f6f2d6261722d71757578/buckets/arp-scale-2-cloud-bucket-with-tags11/awss3folders/root/items/',
                                                   wstl_package=service.__package__,
                                                   ...
                                                   get_all_actions=[
                                                       expectedvalues.Action(
                                                           ...
                                                           url='/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{folder_id}/items/{id}/opener',
                                                           rel=['hea-opener-choices']),
                                                       expectedvalues.Action(
                                                           name='heaserver-awss3folders-item-duplicate',
                                                           url='/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{folder_id}/items/{id}/duplicator',
                                                           rel=['hea-duplicator']),
                                                       expectedvalues.Action(
                                                       ...
                                                       expectedvalues.Action(
                                                           ...
                                                           url='/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{folder_id}/items/mover',
                                                           rel=['hea-mover']
                                                       )
                                                   ],
                                                   get_actions=[
                                                       ...
                                                       expectedvalues.Action(
                                                           name='heaserver-awss3folders-item-move',
                                                           url='/volumes/{volume_id}/buckets/{bucket_id}/awss3folders/{folder_id}/items/{id}/mover',
                                                           rel=['hea-mover']
                                                       )
                                                   ],
