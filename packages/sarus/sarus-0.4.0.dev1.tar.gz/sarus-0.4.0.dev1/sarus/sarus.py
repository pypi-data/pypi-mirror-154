...
with warnings.catch_warnings():
    ...
    from sarus_data_spec.dataset import Dataset as SarusDataset
    ...
    try:
        ...
        import sarus.tensorflow as stf
...
class Dataset:
    ...
    def __init__(
        ...
        if dataspec is None:
            ...
            self._dataspec = SarusDataset(
                dict_deserialize(dataspec["dataset"])
            )
    ...
    def as_pandas(self) -> DataFrame:
        return DataFrame(self._dataspec)
