...
@jsii.data_type(
    jsii_type="lazy-constructs.LazyNodejsFunctionProps",
    jsii_struct_bases=[aws_cdk.aws_lambda_nodejs.NodejsFunctionProps],
    name_mapping={
        ...
        "runtime": "runtime",
        "error_alarm": "errorAlarm",
    },
)
class LazyNodejsFunctionProps(aws_cdk.aws_lambda_nodejs.NodejsFunctionProps):
    def __init__(
        self,
        *,
        ...
        bundling: typing.Optional[aws_cdk.aws_lambda_nodejs.BundlingOptions] = None,
        ...
        error_alarm: typing.Optional[builtins.bool] = None,
    ) -> None:
        '''
        ...
        :param error_alarm: Setting error alarm. Default: true
        '''
        ...
        if isinstance(bundling, dict):
            bundling = aws_cdk.aws_lambda_nodejs.BundlingOptions(**bundling)
        ...
        if error_alarm is not None:
            self._values["error_alarm"] = error_alarm
    ...
    @builtins.property
    def bundling(self) -> typing.Optional[aws_cdk.aws_lambda_nodejs.BundlingOptions]:
        '''Bundling options.
        ...
        return typing.cast(typing.Optional[aws_cdk.aws_lambda_nodejs.BundlingOptions], result)
    ...
    @builtins.property
    def error_alarm(self) -> typing.Optional[builtins.bool]:
        '''Setting error alarm.

        :default: true
        '''
        result = self._values.get("error_alarm")
        return typing.cast(typing.Optional[builtins.bool], result)
    ...
    def __repr__(self) -> str:
        return "LazyNodejsFunctionProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )


class LazyNodejsFunctions(
    aws_cdk.aws_lambda_nodejs.NodejsFunction,
    metaclass=jsii.JSIIMeta,
    jsii_type="lazy-constructs.LazyNodejsFunctions",
):
    def __init__(
        self,
